...
import CartPostModifierInner from './CartPostModifierInner';
...
* @version 3.0
*/
export default class CartPostModifier extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'CartPostModifierInner');
