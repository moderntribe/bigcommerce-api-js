...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CartLineItemUpdatePost', function() {
      beforeEach(function() {
        instance = new Carts.CartLineItemUpdatePost();
      });

      it('should create an instance of CartLineItemUpdatePost', function() {
        expect(instance).to.be.a(Carts.CartLineItemUpdatePost);
      });
