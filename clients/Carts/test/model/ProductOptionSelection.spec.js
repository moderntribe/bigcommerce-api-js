...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductOptionSelection', function() {
      beforeEach(function() {
        instance = new Carts.ProductOptionSelection();
      });

      it('should create an instance of ProductOptionSelection', function() {
        expect(instance).to.be.a(Carts.ProductOptionSelection);
      });
      ...
      it('should have the property option_value (base name: "option_value")', function() {
        expect(instance).to.have.property('option_value');
        // expect(instance.option_value).to.be(expectedValueLiteral);
      });
