...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppliedDiscount1', function() {
      beforeEach(function() {
        instance = new Carts.AppliedDiscount1();
      });

      it('should create an instance of AppliedDiscount1', function() {
        expect(instance).to.be.a(Carts.AppliedDiscount1);
      });
