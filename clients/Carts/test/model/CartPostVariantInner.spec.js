...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CartPostVariantInner', function() {
      beforeEach(function() {
        instance = new Carts.CartPostVariantInner();
      });

      it('should create an instance of CartPostVariantInner', function() {
        expect(instance).to.be.a(Carts.CartPostVariantInner);
      });
