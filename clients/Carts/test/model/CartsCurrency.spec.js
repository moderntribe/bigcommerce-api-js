...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CartsCurrency', function() {
      beforeEach(function() {
        instance = new Carts.CartsCurrency();
      });

      it('should create an instance of CartsCurrency', function() {
        expect(instance).to.be.a(Carts.CartsCurrency);
      });
