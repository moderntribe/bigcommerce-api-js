...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LineItem', function() {
      beforeEach(function() {
        instance = new Carts.LineItem();
      });

      it('should create an instance of LineItem', function() {
        expect(instance).to.be.a(Carts.LineItem);
      });

      it('should have the property physical_items (base name: "physical_items")', function() {
        expect(instance).to.have.property('physical_items');
        // expect(instance.physical_items).to.be(expectedValueLiteral);
      });

      it('should have the property digital_items (base name: "digital_items")', function() {
        expect(instance).to.have.property('digital_items');
        // expect(instance.digital_items).to.be(expectedValueLiteral);
      });
