...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CartPostCustomItem', function() {
      beforeEach(function() {
        instance = new Carts.CartPostCustomItem();
      });

      it('should create an instance of CartPostCustomItem', function() {
        expect(instance).to.be.a(Carts.CartPostCustomItem);
      });
