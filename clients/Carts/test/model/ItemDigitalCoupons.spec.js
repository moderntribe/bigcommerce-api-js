...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ItemDigitalCoupons', function() {
      beforeEach(function() {
        instance = new Carts.ItemDigitalCoupons();
      });

      it('should create an instance of ItemDigitalCoupons', function() {
        expect(instance).to.be.a(Carts.ItemDigitalCoupons);
      });
