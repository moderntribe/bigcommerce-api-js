...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppliedDiscount', function() {
      beforeEach(function() {
        instance = new Carts.AppliedDiscount();
      });

      it('should create an instance of AppliedDiscount', function() {
        expect(instance).to.be.a(Carts.AppliedDiscount);
      });
