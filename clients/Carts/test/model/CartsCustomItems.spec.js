...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CartsCustomItems', function() {
      beforeEach(function() {
        instance = new Carts.CartsCustomItems();
      });

      it('should create an instance of CartsCustomItems', function() {
        expect(instance).to.be.a(Carts.CartsCustomItems);
      });
