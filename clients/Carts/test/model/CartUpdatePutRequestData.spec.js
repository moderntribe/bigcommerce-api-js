...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CartUpdatePutRequestData', function() {
      beforeEach(function() {
        instance = new Carts.CartUpdatePutRequestData();
      });

      it('should create an instance of CartUpdatePutRequestData', function() {
        expect(instance).to.be.a(Carts.CartUpdatePutRequestData);
      });
