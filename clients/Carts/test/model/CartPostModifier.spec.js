...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CartPostModifier', function() {
      beforeEach(function() {
        instance = new Carts.CartPostModifier();
      });

      it('should create an instance of CartPostModifier', function() {
        expect(instance).to.be.a(Carts.CartPostModifier);
      });
