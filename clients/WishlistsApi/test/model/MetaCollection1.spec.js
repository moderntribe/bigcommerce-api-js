...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MetaCollection1', function() {
      beforeEach(function() {
        instance = new Wishlist.MetaCollection1();
      });

      it('should create an instance of MetaCollection1', function() {
        expect(instance).to.be.a(Wishlist.MetaCollection1);
      });
