...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WishlistFull1', function() {
      beforeEach(function() {
        instance = new Wishlist.WishlistFull1();
      });

      it('should create an instance of WishlistFull1', function() {
        expect(instance).to.be.a(Wishlist.WishlistFull1);
      });
