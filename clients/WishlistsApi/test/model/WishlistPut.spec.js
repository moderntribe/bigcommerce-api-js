...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WishlistPut', function() {
      beforeEach(function() {
        instance = new Wishlist.WishlistPut();
      });

      it('should create an instance of WishlistPut', function() {
        expect(instance).to.be.a(Wishlist.WishlistPut);
      });
