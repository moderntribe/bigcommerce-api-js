...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WishlistPost1', function() {
      beforeEach(function() {
        instance = new Wishlist.WishlistPost1();
      });

      it('should create an instance of WishlistPost1', function() {
        expect(instance).to.be.a(Wishlist.WishlistPost1);
      });
