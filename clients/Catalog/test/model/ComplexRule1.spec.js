...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ComplexRule1', function() {
      beforeEach(function() {
        instance = new Catalog.ComplexRule1();
      });

      it('should create an instance of ComplexRule1', function() {
        expect(instance).to.be.a(Catalog.ComplexRule1);
      });
