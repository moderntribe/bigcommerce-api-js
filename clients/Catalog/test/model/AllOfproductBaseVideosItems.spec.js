...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfproductBaseVideosItems', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfproductBaseVideosItems();
      });

      it('should create an instance of AllOfproductBaseVideosItems', function() {
        expect(instance).to.be.a(Catalog.AllOfproductBaseVideosItems);
      });
