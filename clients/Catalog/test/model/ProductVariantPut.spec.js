...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductVariantPut', function() {
      beforeEach(function() {
        instance = new Catalog.ProductVariantPut();
      });

      it('should create an instance of ProductVariantPut', function() {
        expect(instance).to.be.a(Catalog.ProductVariantPut);
      });
