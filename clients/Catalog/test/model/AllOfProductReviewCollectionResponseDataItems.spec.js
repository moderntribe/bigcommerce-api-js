...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfProductReviewCollectionResponseDataItems', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfProductReviewCollectionResponseDataItems();
      });

      it('should create an instance of AllOfProductReviewCollectionResponseDataItems', function() {
        expect(instance).to.be.a(Catalog.AllOfProductReviewCollectionResponseDataItems);
      });
