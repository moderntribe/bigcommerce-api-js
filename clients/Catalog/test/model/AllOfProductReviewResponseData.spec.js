...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfProductReviewResponseData', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfProductReviewResponseData();
      });

      it('should create an instance of AllOfProductReviewResponseData', function() {
        expect(instance).to.be.a(Catalog.AllOfProductReviewResponseData);
      });
