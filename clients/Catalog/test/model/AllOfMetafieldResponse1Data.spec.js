...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfMetafieldResponse1Data', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfMetafieldResponse1Data();
      });

      it('should create an instance of AllOfMetafieldResponse1Data', function() {
        expect(instance).to.be.a(Catalog.AllOfMetafieldResponse1Data);
      });
