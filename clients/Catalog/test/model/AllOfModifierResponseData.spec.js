...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfModifierResponseData', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfModifierResponseData();
      });

      it('should create an instance of AllOfModifierResponseData', function() {
        expect(instance).to.be.a(Catalog.AllOfModifierResponseData);
      });
