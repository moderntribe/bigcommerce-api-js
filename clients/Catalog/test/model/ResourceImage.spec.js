...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResourceImage', function() {
      beforeEach(function() {
        instance = new Catalog.ResourceImage();
      });

      it('should create an instance of ResourceImage', function() {
        expect(instance).to.be.a(Catalog.ResourceImage);
      });
