...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductVariantBase', function() {
      beforeEach(function() {
        instance = new Catalog.ProductVariantBase();
      });

      it('should create an instance of ProductVariantBase', function() {
        expect(instance).to.be.a(Catalog.ProductVariantBase);
      });
