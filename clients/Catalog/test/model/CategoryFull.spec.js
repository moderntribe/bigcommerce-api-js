...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CategoryFull', function() {
      beforeEach(function() {
        instance = new Catalog.CategoryFull();
      });

      it('should create an instance of CategoryFull', function() {
        expect(instance).to.be.a(Catalog.CategoryFull);
      });
