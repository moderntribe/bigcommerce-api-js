...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductVariantPutProduct1', function() {
      beforeEach(function() {
        instance = new Catalog.ProductVariantPutProduct1();
      });

      it('should create an instance of ProductVariantPutProduct1', function() {
        expect(instance).to.be.a(Catalog.ProductVariantPutProduct1);
      });
