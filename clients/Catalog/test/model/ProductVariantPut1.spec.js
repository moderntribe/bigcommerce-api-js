...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductVariantPut1', function() {
      beforeEach(function() {
        instance = new Catalog.ProductVariantPut1();
      });

      it('should create an instance of ProductVariantPut1', function() {
        expect(instance).to.be.a(Catalog.ProductVariantPut1);
      });
