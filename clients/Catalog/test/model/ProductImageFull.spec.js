...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductImageFull', function() {
      beforeEach(function() {
        instance = new Catalog.ProductImageFull();
      });

      it('should create an instance of ProductImageFull', function() {
        expect(instance).to.be.a(Catalog.ProductImageFull);
      });
