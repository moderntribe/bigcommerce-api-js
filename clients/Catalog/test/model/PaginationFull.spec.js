...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginationFull', function() {
      beforeEach(function() {
        instance = new Catalog.PaginationFull();
      });

      it('should create an instance of PaginationFull', function() {
        expect(instance).to.be.a(Catalog.PaginationFull);
      });
