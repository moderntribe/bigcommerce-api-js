...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CategoriesTreeNodeFull', function() {
      beforeEach(function() {
        instance = new Catalog.CategoriesTreeNodeFull();
      });

      it('should create an instance of CategoriesTreeNodeFull', function() {
        expect(instance).to.be.a(Catalog.CategoriesTreeNodeFull);
      });
