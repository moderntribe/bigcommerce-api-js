...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfProductVideoCollectionResponseDataItems', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfProductVideoCollectionResponseDataItems();
      });

      it('should create an instance of AllOfProductVideoCollectionResponseDataItems', function() {
        expect(instance).to.be.a(Catalog.AllOfProductVideoCollectionResponseDataItems);
      });
