...
import CustomUrlBrand from './CustomUrlBrand';

/**
* The Brand1 model module.
* @module model/Brand1
* @version 3.0
*/
export default class Brand1 {
    /**
    * Constructs a new <code>Brand1</code>.
    * Common Brand properties.
    * @alias module:model/Brand1
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>Brand1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Brand1} obj Optional instance to populate.
    * @return {module:model/Brand1} The populated <code>Brand1</code> instance.
    */
