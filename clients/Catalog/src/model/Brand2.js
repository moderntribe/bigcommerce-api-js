...
/**
* The Brand2 model module.
* @module model/Brand2
* @version 3.0
*/
export default class Brand2 {
    /**
    * Constructs a new <code>Brand2</code>.
    * Common Brand properties.
    * @alias module:model/Brand2
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>Brand2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Brand2} obj Optional instance to populate.
    * @return {module:model/Brand2} The populated <code>Brand2</code> instance.
    */
