    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('custom_fields')) {
                obj['custom_fields'] = ApiClient.convertToType(data['custom_fields'], [AllOfproductBaseCustomFieldsItems]);
            }
            ...
            if (data.hasOwnProperty('images')) {
                obj['images'] = ApiClient.convertToType(data['images'], [AllOfproductBaseImagesItems]);
            }
            if (data.hasOwnProperty('primary_image')) {
                obj['primary_image'] = ApiClient.convertToType(data['primary_image'], Object);
            }
            if (data.hasOwnProperty('videos')) {
                obj['videos'] = ApiClient.convertToType(data['videos'], [AllOfproductBaseVideosItems]);
            }
        }
        return obj;
    }
