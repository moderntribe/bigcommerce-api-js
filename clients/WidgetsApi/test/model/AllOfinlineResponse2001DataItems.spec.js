...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfinlineResponse2001DataItems', function() {
      beforeEach(function() {
        instance = new Widgets.AllOfinlineResponse2001DataItems();
      });

      it('should create an instance of AllOfinlineResponse2001DataItems', function() {
        expect(instance).to.be.a(Widgets.AllOfinlineResponse2001DataItems);
      });
