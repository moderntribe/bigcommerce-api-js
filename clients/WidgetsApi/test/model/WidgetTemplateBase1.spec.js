...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WidgetTemplateBase1', function() {
      beforeEach(function() {
        instance = new Widgets.WidgetTemplateBase1();
      });

      it('should create an instance of WidgetTemplateBase1', function() {
        expect(instance).to.be.a(Widgets.WidgetTemplateBase1);
      });
