...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfinlineResponse2004Data', function() {
      beforeEach(function() {
        instance = new Widgets.AllOfinlineResponse2004Data();
      });

      it('should create an instance of AllOfinlineResponse2004Data', function() {
        expect(instance).to.be.a(Widgets.AllOfinlineResponse2004Data);
      });
