...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WidgetSchema', function() {
      beforeEach(function() {
        instance = new Widgets.WidgetSchema();
      });

      it('should create an instance of WidgetSchema', function() {
        expect(instance).to.be.a(Widgets.WidgetSchema);
      });
