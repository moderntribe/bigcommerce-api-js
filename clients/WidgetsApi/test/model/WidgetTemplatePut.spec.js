...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WidgetTemplatePut', function() {
      beforeEach(function() {
        instance = new Widgets.WidgetTemplatePut();
      });

      it('should create an instance of WidgetTemplatePut', function() {
        expect(instance).to.be.a(Widgets.WidgetTemplatePut);
      });
