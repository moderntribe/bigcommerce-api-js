...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WidgetTemplateBase', function() {
      beforeEach(function() {
        instance = new Widgets.WidgetTemplateBase();
      });

      it('should create an instance of WidgetTemplateBase', function() {
        expect(instance).to.be.a(Widgets.WidgetTemplateBase);
      });
