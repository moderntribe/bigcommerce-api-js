...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorBase1', function() {
      beforeEach(function() {
        instance = new Widgets.ErrorBase1();
      });

      it('should create an instance of ErrorBase1', function() {
        expect(instance).to.be.a(Widgets.ErrorBase1);
      });
