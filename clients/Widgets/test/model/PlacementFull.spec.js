...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlacementFull', function() {
      beforeEach(function() {
        instance = new Widgets.PlacementFull();
      });

      it('should create an instance of PlacementFull', function() {
        expect(instance).to.be.a(Widgets.PlacementFull);
      });
