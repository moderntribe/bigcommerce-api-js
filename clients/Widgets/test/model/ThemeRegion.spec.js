...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThemeRegion', function() {
      beforeEach(function() {
        instance = new Widgets.ThemeRegion();
      });

      it('should create an instance of ThemeRegion', function() {
        expect(instance).to.be.a(Widgets.ThemeRegion);
      });
