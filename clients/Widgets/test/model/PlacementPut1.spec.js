...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlacementPut1', function() {
      beforeEach(function() {
        instance = new Widgets.PlacementPut1();
      });

      it('should create an instance of PlacementPut1', function() {
        expect(instance).to.be.a(Widgets.PlacementPut1);
      });
