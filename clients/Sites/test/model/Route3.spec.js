...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Route3', function() {
      beforeEach(function() {
        instance = new Sites.Route3();
      });

      it('should create an instance of Route3', function() {
        expect(instance).to.be.a(Sites.Route3);
      });
      ...
      it('should have the property matching (base name: "matching")', function() {
        expect(instance).to.have.property('matching');
        // expect(instance.matching).to.be(expectedValueLiteral);
      });
