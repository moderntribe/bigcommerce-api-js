...
}(this, function(expect, OrdersV3, BCApiClient, config) {
  'use strict';
  ...
  describe('(package)', function() {
    describe('OrderRefundsApi', function() {
      describe('getorderrefunds', function() {
        it('should call getorderrefunds successfully', async function() {
      ...
      describe('postrefund', function() {
        it('should call postrefund successfully', async function() {
      ...
      describe('postrefundquote', function() {
        it('should call postrefundquote successfully', async function() {
