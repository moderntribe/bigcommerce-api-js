...
import RefundQuotePost1 from './RefundQuotePost1';
...
* @version 3.0
*/
export default class PostRefundQuotesRequest extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'RefundQuotePost1');
