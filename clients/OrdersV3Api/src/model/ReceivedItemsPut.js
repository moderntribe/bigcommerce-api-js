...
import ReceivedItemsPutInner from './ReceivedItemsPutInner';
...
* @version 3.0
*/
export default class ReceivedItemsPut extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'ReceivedItemsPutInner');
