...
import StatusUpdateFull1 from './StatusUpdateFull1';
...
* @version 3.0
*/
export default class UpdateReturnStatusesRequest extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'StatusUpdateFull1');
