...
* @version 3.0
*/
export default class TransactionPost {
    /**
    ...
    */
    ...
    constructor(event, method, amount, currency, gateway) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('offline')) {
                obj['offline'] = Offline1.constructFromObject(data['offline']);
            }
            if (data.hasOwnProperty('custom')) {
                obj['custom'] = Custom1.constructFromObject(data['custom']);
            }
    ...
    */
    'gateway_transaction_id' = undefined;
    /**
