...
import RefundRequestPost2 from './RefundRequestPost2';
...
* @version 3.0
*/
export default class PostRefundsRequest extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'RefundRequestPost2');
