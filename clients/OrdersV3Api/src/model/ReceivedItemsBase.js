...
import ReceivedItemsBaseInner from './ReceivedItemsBaseInner';
...
* @version 3.0
*/
export default class ReceivedItemsBase extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'ReceivedItemsBaseInner');
