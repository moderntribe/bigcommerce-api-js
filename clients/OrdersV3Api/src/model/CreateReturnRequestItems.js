...
* @version 3.0
*/
export default class CreateReturnRequestItems {
    /**
    ...
    */
    ...
    constructor(referenceId, quantity, preferredOutcomeId, reasonId) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('preferred_outcome_id')) {
                obj['preferred_outcome_id'] = ApiClient.convertToType(data['preferred_outcome_id'], 'Number');
            }
    ...
    */
    'preferred_outcome_id' = undefined;
    /**
