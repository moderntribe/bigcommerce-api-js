...
import CreateReturnCustomer from './CreateReturnCustomer';
import CreateReturnItems from './CreateReturnItems';
...
* @version 3.0
*/
export default class ReturnFull {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [CreateReturnItems]);
            }
            ...
            if (data.hasOwnProperty('customer')) {
                obj['customer'] = CreateReturnCustomer.constructFromObject(data['customer']);
            }
