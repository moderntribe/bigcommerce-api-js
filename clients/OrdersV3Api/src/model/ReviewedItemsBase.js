...
import ReviewedItemsBaseInner from './ReviewedItemsBaseInner';
...
* @version 3.0
*/
export default class ReviewedItemsBase extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'ReviewedItemsBaseInner');
