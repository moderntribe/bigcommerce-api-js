...
* @version 3.0
*/
export default class ReviewedItemsPutInner {
    /**
    ...
    */
    ...
    constructor(itemId, authorizedQuantity, rejectedQuantity, pendingQuantity) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('authorized_quantity')) {
                obj['authorized_quantity'] = ApiClient.convertToType(data['authorized_quantity'], 'Number');
            }
            if (data.hasOwnProperty('rejected_quantity')) {
                obj['rejected_quantity'] = ApiClient.convertToType(data['rejected_quantity'], 'Number');
            }
