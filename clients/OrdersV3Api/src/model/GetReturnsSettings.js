...
import GetReturnsSettingsPreferredOutcomes from './GetReturnsSettingsPreferredOutcomes';
import GetReturnsSettingsReasons from './GetReturnsSettingsReasons';
...
* @version 3.0
*/
export default class GetReturnsSettings {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('reasons')) {
                obj['reasons'] = ApiClient.convertToType(data['reasons'], [GetReturnsSettingsReasons]);
            }
            if (data.hasOwnProperty('preferred_outcomes')) {
                obj['preferred_outcomes'] = ApiClient.convertToType(data['preferred_outcomes'], [GetReturnsSettingsPreferredOutcomes]);
            }
        }
        return obj;
    }
