...
import GetReturnableItemsInner from './GetReturnableItemsInner';
...
* @version 3.0
*/
export default class GetReturnableItems extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'GetReturnableItemsInner');
