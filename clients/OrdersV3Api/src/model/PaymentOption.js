    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('offline_provider')) {
                obj['offline_provider'] = ApiClient.convertToType(data['offline_provider'], 'Boolean');
            }
            if (data.hasOwnProperty('offline_reason')) {
                obj['offline_reason'] = ApiClient.convertToType(data['offline_reason'], 'String');
            }
        }
        return obj;
    }
