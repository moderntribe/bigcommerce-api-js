...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfProductImageResponseData', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfProductImageResponseData();
      });

      it('should create an instance of AllOfProductImageResponseData', function() {
        expect(instance).to.be.a(Catalog.AllOfProductImageResponseData);
      });
