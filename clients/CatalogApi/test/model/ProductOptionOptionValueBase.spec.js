...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductOptionOptionValueBase', function() {
      beforeEach(function() {
        instance = new Catalog.ProductOptionOptionValueBase();
      });

      it('should create an instance of ProductOptionOptionValueBase', function() {
        expect(instance).to.be.a(Catalog.ProductOptionOptionValueBase);
      });
