...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfproductBasePrimaryImage', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfproductBasePrimaryImage();
      });

      it('should create an instance of AllOfproductBasePrimaryImage', function() {
        expect(instance).to.be.a(Catalog.AllOfproductBasePrimaryImage);
      });
