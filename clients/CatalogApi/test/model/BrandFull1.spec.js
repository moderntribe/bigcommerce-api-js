...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BrandFull1', function() {
      beforeEach(function() {
        instance = new Catalog.BrandFull1();
      });

      it('should create an instance of BrandFull1', function() {
        expect(instance).to.be.a(Catalog.BrandFull1);
      });
