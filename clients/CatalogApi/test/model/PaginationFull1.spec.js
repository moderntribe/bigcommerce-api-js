...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginationFull1', function() {
      beforeEach(function() {
        instance = new Catalog.PaginationFull1();
      });

      it('should create an instance of PaginationFull1', function() {
        expect(instance).to.be.a(Catalog.PaginationFull1);
      });
