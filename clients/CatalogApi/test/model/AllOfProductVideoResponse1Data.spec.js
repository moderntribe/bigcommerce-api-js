...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfProductVideoResponse1Data', function() {
      beforeEach(function() {
        instance = new Catalog.AllOfProductVideoResponse1Data();
      });

      it('should create an instance of AllOfProductVideoResponse1Data', function() {
        expect(instance).to.be.a(Catalog.AllOfProductVideoResponse1Data);
      });
