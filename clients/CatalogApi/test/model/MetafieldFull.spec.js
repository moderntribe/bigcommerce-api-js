...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MetafieldFull', function() {
      beforeEach(function() {
        instance = new Catalog.MetafieldFull();
      });

      it('should create an instance of MetafieldFull', function() {
        expect(instance).to.be.a(Catalog.MetafieldFull);
      });
