...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CategoriesTreeNodeFull2', function() {
      beforeEach(function() {
        instance = new Catalog.CategoriesTreeNodeFull2();
      });

      it('should create an instance of CategoriesTreeNodeFull2', function() {
        expect(instance).to.be.a(Catalog.CategoriesTreeNodeFull2);
      });
