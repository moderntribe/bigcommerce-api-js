...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResourceImage2', function() {
      beforeEach(function() {
        instance = new Catalog.ResourceImage2();
      });

      it('should create an instance of ResourceImage2', function() {
        expect(instance).to.be.a(Catalog.ResourceImage2);
      });
