...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductReviewFull', function() {
      beforeEach(function() {
        instance = new Catalog.ProductReviewFull();
      });

      it('should create an instance of ProductReviewFull', function() {
        expect(instance).to.be.a(Catalog.ProductReviewFull);
      });
