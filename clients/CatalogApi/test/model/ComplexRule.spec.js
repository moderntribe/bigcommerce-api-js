...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ComplexRule', function() {
      beforeEach(function() {
        instance = new Catalog.ComplexRule();
      });

      it('should create an instance of ComplexRule', function() {
        expect(instance).to.be.a(Catalog.ComplexRule);
      });
