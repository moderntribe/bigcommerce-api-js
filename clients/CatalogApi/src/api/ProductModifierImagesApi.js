...
* @version 3.0
*/
export default class ProductModifierImagesApi {
    ...
    */
     ...
     */
    createModifierImage(productId, modifierId, valueId, accept, contentType, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    deleteModifierImage(productId, modifierId, valueId, accept, contentType, callback) {
      let postBody = null;
