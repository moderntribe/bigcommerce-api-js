...
export default class ProductCustomFieldsApi {
    ...
    */
     ...
     */
    createCustomField(body, productId, accept, contentType, callback) {
      let postBody = body;
     ...
     */
    deleteCustomFieldById(productId, customFieldId, accept, contentType, callback) {
      let postBody = null;
     ...
     */
    getCustomFieldById(productId, customFieldId, accept, contentType, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getCustomFields(productId, accept, contentType, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * data is of type: {@link module:model/InlineResponse2003}
     */
    updateCustomField(body, productId, customFieldId, accept, contentType, callback) {
      let postBody = body;
