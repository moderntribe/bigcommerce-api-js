...
* @version 3.0
*/
export default class CategoryMetafieldsApi {
    ...
    */
     ...
     */
    createCategoryMetafield(body, categoryId, accept, contentType, callback) {
      let postBody = body;
     ...
     */
    deleteCategoryMetafieldById(metafieldId, categoryId, accept, contentType, callback) {
      let postBody = null;
     ...
     */
    getCategoryMetafieldByCategoryId(metafieldId, categoryId, accept, contentType, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = MetafieldResponse2;
     ...
     */
    getCategoryMetafieldsByCategoryId(categoryId, accept, contentType, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    updateCategoryMetafield(body, metafieldId, categoryId, accept, contentType, callback) {
      let postBody = body;
