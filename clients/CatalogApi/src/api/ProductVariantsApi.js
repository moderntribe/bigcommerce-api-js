...
import ProductVariantPost1 from '../model/ProductVariantPost1';
...
export default class ProductVariantsApi {
    ...
    */
     ...
     */
    createVariant(body, productId, callback) {
      let postBody = body;
      ...
      let returnType = VariantResponse;
     ...
     */
    createVariantImage(productId, variantId, opts, callback) {
      opts = opts || {};
     ...
     */
    deleteVariantById(productId, variantId, accept, contentType, callback) {
      let postBody = null;
     ...
     * data is of type: {@link module:model/VariantResponse}
     */
    getVariantById(productId, variantId, accept, contentType, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getVariantsByProductId(productId, accept, contentType, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * data is of type: {@link module:model/VariantResponse}
     */
    updateVariant(body, productId, variantId, accept, contentType, callback) {
      let postBody = body;
