...
import CategoriesTreeNodeFull1 from './CategoriesTreeNodeFull1';
...
* @version 3.0
*/
export default class CategoriesTreeNodeFull2 {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('children')) {
                obj['children'] = ApiClient.convertToType(data['children'], [CategoriesTreeNodeFull1]);
            }
        }
        return obj;
    }
