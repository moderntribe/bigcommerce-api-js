...
import CategoriesTreeNodeFull from './CategoriesTreeNodeFull';
...
* @version 3.0
*/
export default class CategoriesTreeNodeFull1 {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('children')) {
                obj['children'] = ApiClient.convertToType(data['children'], [CategoriesTreeNodeFull]);
            }
        }
        return obj;
    }
