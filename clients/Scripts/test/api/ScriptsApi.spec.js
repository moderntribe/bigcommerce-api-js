...
}(this, function(expect, Scripts, BCApiClient, config) {
  'use strict';
  ...
  describe('(package)', function() {
    describe('ScriptsApi', function() {
      describe('createScript', function() {
        it('should call createScript successfully', async function() {
      ...
      describe('deleteScript', function() {
        it('should call deleteScript successfully', async function() {
      ...
      describe('getScript', function() {
        it('should call getScript successfully', async function() {
      ...
      describe('getScripts', function() {
        it('should call getScripts successfully', async function() {
      ...
      describe('updateScript', function() {
        it('should call updateScript successfully', async function() {
