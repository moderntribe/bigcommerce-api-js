...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScriptFull', function() {
      beforeEach(function() {
        instance = new Scripts.ScriptFull();
      });

      it('should create an instance of ScriptFull', function() {
        expect(instance).to.be.a(Scripts.ScriptFull);
      });
