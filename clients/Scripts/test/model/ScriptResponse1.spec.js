...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScriptResponse1', function() {
      beforeEach(function() {
        instance = new Scripts.ScriptResponse1();
      });

      it('should create an instance of ScriptResponse1', function() {
        expect(instance).to.be.a(Scripts.ScriptResponse1);
      });
