...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfscriptResponseCollectionDataItems', function() {
      beforeEach(function() {
        instance = new Scripts.AllOfscriptResponseCollectionDataItems();
      });

      it('should create an instance of AllOfscriptResponseCollectionDataItems', function() {
        expect(instance).to.be.a(Scripts.AllOfscriptResponseCollectionDataItems);
      });
