...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScriptsResponse', function() {
      beforeEach(function() {
        instance = new Scripts.ScriptsResponse();
      });

      it('should create an instance of ScriptsResponse', function() {
        expect(instance).to.be.a(Scripts.ScriptsResponse);
      });
