...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScriptPost1', function() {
      beforeEach(function() {
        instance = new Scripts.ScriptPost1();
      });

      it('should create an instance of ScriptPost1', function() {
        expect(instance).to.be.a(Scripts.ScriptPost1);
      });
