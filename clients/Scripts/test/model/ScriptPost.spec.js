...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScriptPost', function() {
      beforeEach(function() {
        instance = new Scripts.ScriptPost();
      });

      it('should create an instance of ScriptPost', function() {
        expect(instance).to.be.a(Scripts.ScriptPost);
      });
