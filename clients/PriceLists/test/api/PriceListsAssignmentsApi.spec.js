  ...
  describe('(package)', function() {
    describe('PriceListsAssignmentsApi', function() {
      describe('createPriceListAssignments', function() {
        it('should call createPriceListAssignments successfully', async function() {
      ...
      describe('deletePriceListAssignmentsByFilter', function() {
        it('should call deletePriceListAssignmentsByFilter successfully', async function() {
      ...
      describe('getListOfPriceListAssignments', function() {
        it('should call getListOfPriceListAssignments successfully', async function() {
