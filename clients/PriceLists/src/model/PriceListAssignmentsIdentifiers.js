...
/**
* The PriceListAssignmentsIdentifiers model module.
* @module model/PriceListAssignmentsIdentifiers
* @version 3.0
*/
export default class PriceListAssignmentsIdentifiers {
    /**
    * Constructs a new <code>PriceListAssignmentsIdentifiers</code>.
    * &#x60;Price List Assignments&#x60; object used in GET response.
    * @alias module:model/PriceListAssignmentsIdentifiers
    * @class
    */
    ...
    /**
    * Constructs a <code>PriceListAssignmentsIdentifiers</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PriceListAssignmentsIdentifiers} obj Optional instance to populate.
    * @return {module:model/PriceListAssignmentsIdentifiers} The populated <code>PriceListAssignmentsIdentifiers</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PriceListAssignmentsIdentifiers();
