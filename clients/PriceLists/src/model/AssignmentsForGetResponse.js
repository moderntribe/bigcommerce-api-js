...
import AssignmentsForGetResponseData from './AssignmentsForGetResponseData';
...
* @version 3.0
*/
export default class AssignmentsForGetResponse {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [AssignmentsForGetResponseData]);
            }
