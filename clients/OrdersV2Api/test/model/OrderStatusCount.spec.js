...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderStatusCount', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderStatusCount();
      });

      it('should create an instance of OrderStatusCount', function() {
        expect(instance).to.be.a(OrdersV2.OrderStatusCount);
      });
