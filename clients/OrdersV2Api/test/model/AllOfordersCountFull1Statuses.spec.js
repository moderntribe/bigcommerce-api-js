...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfordersCountFull1Statuses', function() {
      beforeEach(function() {
        instance = new OrdersV2.AllOfordersCountFull1Statuses();
      });

      it('should create an instance of AllOfordersCountFull1Statuses', function() {
        expect(instance).to.be.a(OrdersV2.AllOfordersCountFull1Statuses);
      });
