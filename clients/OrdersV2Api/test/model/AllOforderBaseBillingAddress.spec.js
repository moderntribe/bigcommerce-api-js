...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOforderBaseBillingAddress', function() {
      beforeEach(function() {
        instance = new OrdersV2.AllOforderBaseBillingAddress();
      });

      it('should create an instance of AllOforderBaseBillingAddress', function() {
        expect(instance).to.be.a(OrdersV2.AllOforderBaseBillingAddress);
      });
