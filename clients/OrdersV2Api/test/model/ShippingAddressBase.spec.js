...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShippingAddressBase', function() {
      beforeEach(function() {
        instance = new OrdersV2.ShippingAddressBase();
      });

      it('should create an instance of ShippingAddressBase', function() {
        expect(instance).to.be.a(OrdersV2.ShippingAddressBase);
      });
