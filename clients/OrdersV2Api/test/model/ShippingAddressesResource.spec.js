...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShippingAddressesResource', function() {
      beforeEach(function() {
        instance = new OrdersV2.ShippingAddressesResource();
      });

      it('should create an instance of ShippingAddressesResource', function() {
        expect(instance).to.be.a(OrdersV2.ShippingAddressesResource);
      });
