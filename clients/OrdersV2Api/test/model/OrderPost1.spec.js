...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderPost1', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderPost1();
      });

      it('should create an instance of OrderPost1', function() {
        expect(instance).to.be.a(OrdersV2.OrderPost1);
      });
