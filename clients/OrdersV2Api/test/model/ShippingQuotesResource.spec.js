...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShippingQuotesResource', function() {
      beforeEach(function() {
        instance = new OrdersV2.ShippingQuotesResource();
      });

      it('should create an instance of ShippingQuotesResource', function() {
        expect(instance).to.be.a(OrdersV2.ShippingQuotesResource);
      });
