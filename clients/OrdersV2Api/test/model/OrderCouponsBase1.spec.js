...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderCouponsBase1', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderCouponsBase1();
      });

      it('should create an instance of OrderCouponsBase1', function() {
        expect(instance).to.be.a(OrdersV2.OrderCouponsBase1);
      });
      ...
      it('should have the property coupon_id (base name: "coupon_id")', function() {
        expect(instance).to.have.property('coupon_id');
        // expect(instance.coupon_id).to.be(expectedValueLiteral);
      });
