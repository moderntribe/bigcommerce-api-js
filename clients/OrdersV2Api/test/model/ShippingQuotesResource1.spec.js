...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShippingQuotesResource1', function() {
      beforeEach(function() {
        instance = new OrdersV2.ShippingQuotesResource1();
      });

      it('should create an instance of ShippingQuotesResource1', function() {
        expect(instance).to.be.a(OrdersV2.ShippingQuotesResource1);
      });
