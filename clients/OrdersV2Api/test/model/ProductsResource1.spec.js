...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductsResource1', function() {
      beforeEach(function() {
        instance = new OrdersV2.ProductsResource1();
      });

      it('should create an instance of ProductsResource1', function() {
        expect(instance).to.be.a(OrdersV2.ProductsResource1);
      });
