...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrdersShippingAddresses', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrdersShippingAddresses();
      });

      it('should create an instance of OrdersShippingAddresses', function() {
        expect(instance).to.be.a(OrdersV2.OrdersShippingAddresses);
      });
