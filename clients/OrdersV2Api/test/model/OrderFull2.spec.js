...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderFull2', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderFull2();
      });

      it('should create an instance of OrderFull2', function() {
        expect(instance).to.be.a(OrdersV2.OrderFull2);
      });
