...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderProducts2', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderProducts2();
      });

      it('should create an instance of OrderProducts2', function() {
        expect(instance).to.be.a(OrdersV2.OrderProducts2);
      });
