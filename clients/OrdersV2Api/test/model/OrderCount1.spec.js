...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderCount1', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderCount1();
      });

      it('should create an instance of OrderCount1', function() {
        expect(instance).to.be.a(OrdersV2.OrderCount1);
      });
