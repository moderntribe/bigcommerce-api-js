...
* @version 2.0
*/
export default class OrderShippingAddressesQuotesApi {
    ...
    */
     ...
     */
    getShippingQuotes(orderId, shippingAddressId, accept, contentType, callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json', 'Fixed Shipping', 'UPS Example'];
      let returnType = ShippingQuotesBase1;
