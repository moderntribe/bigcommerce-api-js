...
}(this, function(expect, PriceLists, BCApiClient, config) {
  'use strict';
  ...
  describe('(package)', function() {
    describe('PriceListsRecordsApi', function() {
      describe('deletePriceListRecord', function() {
        it('should call deletePriceListRecord successfully', async function() {
      ...
      describe('deletePriceListRecordsByFilter', function() {
        it('should call deletePriceListRecordsByFilter successfully', async function() {
      ...
      describe('getPriceListRecord', function() {
        it('should call getPriceListRecord successfully', async function() {
      ...
      describe('getPriceListRecordCollection', function() {
        it('should call getPriceListRecordCollection successfully', async function() {
      ...
      describe('getPriceListRecordsByVariantId', function() {
        it('should call getPriceListRecordsByVariantId successfully', async function() {
      ...
      describe('setPriceListRecord', function() {
        it('should call setPriceListRecord successfully', async function() {
      ...
      describe('setPriceListRecordCollection', function() {
        it('should call setPriceListRecordCollection successfully', async function() {
