...
/**
* The PriceListPost model module.
* @module model/PriceListPost
* @version 3.0
*/
export default class PriceListPost {
    /**
    * Constructs a new <code>PriceListPost</code>.
    * Creates a Price List. 
    * @alias module:model/PriceListPost
    * @class
    */
    ...
    /**
    * Constructs a <code>PriceListPost</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PriceListPost} obj Optional instance to populate.
    * @return {module:model/PriceListPost} The populated <code>PriceListPost</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PriceListPost();
