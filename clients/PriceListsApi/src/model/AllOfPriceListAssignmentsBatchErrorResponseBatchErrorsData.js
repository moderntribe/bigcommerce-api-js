...
/**
* The AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData model module.
* @module model/AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData
* @version 3.0
*/
export default class AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData {
    /**
    * Constructs a new <code>AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData</code>.
    * &#x60;Price List Assignments&#x60; object used in GET response.
    * @alias module:model/AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData
    * @class
    */
    ...
    /**
    * Constructs a <code>AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData} obj Optional instance to populate.
    * @return {module:model/AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData} The populated <code>AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData();
