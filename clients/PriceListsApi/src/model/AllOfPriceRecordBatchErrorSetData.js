...
/**
* The AllOfPriceRecordBatchErrorSetData model module.
* @module model/AllOfPriceRecordBatchErrorSetData
* @version 3.0
*/
export default class AllOfPriceRecordBatchErrorSetData {
    /**
    * Constructs a new <code>AllOfPriceRecordBatchErrorSetData</code>.
    * Price Record object used in batch create or update.
    * @alias module:model/AllOfPriceRecordBatchErrorSetData
    * @class
    */
    ...
    /**
    * Constructs a <code>AllOfPriceRecordBatchErrorSetData</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfPriceRecordBatchErrorSetData} obj Optional instance to populate.
    * @return {module:model/AllOfPriceRecordBatchErrorSetData} The populated <code>AllOfPriceRecordBatchErrorSetData</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOfPriceRecordBatchErrorSetData();
