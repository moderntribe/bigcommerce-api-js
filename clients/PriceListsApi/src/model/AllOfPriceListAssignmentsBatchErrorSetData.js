...
/**
* The AllOfPriceListAssignmentsBatchErrorSetData model module.
* @module model/AllOfPriceListAssignmentsBatchErrorSetData
* @version 3.0
*/
export default class AllOfPriceListAssignmentsBatchErrorSetData {
    /**
    * Constructs a new <code>AllOfPriceListAssignmentsBatchErrorSetData</code>.
    * &#x60;Price List Assignments&#x60; object used in GET response.
    * @alias module:model/AllOfPriceListAssignmentsBatchErrorSetData
    * @class
    */
    ...
    /**
    * Constructs a <code>AllOfPriceListAssignmentsBatchErrorSetData</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfPriceListAssignmentsBatchErrorSetData} obj Optional instance to populate.
    * @return {module:model/AllOfPriceListAssignmentsBatchErrorSetData} The populated <code>AllOfPriceListAssignmentsBatchErrorSetData</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllOfPriceListAssignmentsBatchErrorSetData();
