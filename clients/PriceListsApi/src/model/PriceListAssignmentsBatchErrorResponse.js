...
import PriceListAssignmentsBatchErrorResponseBatchErrors from './PriceListAssignmentsBatchErrorResponseBatchErrors';
...
* @version 3.0
*/
export default class PriceListAssignmentsBatchErrorResponse {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('batch_errors')) {
                obj['batch_errors'] = ApiClient.convertToType(data['batch_errors'], [PriceListAssignmentsBatchErrorResponseBatchErrors]);
            }
        }
        return obj;
    }
