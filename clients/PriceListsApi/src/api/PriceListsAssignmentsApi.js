...
* @version 3.0
*/
export default class PriceListsAssignmentsApi {
    ...
    */
     ...
     */
    createPriceListAssignments(body, callback) {
      let postBody = body;
     ...
     */
    deletePriceListAssignmentsByFilter(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getListOfPriceListAssignments(opts, callback) {
      opts = opts || {};
      let postBody = null;
