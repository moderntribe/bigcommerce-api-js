...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WishlistItemPost1', function() {
      beforeEach(function() {
        instance = new Wishlist.WishlistItemPost1();
      });

      it('should create an instance of WishlistItemPost1', function() {
        expect(instance).to.be.a(Wishlist.WishlistItemPost1);
      });
