...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WishlistItemFull', function() {
      beforeEach(function() {
        instance = new Wishlist.WishlistItemFull();
      });

      it('should create an instance of WishlistItemFull', function() {
        expect(instance).to.be.a(Wishlist.WishlistItemFull);
      });
