...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WishlistPost', function() {
      beforeEach(function() {
        instance = new Wishlist.WishlistPost();
      });

      it('should create an instance of WishlistPost', function() {
        expect(instance).to.be.a(Wishlist.WishlistPost);
      });
