...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddItemToWishlist', function() {
      beforeEach(function() {
        instance = new Wishlist.AddItemToWishlist();
      });

      it('should create an instance of AddItemToWishlist', function() {
        expect(instance).to.be.a(Wishlist.AddItemToWishlist);
      });
