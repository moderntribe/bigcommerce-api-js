...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriberPut1', function() {
      beforeEach(function() {
        instance = new Subscribers.SubscriberPut1();
      });

      it('should create an instance of SubscriberPut1', function() {
        expect(instance).to.be.a(Subscribers.SubscriberPut1);
      });
