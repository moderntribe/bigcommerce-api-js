...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfSubscriberResponseData', function() {
      beforeEach(function() {
        instance = new Subscribers.AllOfSubscriberResponseData();
      });

      it('should create an instance of AllOfSubscriberResponseData', function() {
        expect(instance).to.be.a(Subscribers.AllOfSubscriberResponseData);
      });
