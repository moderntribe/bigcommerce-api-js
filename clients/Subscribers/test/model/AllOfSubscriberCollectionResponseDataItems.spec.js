...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfSubscriberCollectionResponseDataItems', function() {
      beforeEach(function() {
        instance = new Subscribers.AllOfSubscriberCollectionResponseDataItems();
      });

      it('should create an instance of AllOfSubscriberCollectionResponseDataItems', function() {
        expect(instance).to.be.a(Subscribers.AllOfSubscriberCollectionResponseDataItems);
      });
