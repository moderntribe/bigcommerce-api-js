...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriberFull', function() {
      beforeEach(function() {
        instance = new Subscribers.SubscriberFull();
      });

      it('should create an instance of SubscriberFull', function() {
        expect(instance).to.be.a(Subscribers.SubscriberFull);
      });
