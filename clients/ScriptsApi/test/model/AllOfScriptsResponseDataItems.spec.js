...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfScriptsResponseDataItems', function() {
      beforeEach(function() {
        instance = new Scripts.AllOfScriptsResponseDataItems();
      });

      it('should create an instance of AllOfScriptsResponseDataItems', function() {
        expect(instance).to.be.a(Scripts.AllOfScriptsResponseDataItems);
      });
