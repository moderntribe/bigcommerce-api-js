...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfscriptResponse1Data', function() {
      beforeEach(function() {
        instance = new Scripts.AllOfscriptResponse1Data();
      });

      it('should create an instance of AllOfscriptResponse1Data', function() {
        expect(instance).to.be.a(Scripts.AllOfscriptResponse1Data);
      });
