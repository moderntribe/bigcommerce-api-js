...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderShipment2', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderShipment2();
      });

      it('should create an instance of OrderShipment2', function() {
        expect(instance).to.be.a(OrdersV2.OrderShipment2);
      });
