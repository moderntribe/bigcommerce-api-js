...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderStatusBase', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderStatusBase();
      });

      it('should create an instance of OrderStatusBase', function() {
        expect(instance).to.be.a(OrdersV2.OrderStatusBase);
      });
