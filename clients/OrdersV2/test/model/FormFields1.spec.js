...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FormFields1', function() {
      beforeEach(function() {
        instance = new OrdersV2.FormFields1();
      });

      it('should create an instance of FormFields1', function() {
        expect(instance).to.be.a(OrdersV2.FormFields1);
      });
