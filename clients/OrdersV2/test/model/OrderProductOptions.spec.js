...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderProductOptions', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderProductOptions();
      });

      it('should create an instance of OrderProductOptions', function() {
        expect(instance).to.be.a(OrdersV2.OrderProductOptions);
      });
