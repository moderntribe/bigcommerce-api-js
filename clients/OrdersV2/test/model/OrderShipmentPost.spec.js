...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderShipmentPost', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderShipmentPost();
      });

      it('should create an instance of OrderShipmentPost', function() {
        expect(instance).to.be.a(OrdersV2.OrderShipmentPost);
      });
