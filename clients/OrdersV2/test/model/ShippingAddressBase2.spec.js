...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShippingAddressBase2', function() {
      beforeEach(function() {
        instance = new OrdersV2.ShippingAddressBase2();
      });

      it('should create an instance of ShippingAddressBase2', function() {
        expect(instance).to.be.a(OrdersV2.ShippingAddressBase2);
      });
