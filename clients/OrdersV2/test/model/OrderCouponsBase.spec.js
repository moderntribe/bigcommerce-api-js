...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderCouponsBase', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderCouponsBase();
      });

      it('should create an instance of OrderCouponsBase', function() {
        expect(instance).to.be.a(OrdersV2.OrderCouponsBase);
      });
