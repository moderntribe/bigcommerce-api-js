...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BillingAddressFull', function() {
      beforeEach(function() {
        instance = new OrdersV2.BillingAddressFull();
      });

      it('should create an instance of BillingAddressFull', function() {
        expect(instance).to.be.a(OrdersV2.BillingAddressFull);
      });
