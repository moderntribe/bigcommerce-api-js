...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfordersCountFullStatuses', function() {
      beforeEach(function() {
        instance = new OrdersV2.AllOfordersCountFullStatuses();
      });

      it('should create an instance of AllOfordersCountFullStatuses', function() {
        expect(instance).to.be.a(OrdersV2.AllOfordersCountFullStatuses);
      });
