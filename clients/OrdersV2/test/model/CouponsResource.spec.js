...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponsResource', function() {
      beforeEach(function() {
        instance = new OrdersV2.CouponsResource();
      });

      it('should create an instance of CouponsResource', function() {
        expect(instance).to.be.a(OrdersV2.CouponsResource);
      });
