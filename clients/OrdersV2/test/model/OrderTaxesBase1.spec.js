...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderTaxesBase1', function() {
      beforeEach(function() {
        instance = new OrdersV2.OrderTaxesBase1();
      });

      it('should create an instance of OrderTaxesBase1', function() {
        expect(instance).to.be.a(OrdersV2.OrderTaxesBase1);
      });
      ...
      it('should have the property tax_rate_id (base name: "tax_rate_id")', function() {
        expect(instance).to.have.property('tax_rate_id');
        // expect(instance.tax_rate_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property class (base name: "class")', function() {
        expect(instance).to.have.property('class');
        // expect(instance.class).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property priority_amount (base name: "priority_amount")', function() {
        expect(instance).to.have.property('priority_amount');
        // expect(instance.priority_amount).to.be(expectedValueLiteral);
      });

      it('should have the property line_amount (base name: "line_amount")', function() {
        expect(instance).to.have.property('line_amount');
        // expect(instance.line_amount).to.be(expectedValueLiteral);
      });

      it('should have the property order_product_id (base name: "order_product_id")', function() {
        expect(instance).to.have.property('order_product_id');
        // expect(instance.order_product_id).to.be(expectedValueLiteral);
      });

      it('should have the property line_item_type (base name: "line_item_type")', function() {
        expect(instance).to.have.property('line_item_type');
        // expect(instance.line_item_type).to.be(expectedValueLiteral);
      });
