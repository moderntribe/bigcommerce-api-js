...
import BillingAddressBase1 from './BillingAddressBase1';
...
* @version 2.0
*/
export default class OrderShipment1 {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('billing_address')) {
                obj['billing_address'] = BillingAddressBase1.constructFromObject(data['billing_address']);
            }
            if (data.hasOwnProperty('shipping_address')) {
                obj['shipping_address'] = ShippingAddressBase1.constructFromObject(data['shipping_address']);
            }
