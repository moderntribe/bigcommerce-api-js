...
<a name="storeGet"></a>
# **storeGet**
> StoreInformation storeGet(accept, contentType)
...
let apiInstance = new StoreInformation.StoreInformationApi();
let accept = "application/json"; // String | 
let contentType = "application/json"; // String | 

apiInstance.storeGet(accept, contentType, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
