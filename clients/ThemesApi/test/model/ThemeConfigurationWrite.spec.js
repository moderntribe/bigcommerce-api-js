...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThemeConfigurationWrite', function() {
      beforeEach(function() {
        instance = new Themes.ThemeConfigurationWrite();
      });

      it('should create an instance of ThemeConfigurationWrite', function() {
        expect(instance).to.be.a(Themes.ThemeConfigurationWrite);
      });
