...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WhichThemeToDownload', function() {
      beforeEach(function() {
        instance = new Themes.WhichThemeToDownload();
      });

      it('should create an instance of WhichThemeToDownload', function() {
        expect(instance).to.be.a(Themes.WhichThemeToDownload);
      });
