...
import CreateReturnRequestItems from './CreateReturnRequestItems';
...
* @version 3.0
*/
export default class CreateReturnRequest {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [CreateReturnRequestItems]);
            }
