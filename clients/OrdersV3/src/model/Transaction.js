...
import AVSResults from './AVSResults';
import CVVResult from './CVVResult';
import CreditCard from './CreditCard';
import GiftCertificate from './GiftCertificate';
import TransactionStoreCredit from './TransactionStoreCredit';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('avs_result')) {
                obj['avs_result'] = AVSResults.constructFromObject(data['avs_result']);
            }
            ...
            if (data.hasOwnProperty('store_credit')) {
                obj['store_credit'] = TransactionStoreCredit.constructFromObject(data['store_credit']);
            }
        }
        return obj;
    }
