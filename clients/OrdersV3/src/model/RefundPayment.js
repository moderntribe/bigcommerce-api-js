...
* @version 3.0
*/
export default class RefundPayment {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('is_declined')) {
                obj['is_declined'] = ApiClient.convertToType(data['is_declined'], 'Boolean');
            }
            if (data.hasOwnProperty('declined_message')) {
                obj['declined_message'] = ApiClient.convertToType(data['declined_message'], 'String');
            }
        }
        return obj;
    }
