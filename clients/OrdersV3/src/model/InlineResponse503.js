...
import FailedQuoteError1 from './FailedQuoteError1';
...
* @version 3.0
*/
export default class InlineResponse503 {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [FailedQuoteError1]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = Meta1.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
