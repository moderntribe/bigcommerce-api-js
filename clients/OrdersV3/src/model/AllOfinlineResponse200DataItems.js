...
export default class AllOfinlineResponse200DataItems {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('avs_result')) {
                obj['avs_result'] = ApiClient.convertToType(data['avs_result'], Object);
            }
            if (data.hasOwnProperty('cvv_result')) {
                obj['cvv_result'] = ApiClient.convertToType(data['cvv_result'], Object);
            }
            if (data.hasOwnProperty('credit_card')) {
                obj['credit_card'] = ApiClient.convertToType(data['credit_card'], Object);
            }
            if (data.hasOwnProperty('gift_certificate')) {
                obj['gift_certificate'] = ApiClient.convertToType(data['gift_certificate'], Object);
            }
            if (data.hasOwnProperty('store_credit')) {
                obj['store_credit'] = ApiClient.convertToType(data['store_credit'], Object);
            }
        }
        return obj;
    }
    ...
    */
    'payment_instrument_token' = undefined;
    /**
