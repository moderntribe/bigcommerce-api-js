...
import UpdateReturnStatusesInner from './UpdateReturnStatusesInner';
...
* @version 3.0
*/
export default class UpdateReturnStatuses extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'UpdateReturnStatusesInner');
