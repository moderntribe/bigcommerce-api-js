...
import ReviewedItemsPutInner from './ReviewedItemsPutInner';
...
* @version 3.0
*/
export default class ReviewedItemsPut extends Array {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ApiClient.constructFromObject(data, obj, 'ReviewedItemsPutInner');
