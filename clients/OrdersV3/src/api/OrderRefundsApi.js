...
* @version 3.0
*/
export default class OrderRefundsApi {
    ...
    */
     ...
     */
    getorderrefunds(orderId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/orders/{order_id}/payment_actions/refunds', 'GET',
     ...
     */
    postrefund(body, orderId, opts, callback) {
      opts = opts || {};
      let postBody = body;
      ...
      return this.apiClient.callApi(
        '/orders/{order_id}/payment_actions/refunds', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     */
    postrefundquote(body, orderId, opts, callback) {
      opts = opts || {};
      let postBody = body;
      ...
      return this.apiClient.callApi(
        '/orders/{order_id}/payment_actions/refund_quotes', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
