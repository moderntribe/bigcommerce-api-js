...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfinlineResponse200DataItems', function() {
      beforeEach(function() {
        instance = new OrdersV3.AllOfinlineResponse200DataItems();
      });

      it('should create an instance of AllOfinlineResponse200DataItems', function() {
        expect(instance).to.be.a(OrdersV3.AllOfinlineResponse200DataItems);
      });
      ...
      it('should have the property payment_instrument_token (base name: "payment_instrument_token")', function() {
        expect(instance).to.have.property('payment_instrument_token');
        // expect(instance.payment_instrument_token).to.be(expectedValueLiteral);
      });

      it('should have the property avs_result (base name: "avs_result")', function() {
        expect(instance).to.have.property('avs_result');
        // expect(instance.avs_result).to.be(expectedValueLiteral);
      });

      it('should have the property cvv_result (base name: "cvv_result")', function() {
        expect(instance).to.have.property('cvv_result');
        // expect(instance.cvv_result).to.be(expectedValueLiteral);
      });

      it('should have the property credit_card (base name: "credit_card")', function() {
        expect(instance).to.have.property('credit_card');
        // expect(instance.credit_card).to.be(expectedValueLiteral);
      });

      it('should have the property gift_certificate (base name: "gift_certificate")', function() {
        expect(instance).to.have.property('gift_certificate');
        // expect(instance.gift_certificate).to.be(expectedValueLiteral);
      });

      it('should have the property store_credit (base name: "store_credit")', function() {
        expect(instance).to.have.property('store_credit');
        // expect(instance.store_credit).to.be(expectedValueLiteral);
      });
