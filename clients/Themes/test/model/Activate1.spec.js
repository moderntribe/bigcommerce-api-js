...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Activate1', function() {
      beforeEach(function() {
        instance = new Themes.Activate1();
      });

      it('should create an instance of Activate1', function() {
        expect(instance).to.be.a(Themes.Activate1);
      });
      ...
      it('should have the property which (base name: "which")', function() {
        expect(instance).to.have.property('which');
        // expect(instance.which).to.be(expectedValueLiteral);
      });
