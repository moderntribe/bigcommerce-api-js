...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThemesCollectionResponseData', function() {
      beforeEach(function() {
        instance = new Themes.ThemesCollectionResponseData();
      });

      it('should create an instance of ThemesCollectionResponseData', function() {
        expect(instance).to.be.a(Themes.ThemesCollectionResponseData);
      });
      ...
      it('should have the property is_private (base name: "is_private")', function() {
        expect(instance).to.have.property('is_private');
        // expect(instance.is_private).to.be(expectedValueLiteral);
      });
