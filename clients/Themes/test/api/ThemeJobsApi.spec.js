...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Themes.ThemeJobsApi(new BCApiClient(config));
  });

  describe('(package)', function() {
    describe('ThemeJobsApi', function() {
      describe('getJob', function() {
        it('should call getJob successfully', async function() {
          // const getJobResponse = await instance.getJob();
          // expect(getJobResponse.ok).to.be(true);
          // expect(getJobResponse.body.data).to.be.an('array');
        });
      });
    });
  });
