...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Sites.SitesApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('SitesApi', function () {
      describe('deleteSite', function () {
        it('should call deleteSite successfully', _asyncToGenerator(function* () {
          // const deleteSiteResponse = await instance.deleteSite();
          // expect(deleteSiteResponse.ok).to.be(true);
          // expect(deleteSiteResponse.body.data).to.be.an('array');
        }));
      });
      describe('getSite', function () {
        it('should call getSite successfully', _asyncToGenerator(function* () {
          // const getSiteResponse = await instance.getSite();
          // expect(getSiteResponse.ok).to.be(true);
          // expect(getSiteResponse.body.data).to.be.an('array');
        }));
      });
      describe('postSite', function () {
        it('should call postSite successfully', _asyncToGenerator(function* () {
          // const postSiteResponse = await instance.postSite();
          // expect(postSiteResponse.ok).to.be(true);
          // expect(postSiteResponse.body.data).to.be.an('array');
        }));
      });
      describe('putSite', function () {
        it('should call putSite successfully', _asyncToGenerator(function* () {
          // const putSiteResponse = await instance.putSite();
          // expect(putSiteResponse.ok).to.be(true);
          // expect(putSiteResponse.body.data).to.be.an('array');
        }));
      });
      describe('sitesGet', function () {
        it('should call sitesGet successfully', _asyncToGenerator(function* () {
          // const sitesGetResponse = await instance.sitesGet();
          // expect(sitesGetResponse.ok).to.be(true);
          // expect(sitesGetResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
