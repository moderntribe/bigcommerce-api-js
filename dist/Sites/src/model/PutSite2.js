...
/**
* The PutSite2 model module.
* @module model/PutSite2
* @version 3.0
*/
var PutSite2 = function () {
    /**
    * Constructs a new <code>PutSite2</code>.
    * @alias module:model/PutSite2
    * @class
    */

    function PutSite2() {
        _classCallCheck(this, PutSite2);

        this['url'] = undefined;
    }

    /**
    * Constructs a <code>PutSite2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PutSite2} obj Optional instance to populate.
    * @return {module:model/PutSite2} The populated <code>PutSite2</code> instance.
    */


    _createClass(PutSite2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PutSite2();
