...
/**
* The Site2 model module.
* @module model/Site2
* @version 3.0
*/
var Site2 = function () {
    /**
    * Constructs a new <code>Site2</code>.
    * @alias module:model/Site2
    * @class
    */

    function Site2() {
        _classCallCheck(this, Site2);
    ...
    /**
    * Constructs a <code>Site2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Site2} obj Optional instance to populate.
    * @return {module:model/Site2} The populated <code>Site2</code> instance.
    */


    _createClass(Site2, null, [{
