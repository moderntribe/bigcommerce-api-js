...
/**
* The Route4 model module.
* @module model/Route4
* @version 3.0
*/
var Route4 = function () {
  /**
  * Constructs a new <code>Route4</code>.
  * @alias module:model/Route4
  * @class
  */

  function Route4() {
    _classCallCheck(this, Route4);
  ...
  /**
  * Constructs a <code>Route4</code> from a plain JavaScript object, optionally creating a new instance.
  * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
  * @param {Object} data The plain JavaScript object bearing properties of interest.
  * @param {module:model/Route4} obj Optional instance to populate.
  * @return {module:model/Route4} The populated <code>Route4</code> instance.
  */


  _createClass(Route4, null, [{
    ...
    * @member {module:model/Route4.TypeEnum} type
    */
