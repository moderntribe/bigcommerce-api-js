...
/**
* The Route3 model module.
* @module model/Route3
* @version 3.0
*/
var Route3 = function () {
  /**
  * Constructs a new <code>Route3</code>.
  * @alias module:model/Route3
  * @class
  */

  function Route3() {
    _classCallCheck(this, Route3);
  ...
  /**
  * Constructs a <code>Route3</code> from a plain JavaScript object, optionally creating a new instance.
  * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
  * @param {Object} data The plain JavaScript object bearing properties of interest.
  * @param {module:model/Route3} obj Optional instance to populate.
  * @return {module:model/Route3} The populated <code>Route3</code> instance.
  */


  _createClass(Route3, null, [{
    ...
    * @member {module:model/Route3.TypeEnum} type
    */
