...
/**
* The PutSite model module.
* @module model/PutSite
* @version 3.0
*/
var PutSite = function () {
    /**
    * Constructs a new <code>PutSite</code>.
    * @alias module:model/PutSite
    * @class
    */

    function PutSite() {
        _classCallCheck(this, PutSite);

        this['url'] = undefined;
    }

    /**
    * Constructs a <code>PutSite</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PutSite} obj Optional instance to populate.
    * @return {module:model/PutSite} The populated <code>PutSite</code> instance.
    */


    _createClass(PutSite, null, [{
