...
/**
* The MetaEmpty model module.
* @module model/MetaEmpty
* @version 3.0
*/
var MetaEmpty = function () {
    /**
    * Constructs a new <code>MetaEmpty</code>.
    * Empty meta object; may be used later.
    * @alias module:model/MetaEmpty
    * @class
    */

    function MetaEmpty() {
        _classCallCheck(this, MetaEmpty);
    }

    /**
    * Constructs a <code>MetaEmpty</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MetaEmpty} obj Optional instance to populate.
    * @return {module:model/MetaEmpty} The populated <code>MetaEmpty</code> instance.
    */


    _createClass(MetaEmpty, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new MetaEmpty();
            }
            return obj;
        }
    }]);
