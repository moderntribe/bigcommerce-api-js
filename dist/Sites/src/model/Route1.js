...
/**
* The Route1 model module.
* @module model/Route1
* @version 3.0
*/
var Route1 = function () {
  /**
  * Constructs a new <code>Route1</code>.
  * @alias module:model/Route1
  * @class
  */
  ...
  /**
  * Constructs a <code>Route1</code> from a plain JavaScript object, optionally creating a new instance.
  * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
  * @param {Object} data The plain JavaScript object bearing properties of interest.
  * @param {module:model/Route1} obj Optional instance to populate.
  * @return {module:model/Route1} The populated <code>Route1</code> instance.
  */


  _createClass(Route1, null, [{
    ...
    * @member {module:model/Route1.TypeEnum} type
    */
