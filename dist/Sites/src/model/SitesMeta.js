...
/**
* The SitesMeta model module.
* @module model/SitesMeta
* @version 3.0
*/
var SitesMeta = function () {
    /**
    * Constructs a new <code>SitesMeta</code>.
    * @alias module:model/SitesMeta
    * @class
    */

    function SitesMeta() {
        _classCallCheck(this, SitesMeta);

        this['pagination'] = undefined;
    }

    /**
    * Constructs a <code>SitesMeta</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SitesMeta} obj Optional instance to populate.
    * @return {module:model/SitesMeta} The populated <code>SitesMeta</code> instance.
    */


    _createClass(SitesMeta, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new SitesMeta();
