...
/**
* The PutSite1 model module.
* @module model/PutSite1
* @version 3.0
*/
var PutSite1 = function () {
    /**
    * Constructs a new <code>PutSite1</code>.
    * @alias module:model/PutSite1
    * @class
    */

    function PutSite1() {
        _classCallCheck(this, PutSite1);

        this['url'] = undefined;
    }

    /**
    * Constructs a <code>PutSite1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PutSite1} obj Optional instance to populate.
    * @return {module:model/PutSite1} The populated <code>PutSite1</code> instance.
    */


    _createClass(PutSite1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PutSite1();
