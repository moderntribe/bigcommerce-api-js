...
/**
* The PriceListCollectionResponse model module.
* @module model/PriceListCollectionResponse
* @version 3.0
*/
var PriceListCollectionResponse = function () {
    /**
    * Constructs a new <code>PriceListCollectionResponse</code>.
    * Get All PriceLists.
    * @alias module:model/PriceListCollectionResponse
    * @class
    */

    function PriceListCollectionResponse() {
        _classCallCheck(this, PriceListCollectionResponse);
    ...
    /**
    * Constructs a <code>PriceListCollectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PriceListCollectionResponse} obj Optional instance to populate.
    * @return {module:model/PriceListCollectionResponse} The populated <code>PriceListCollectionResponse</code> instance.
    */


    _createClass(PriceListCollectionResponse, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceListCollectionResponse();

                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], [AllOfPriceListCollectionResponseDataItems]);
                }
    ...
    return PriceListCollectionResponse;
}();

exports.default = PriceListCollectionResponse;