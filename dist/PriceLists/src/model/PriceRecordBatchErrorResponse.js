...
var _PriceRecordBatchErrorSet = require('./PriceRecordBatchErrorSet');
...
* @version 3.0
*/
var PriceRecordBatchErrorResponse = function () {
    /**
    ...
    */
    ...
    function PriceRecordBatchErrorResponse() {
        _classCallCheck(this, PriceRecordBatchErrorResponse);
    ...
    */
    ...
    _createClass(PriceRecordBatchErrorResponse, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceRecordBatchErrorResponse();

                if (data.hasOwnProperty('batch_errors')) {
                    obj['batch_errors'] = _ApiClient2.default.convertToType(data['batch_errors'], [_PriceRecordBatchErrorSet2.default]);
                }
            }
            return obj;
        }
    ...
    return PriceRecordBatchErrorResponse;
}();

exports.default = PriceRecordBatchErrorResponse;