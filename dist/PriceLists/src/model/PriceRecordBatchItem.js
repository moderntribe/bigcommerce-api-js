...
* @version 3.0
*/
var PriceRecordBatchItem = function () {
    /**
    ...
    */
    ...
    function PriceRecordBatchItem() {
        _classCallCheck(this, PriceRecordBatchItem);
    ...
    */
    ...
    _createClass(PriceRecordBatchItem, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceRecordBatchItem();
    ...
    return PriceRecordBatchItem;
}();

exports.default = PriceRecordBatchItem;