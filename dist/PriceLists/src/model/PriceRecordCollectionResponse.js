...
* @version 3.0
*/
var PriceRecordCollectionResponse = function () {
    /**
    ...
    */
    ...
    function PriceRecordCollectionResponse() {
        _classCallCheck(this, PriceRecordCollectionResponse);
    ...
    */
    ...
    _createClass(PriceRecordCollectionResponse, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceRecordCollectionResponse();

                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], [AllOfPriceRecordCollectionResponseDataItems]);
                }
    ...
    return PriceRecordCollectionResponse;
}();

exports.default = PriceRecordCollectionResponse;