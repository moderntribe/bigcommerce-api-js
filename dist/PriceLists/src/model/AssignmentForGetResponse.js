...
/**
* The AssignmentForGetResponse model module.
* @module model/AssignmentForGetResponse
* @version 3.0
*/
var AssignmentForGetResponse = function () {
    /**
    * Constructs a new <code>AssignmentForGetResponse</code>.
    * @alias module:model/AssignmentForGetResponse
    * @class
    */

    function AssignmentForGetResponse() {
        _classCallCheck(this, AssignmentForGetResponse);
    ...
    /**
    * Constructs a <code>AssignmentForGetResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AssignmentForGetResponse} obj Optional instance to populate.
    * @return {module:model/AssignmentForGetResponse} The populated <code>AssignmentForGetResponse</code> instance.
    */


    _createClass(AssignmentForGetResponse, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AssignmentForGetResponse();
    ...
    return AssignmentForGetResponse;
}();

exports.default = AssignmentForGetResponse;