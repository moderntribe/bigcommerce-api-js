...
/**
* The PriceRecordResponse model module.
* @module model/PriceRecordResponse
* @version 3.0
*/
var PriceRecordResponse = function () {
    /**
    * Constructs a new <code>PriceRecordResponse</code>.
    * Response payload for the BigCommerce API.
    * @alias module:model/PriceRecordResponse
    * @class
    */

    function PriceRecordResponse() {
        _classCallCheck(this, PriceRecordResponse);
    ...
    /**
    * Constructs a <code>PriceRecordResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PriceRecordResponse} obj Optional instance to populate.
    * @return {module:model/PriceRecordResponse} The populated <code>PriceRecordResponse</code> instance.
    */


    _createClass(PriceRecordResponse, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceRecordResponse();
...
exports.default = PriceRecordResponse;