...
var _BulkPricingTier = require('./BulkPricingTier');
...
var PriceRecordBase = function () {
    ...
    */
    ...
    function PriceRecordBase() {
        _classCallCheck(this, PriceRecordBase);
    ...
    */
    ...
    _createClass(PriceRecordBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceRecordBase();
                ...
                if (data.hasOwnProperty('bulk_pricing_tiers')) {
                    obj['bulk_pricing_tiers'] = _ApiClient2.default.convertToType(data['bulk_pricing_tiers'], [_BulkPricingTier2.default]);
                }
    ...
    return PriceRecordBase;
}();

exports.default = PriceRecordBase;