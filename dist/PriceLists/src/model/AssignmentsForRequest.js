...
/**
* The AssignmentsForRequest model module.
* @module model/AssignmentsForRequest
* @version 3.0
*/
var AssignmentsForRequest = function () {
    /**
    * Constructs a new <code>AssignmentsForRequest</code>.
    * &#x60;Price List Assignments&#x60; object used in batch create.
    * @alias module:model/AssignmentsForRequest
    * @class
    * @param customerGroupId {Number} Customer group id for assignment.
    * @param priceListId {Number} Pricelist id for assignment.
    */

    function AssignmentsForRequest(customerGroupId, priceListId) {
        _classCallCheck(this, AssignmentsForRequest);

        this['customer_group_id'] = undefined;
        this['price_list_id'] = undefined;
        this['channel_id'] = undefined;


        this['customer_group_id'] = customerGroupId;
        this['price_list_id'] = priceListId;
    }

    /**
    * Constructs a <code>AssignmentsForRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AssignmentsForRequest} obj Optional instance to populate.
    * @return {module:model/AssignmentsForRequest} The populated <code>AssignmentsForRequest</code> instance.
    */


    _createClass(AssignmentsForRequest, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AssignmentsForRequest();

                if (data.hasOwnProperty('customer_group_id')) {
                    obj['customer_group_id'] = _ApiClient2.default.convertToType(data['customer_group_id'], 'Number');
                }
                if (data.hasOwnProperty('price_list_id')) {
                    obj['price_list_id'] = _ApiClient2.default.convertToType(data['price_list_id'], 'Number');
                }
...
exports.default = AssignmentsForRequest;