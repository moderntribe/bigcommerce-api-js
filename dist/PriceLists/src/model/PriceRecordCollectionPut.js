...
* @version 3.0
*/
var PriceRecordCollectionPut = function (_extendableBuiltin2) {
    _inherits(PriceRecordCollectionPut, _extendableBuiltin2);
    ...
    */
    ...
    function PriceRecordCollectionPut() {
        var _ret;

        _classCallCheck(this, PriceRecordCollectionPut);

        var _this = _possibleConstructorReturn(this, (PriceRecordCollectionPut.__proto__ || Object.getPrototypeOf(PriceRecordCollectionPut)).call(this));
    ...
    */
    ...
    _createClass(PriceRecordCollectionPut, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceRecordCollectionPut();
    ...
    return PriceRecordCollectionPut;
}(_extendableBuiltin(Array));

exports.default = PriceRecordCollectionPut;