...
/**
* The AllOfPriceListResponseData model module.
* @module model/AllOfPriceListResponseData
* @version 3.0
*/
var AllOfPriceListResponseData = function () {
    /**
    * Constructs a new <code>AllOfPriceListResponseData</code>.
    * @alias module:model/AllOfPriceListResponseData
    * @class
    * @param name {} The unique name of the Price List. Required in /POST.  
    */

    function AllOfPriceListResponseData(name) {
        _classCallCheck(this, AllOfPriceListResponseData);
    ...
    /**
    * Constructs a <code>AllOfPriceListResponseData</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfPriceListResponseData} obj Optional instance to populate.
    * @return {module:model/AllOfPriceListResponseData} The populated <code>AllOfPriceListResponseData</code> instance.
    */


    _createClass(AllOfPriceListResponseData, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfPriceListResponseData();
...
exports.default = AllOfPriceListResponseData;