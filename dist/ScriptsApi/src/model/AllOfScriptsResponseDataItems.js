...
/**
* The AllOfScriptsResponseDataItems model module.
* @module model/AllOfScriptsResponseDataItems
* @version 3.0
*/
var AllOfScriptsResponseDataItems = function () {
    /**
    * Constructs a new <code>AllOfScriptsResponseDataItems</code>.
    * @alias module:model/AllOfScriptsResponseDataItems
    * @class
    */

    function AllOfScriptsResponseDataItems() {
        _classCallCheck(this, AllOfScriptsResponseDataItems);
    ...
    /**
    * Constructs a <code>AllOfScriptsResponseDataItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfScriptsResponseDataItems} obj Optional instance to populate.
    * @return {module:model/AllOfScriptsResponseDataItems} The populated <code>AllOfScriptsResponseDataItems</code> instance.
    */


    _createClass(AllOfScriptsResponseDataItems, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfScriptsResponseDataItems();
        ...
        * @member {module:model/AllOfScriptsResponseDataItems.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/AllOfScriptsResponseDataItems.LocationEnum} location
        */
        ...
        * @member {module:model/AllOfScriptsResponseDataItems.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/AllOfScriptsResponseDataItems.KindEnum} kind
        */
        ...
        * @member {module:model/AllOfScriptsResponseDataItems.ConsentCategoryEnum} consent_category
        */
    ...
    return AllOfScriptsResponseDataItems;
}();

AllOfScriptsResponseDataItems.LoadMethodEnum = {
    /**
     * value: "default"
     * @const
     */
     ...
     */
    "defer": "defer" };
AllOfScriptsResponseDataItems.LocationEnum = {
    /**
     * value: "head"
     * @const
     */
     ...
     */
    "footer": "footer" };
AllOfScriptsResponseDataItems.VisibilityEnum = {
    /**
     * value: "storefront"
     * @const
     */
...
AllOfScriptsResponseDataItems.KindEnum = {
    /**
     * value: "src"
     * @const
     */
...
AllOfScriptsResponseDataItems.ConsentCategoryEnum = {
    /**
     * value: "essential"
     * @const
     */
     ...
     */
    "targeting": "targeting" };
exports.default = AllOfScriptsResponseDataItems;