...
/**
* The ScriptFull model module.
* @module model/ScriptFull
* @version 3.0
*/
var ScriptFull = function () {
    /**
    * Constructs a new <code>ScriptFull</code>.
    * @alias module:model/ScriptFull
    * @class
    */

    function ScriptFull() {
        _classCallCheck(this, ScriptFull);
    ...
    /**
    * Constructs a <code>ScriptFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ScriptFull} obj Optional instance to populate.
    * @return {module:model/ScriptFull} The populated <code>ScriptFull</code> instance.
    */


    _createClass(ScriptFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ScriptFull();
        ...
        * @member {module:model/ScriptFull.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/ScriptFull.LocationEnum} location
        */
        ...
        * @member {module:model/ScriptFull.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/ScriptFull.KindEnum} kind
        */
        ...
        * @member {module:model/ScriptFull.ConsentCategoryEnum} consent_category
        */
...
ScriptFull.ConsentCategoryEnum = {
    /**
     * value: "essential"
     * @const
     */
