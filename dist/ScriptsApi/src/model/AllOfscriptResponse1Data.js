...
/**
* The AllOfscriptResponse1Data model module.
* @module model/AllOfscriptResponse1Data
* @version 3.0
*/
var AllOfscriptResponse1Data = function () {
    /**
    * Constructs a new <code>AllOfscriptResponse1Data</code>.
    * @alias module:model/AllOfscriptResponse1Data
    * @class
    */

    function AllOfscriptResponse1Data() {
        _classCallCheck(this, AllOfscriptResponse1Data);
    ...
    /**
    * Constructs a <code>AllOfscriptResponse1Data</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfscriptResponse1Data} obj Optional instance to populate.
    * @return {module:model/AllOfscriptResponse1Data} The populated <code>AllOfscriptResponse1Data</code> instance.
    */


    _createClass(AllOfscriptResponse1Data, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfscriptResponse1Data();
        ...
        * @member {module:model/AllOfscriptResponse1Data.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/AllOfscriptResponse1Data.LocationEnum} location
        */
        ...
        * @member {module:model/AllOfscriptResponse1Data.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/AllOfscriptResponse1Data.KindEnum} kind
        */
        ...
        * @member {module:model/AllOfscriptResponse1Data.ConsentCategoryEnum} consent_category
        */
...
AllOfscriptResponse1Data.LoadMethodEnum = {
    /**
     * value: "default"
     * @const
     */
     ...
     */
    "defer": "defer" };
AllOfscriptResponse1Data.LocationEnum = {
    /**
     * value: "head"
     * @const
     */
     ...
     */
    "footer": "footer" };
AllOfscriptResponse1Data.VisibilityEnum = {
    /**
     * value: "storefront"
     * @const
     */
...
AllOfscriptResponse1Data.KindEnum = {
    /**
     * value: "src"
     * @const
     */
...
AllOfscriptResponse1Data.ConsentCategoryEnum = {
    /**
     * value: "essential"
     * @const
     */
     ...
     */
    "targeting": "targeting" };
exports.default = AllOfscriptResponse1Data;