...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ScriptResponseCollection', function () {
      beforeEach(function () {
        instance = new Scripts.ScriptResponseCollection();
      });

      it('should create an instance of ScriptResponseCollection', function () {
        expect(instance).to.be.a(Scripts.ScriptResponseCollection);
      });
