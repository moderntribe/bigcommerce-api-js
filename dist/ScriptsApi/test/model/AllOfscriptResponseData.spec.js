...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfscriptResponseData', function () {
      beforeEach(function () {
        instance = new Scripts.AllOfscriptResponseData();
      });

      it('should create an instance of AllOfscriptResponseData', function () {
        expect(instance).to.be.a(Scripts.AllOfscriptResponseData);
      });
