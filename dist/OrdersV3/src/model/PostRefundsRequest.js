...
var _RefundRequestPost = require('./RefundRequestPost2');
...
/**
* The PostRefundsRequest model module.
* @module model/PostRefundsRequest
* @version 3.0
*/
var PostRefundsRequest = function (_extendableBuiltin2) {
    _inherits(PostRefundsRequest, _extendableBuiltin2);

    /**
    * Constructs a new <code>PostRefundsRequest</code>.
    * Request body for batch refunds
    * @alias module:model/PostRefundsRequest
    * @class
    * @extends Array
    */

    function PostRefundsRequest() {
        var _ret;

        _classCallCheck(this, PostRefundsRequest);

        var _this = _possibleConstructorReturn(this, (PostRefundsRequest.__proto__ || Object.getPrototypeOf(PostRefundsRequest)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>PostRefundsRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PostRefundsRequest} obj Optional instance to populate.
    * @return {module:model/PostRefundsRequest} The populated <code>PostRefundsRequest</code> instance.
    */


    _createClass(PostRefundsRequest, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PostRefundsRequest();
                _ApiClient2.default.constructFromObject(data, obj, 'RefundRequestPost2');
            }
            return obj;
        }
    }]);
...
exports.default = PostRefundsRequest;