...
var _StatusUpdateFull = require('./StatusUpdateFull1');
...
/**
* The UpdateReturnStatusesRequest model module.
* @module model/UpdateReturnStatusesRequest
* @version 3.0
*/
var UpdateReturnStatusesRequest = function (_extendableBuiltin2) {
    _inherits(UpdateReturnStatusesRequest, _extendableBuiltin2);

    /**
    * Constructs a new <code>UpdateReturnStatusesRequest</code>.
    * @alias module:model/UpdateReturnStatusesRequest
    * @class
    * @extends Array
    */

    function UpdateReturnStatusesRequest() {
        var _ret;

        _classCallCheck(this, UpdateReturnStatusesRequest);

        var _this = _possibleConstructorReturn(this, (UpdateReturnStatusesRequest.__proto__ || Object.getPrototypeOf(UpdateReturnStatusesRequest)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>UpdateReturnStatusesRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UpdateReturnStatusesRequest} obj Optional instance to populate.
    * @return {module:model/UpdateReturnStatusesRequest} The populated <code>UpdateReturnStatusesRequest</code> instance.
    */


    _createClass(UpdateReturnStatusesRequest, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new UpdateReturnStatusesRequest();
                _ApiClient2.default.constructFromObject(data, obj, 'StatusUpdateFull1');
            }
            return obj;
        }
    }]);

    return UpdateReturnStatusesRequest;
}(_extendableBuiltin(Array));

exports.default = UpdateReturnStatusesRequest;