...
/**
* The LinksFull1 model module.
* @module model/LinksFull1
* @version 3.0
*/
var LinksFull1 = function () {
    /**
    * Constructs a new <code>LinksFull1</code>.
    * @alias module:model/LinksFull1
    * @class
    */

    function LinksFull1() {
        _classCallCheck(this, LinksFull1);
    ...
    /**
    * Constructs a <code>LinksFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/LinksFull1} obj Optional instance to populate.
    * @return {module:model/LinksFull1} The populated <code>LinksFull1</code> instance.
    */


    _createClass(LinksFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new LinksFull1();
