...
/**
* The ErrorResponse1 model module.
* @module model/ErrorResponse1
* @version 3.0
*/
var ErrorResponse1 = function () {
    /**
    * Constructs a new <code>ErrorResponse1</code>.
    * @alias module:model/ErrorResponse1
    * @class
    */

    function ErrorResponse1() {
        _classCallCheck(this, ErrorResponse1);
    ...
    /**
    * Constructs a <code>ErrorResponse1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ErrorResponse1} obj Optional instance to populate.
    * @return {module:model/ErrorResponse1} The populated <code>ErrorResponse1</code> instance.
    */


    _createClass(ErrorResponse1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ErrorResponse1();
...
exports.default = ErrorResponse1;