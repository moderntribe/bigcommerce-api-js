...
/**
* The StatusUpdateFull1 model module.
* @module model/StatusUpdateFull1
* @version 3.0
*/
var StatusUpdateFull1 = function () {
    /**
    * Constructs a new <code>StatusUpdateFull1</code>.
    * @alias module:model/StatusUpdateFull1
    * @class
    */

    function StatusUpdateFull1() {
        _classCallCheck(this, StatusUpdateFull1);
    ...
    /**
    * Constructs a <code>StatusUpdateFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/StatusUpdateFull1} obj Optional instance to populate.
    * @return {module:model/StatusUpdateFull1} The populated <code>StatusUpdateFull1</code> instance.
    */


    _createClass(StatusUpdateFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new StatusUpdateFull1();
                ...
                if (data.hasOwnProperty('new_status')) {
                    obj['new_status'] = _ApiClient2.default.convertToType(data['new_status'], 'String');
                }
            }
            return obj;
        }
        ...
        * @member {module:model/StatusUpdateFull1.NewStatusEnum} new_status
        */


        /**
        * Allowed values for the <code>new_status</code> property.
        * @enum {String}
        * @readonly
        */
    ...
    return StatusUpdateFull1;
}();

StatusUpdateFull1.NewStatusEnum = {
    /**
     * value: "CLOSED"
     * @const
     */
     ...
     */
    "REMOVED": "REMOVED" };
exports.default = StatusUpdateFull1;