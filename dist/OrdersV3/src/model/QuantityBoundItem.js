...
/**
* The QuantityBoundItem model module.
* @module model/QuantityBoundItem
* @version 3.0
*/
var QuantityBoundItem = function () {
    /**
    * Constructs a new <code>QuantityBoundItem</code>.
    ...
    * @alias module:model/QuantityBoundItem
    * @class
    */

    function QuantityBoundItem() {
        _classCallCheck(this, QuantityBoundItem);
    ...
    /**
    * Constructs a <code>QuantityBoundItem</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/QuantityBoundItem} obj Optional instance to populate.
    * @return {module:model/QuantityBoundItem} The populated <code>QuantityBoundItem</code> instance.
    */


    _createClass(QuantityBoundItem, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new QuantityBoundItem();
        ...
        /**
        * Type of refund.
        * @member {module:model/QuantityBoundItem.ItemTypeEnum} item_type
        */
    ...
    return QuantityBoundItem;
}();

QuantityBoundItem.ItemTypeEnum = {
    /**
     * value: "PRODUCT"
     * @const
     */
...
exports.default = QuantityBoundItem;