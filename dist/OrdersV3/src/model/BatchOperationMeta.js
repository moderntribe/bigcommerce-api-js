...
/**
* The BatchOperationMeta model module.
* @module model/BatchOperationMeta
* @version 3.0
*/
var BatchOperationMeta = function () {
    /**
    * Constructs a new <code>BatchOperationMeta</code>.
    * @alias module:model/BatchOperationMeta
    * @class
    */

    function BatchOperationMeta() {
        _classCallCheck(this, BatchOperationMeta);
    ...
    /**
    * Constructs a <code>BatchOperationMeta</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BatchOperationMeta} obj Optional instance to populate.
    * @return {module:model/BatchOperationMeta} The populated <code>BatchOperationMeta</code> instance.
    */


    _createClass(BatchOperationMeta, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BatchOperationMeta();

                if (data.hasOwnProperty('total')) {
                    obj['total'] = _ApiClient2.default.convertToType(data['total'], 'Number');
                }
                if (data.hasOwnProperty('success')) {
                    obj['success'] = _ApiClient2.default.convertToType(data['success'], 'Number');
                }
                if (data.hasOwnProperty('failed')) {
                    obj['failed'] = _ApiClient2.default.convertToType(data['failed'], 'Number');
                }
            }
            return obj;
        }
    ...
    return BatchOperationMeta;
}();

exports.default = BatchOperationMeta;