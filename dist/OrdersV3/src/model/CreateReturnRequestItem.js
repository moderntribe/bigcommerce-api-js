...
/**
* The CreateReturnRequestItem model module.
* @module model/CreateReturnRequestItem
* @version 3.0
*/
var CreateReturnRequestItem = function () {
    /**
    * Constructs a new <code>CreateReturnRequestItem</code>.
    * @alias module:model/CreateReturnRequestItem
    * @class
    ...
    */
    ...
    function CreateReturnRequestItem(referenceId, quantity, preferredOutcomeId, reasonId) {
        _classCallCheck(this, CreateReturnRequestItem);
    ...
    /**
    * Constructs a <code>CreateReturnRequestItem</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnRequestItem} obj Optional instance to populate.
    * @return {module:model/CreateReturnRequestItem} The populated <code>CreateReturnRequestItem</code> instance.
    */


    _createClass(CreateReturnRequestItem, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnRequestItem();
    ...
    return CreateReturnRequestItem;
}();

exports.default = CreateReturnRequestItem;