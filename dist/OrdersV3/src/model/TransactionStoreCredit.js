...
/**
* The TransactionStoreCredit model module.
* @module model/TransactionStoreCredit
* @version 3.0
*/
var TransactionStoreCredit = function () {
    /**
    * Constructs a new <code>TransactionStoreCredit</code>.
    * A store credit model. 
    * @alias module:model/TransactionStoreCredit
    * @class
    */

    function TransactionStoreCredit() {
        _classCallCheck(this, TransactionStoreCredit);

        this['remaining_balance'] = undefined;
    }

    /**
    * Constructs a <code>TransactionStoreCredit</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TransactionStoreCredit} obj Optional instance to populate.
    * @return {module:model/TransactionStoreCredit} The populated <code>TransactionStoreCredit</code> instance.
    */


    _createClass(TransactionStoreCredit, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new TransactionStoreCredit();

                if (data.hasOwnProperty('remaining_balance')) {
                    obj['remaining_balance'] = _ApiClient2.default.convertToType(data['remaining_balance'], 'String');
                }
            }
            return obj;
        }
    ...
    return TransactionStoreCredit;
}();

exports.default = TransactionStoreCredit;