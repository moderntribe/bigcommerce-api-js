...
/**
* The PreferredOutcome model module.
* @module model/PreferredOutcome
* @version 3.0
*/
var PreferredOutcome = function () {
    /**
    * Constructs a new <code>PreferredOutcome</code>.
    * @alias module:model/PreferredOutcome
    * @class
    */

    function PreferredOutcome() {
        _classCallCheck(this, PreferredOutcome);
    ...
    /**
    * Constructs a <code>PreferredOutcome</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PreferredOutcome} obj Optional instance to populate.
    * @return {module:model/PreferredOutcome} The populated <code>PreferredOutcome</code> instance.
    */


    _createClass(PreferredOutcome, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PreferredOutcome();
...
exports.default = PreferredOutcome;