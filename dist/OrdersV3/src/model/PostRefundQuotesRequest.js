...
var _RefundQuotePost = require('./RefundQuotePost1');
...
/**
* The PostRefundQuotesRequest model module.
* @module model/PostRefundQuotesRequest
* @version 3.0
*/
var PostRefundQuotesRequest = function (_extendableBuiltin2) {
    _inherits(PostRefundQuotesRequest, _extendableBuiltin2);

    /**
    * Constructs a new <code>PostRefundQuotesRequest</code>.
    * Request body for batch refund quotes.
    * @alias module:model/PostRefundQuotesRequest
    * @class
    * @extends Array
    */

    function PostRefundQuotesRequest() {
        var _ret;

        _classCallCheck(this, PostRefundQuotesRequest);

        var _this = _possibleConstructorReturn(this, (PostRefundQuotesRequest.__proto__ || Object.getPrototypeOf(PostRefundQuotesRequest)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>PostRefundQuotesRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PostRefundQuotesRequest} obj Optional instance to populate.
    * @return {module:model/PostRefundQuotesRequest} The populated <code>PostRefundQuotesRequest</code> instance.
    */


    _createClass(PostRefundQuotesRequest, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PostRefundQuotesRequest();
                _ApiClient2.default.constructFromObject(data, obj, 'RefundQuotePost1');
            }
            return obj;
        }
    }]);

    return PostRefundQuotesRequest;
}(_extendableBuiltin(Array));

exports.default = PostRefundQuotesRequest;