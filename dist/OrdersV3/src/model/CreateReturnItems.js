...
/**
* The CreateReturnItems model module.
* @module model/CreateReturnItems
* @version 3.0
*/
var CreateReturnItems = function () {
    /**
    * Constructs a new <code>CreateReturnItems</code>.
    * A view of a return item
    * @alias module:model/CreateReturnItems
    * @class
    */

    function CreateReturnItems() {
        _classCallCheck(this, CreateReturnItems);

        this['id'] = undefined;
        this['reference_id'] = undefined;
        this['quantity'] = undefined;
        this['total'] = undefined;
        this['preferred_outcome'] = undefined;
        this['reason'] = undefined;
        this['received_state'] = undefined;
        this['review_state'] = undefined;
    }

    /**
    * Constructs a <code>CreateReturnItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnItems} obj Optional instance to populate.
    * @return {module:model/CreateReturnItems} The populated <code>CreateReturnItems</code> instance.
    */


    _createClass(CreateReturnItems, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnItems();

                if (data.hasOwnProperty('id')) {
                    obj['id'] = _ApiClient2.default.convertToType(data['id'], 'Number');
                }
                if (data.hasOwnProperty('reference_id')) {
                    obj['reference_id'] = _CreateReturnRequestReferenceId2.default.constructFromObject(data['reference_id']);
                }
                ...
                if (data.hasOwnProperty('preferred_outcome')) {
                    obj['preferred_outcome'] = _CreateReturnPreferredOutcome2.default.constructFromObject(data['preferred_outcome']);
                }
                if (data.hasOwnProperty('reason')) {
                    obj['reason'] = _CreateReturnReason2.default.constructFromObject(data['reason']);
                }
                if (data.hasOwnProperty('received_state')) {
                    obj['received_state'] = _CreateReturnReceivedState2.default.constructFromObject(data['received_state']);
                }
                if (data.hasOwnProperty('review_state')) {
                    obj['review_state'] = _CreateReturnReviewState2.default.constructFromObject(data['review_state']);
                }
            }
            return obj;
        }
    ...
    return CreateReturnItems;
}();

exports.default = CreateReturnItems;