...
var _ReceivedItemsPutInner = require('./ReceivedItemsPutInner');
...
/**
* The ReceivedItemsPut model module.
* @module model/ReceivedItemsPut
* @version 3.0
*/
var ReceivedItemsPut = function (_extendableBuiltin2) {
    _inherits(ReceivedItemsPut, _extendableBuiltin2);

    /**
    * Constructs a new <code>ReceivedItemsPut</code>.
    * @alias module:model/ReceivedItemsPut
    * @class
    * @extends Array
    */

    function ReceivedItemsPut() {
        var _ret;

        _classCallCheck(this, ReceivedItemsPut);

        var _this = _possibleConstructorReturn(this, (ReceivedItemsPut.__proto__ || Object.getPrototypeOf(ReceivedItemsPut)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>ReceivedItemsPut</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReceivedItemsPut} obj Optional instance to populate.
    * @return {module:model/ReceivedItemsPut} The populated <code>ReceivedItemsPut</code> instance.
    */


    _createClass(ReceivedItemsPut, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReceivedItemsPut();
                _ApiClient2.default.constructFromObject(data, obj, 'ReceivedItemsPutInner');
            }
            return obj;
        }
    }]);

    return ReceivedItemsPut;
}(_extendableBuiltin(Array));

exports.default = ReceivedItemsPut;