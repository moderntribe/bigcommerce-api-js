...
/**
* The RefundRequestPost2 model module.
* @module model/RefundRequestPost2
* @version 3.0
*/
var RefundRequestPost2 = function () {
    /**
    * Constructs a new <code>RefundRequestPost2</code>.
    * Request body for refund requests.
    * @alias module:model/RefundRequestPost2
    * @class
    ...
    */
    ...
    function RefundRequestPost2(orderId, items, payments) {
        _classCallCheck(this, RefundRequestPost2);
    ...
    /**
    * Constructs a <code>RefundRequestPost2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RefundRequestPost2} obj Optional instance to populate.
    * @return {module:model/RefundRequestPost2} The populated <code>RefundRequestPost2</code> instance.
    */


    _createClass(RefundRequestPost2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new RefundRequestPost2();
                ...
                if (data.hasOwnProperty('payments')) {
                    obj['payments'] = _ApiClient2.default.convertToType(data['payments'], [Object]);
                }
            }
            return obj;
        }
    ...
    return RefundRequestPost2;
}();

exports.default = RefundRequestPost2;