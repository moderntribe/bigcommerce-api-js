...
/**
* The CreateReturnReason model module.
* @module model/CreateReturnReason
* @version 3.0
*/
var CreateReturnReason = function () {
    /**
    * Constructs a new <code>CreateReturnReason</code>.
    * @alias module:model/CreateReturnReason
    * @class
    */

    function CreateReturnReason() {
        _classCallCheck(this, CreateReturnReason);
    ...
    /**
    * Constructs a <code>CreateReturnReason</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnReason} obj Optional instance to populate.
    * @return {module:model/CreateReturnReason} The populated <code>CreateReturnReason</code> instance.
    */


    _createClass(CreateReturnReason, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnReason();
    ...
    return CreateReturnReason;
}();

exports.default = CreateReturnReason;