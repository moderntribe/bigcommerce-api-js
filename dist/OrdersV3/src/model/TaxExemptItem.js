...
/**
* The TaxExemptItem model module.
* @module model/TaxExemptItem
* @version 3.0
*/
var TaxExemptItem = function () {
    /**
    * Constructs a new <code>TaxExemptItem</code>.
    * Tax Exempt Item
    * @alias module:model/TaxExemptItem
    * @class
    */

    function TaxExemptItem() {
        _classCallCheck(this, TaxExemptItem);
    ...
    /**
    * Constructs a <code>TaxExemptItem</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TaxExemptItem} obj Optional instance to populate.
    * @return {module:model/TaxExemptItem} The populated <code>TaxExemptItem</code> instance.
    */


    _createClass(TaxExemptItem, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new TaxExemptItem();
        ...
        /**
        * Type of refund.
        * @member {module:model/TaxExemptItem.ItemTypeEnum} item_type
        */
    ...
    return TaxExemptItem;
}();

TaxExemptItem.ItemTypeEnum = {
    /**
     * value: "ORDER"
     * @const
     */
    "ORDER": "ORDER" };
exports.default = TaxExemptItem;