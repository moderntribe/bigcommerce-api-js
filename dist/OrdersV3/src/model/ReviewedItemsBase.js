...
var _ReviewedItemsBaseInner = require('./ReviewedItemsBaseInner');
...
/**
* The ReviewedItemsBase model module.
* @module model/ReviewedItemsBase
* @version 3.0
*/
var ReviewedItemsBase = function (_extendableBuiltin2) {
    _inherits(ReviewedItemsBase, _extendableBuiltin2);

    /**
    * Constructs a new <code>ReviewedItemsBase</code>.
    * @alias module:model/ReviewedItemsBase
    * @class
    * @extends Array
    */

    function ReviewedItemsBase() {
        var _ret;

        _classCallCheck(this, ReviewedItemsBase);

        var _this = _possibleConstructorReturn(this, (ReviewedItemsBase.__proto__ || Object.getPrototypeOf(ReviewedItemsBase)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>ReviewedItemsBase</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReviewedItemsBase} obj Optional instance to populate.
    * @return {module:model/ReviewedItemsBase} The populated <code>ReviewedItemsBase</code> instance.
    */


    _createClass(ReviewedItemsBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReviewedItemsBase();
                _ApiClient2.default.constructFromObject(data, obj, 'ReviewedItemsBaseInner');
            }
            return obj;
        }
    }]);

    return ReviewedItemsBase;
}(_extendableBuiltin(Array));

exports.default = ReviewedItemsBase;