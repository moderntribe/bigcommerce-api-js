...
/**
* The RefundMethod model module.
* @module model/RefundMethod
* @version 3.0
*/
var RefundMethod = function (_extendableBuiltin2) {
    _inherits(RefundMethod, _extendableBuiltin2);

    /**
    * Constructs a new <code>RefundMethod</code>.
    * @alias module:model/RefundMethod
    * @class
    * @extends Array
    */
    ...
    function RefundMethod() {
        ...
        _classCallCheck(this, RefundMethod);

        var _this = _possibleConstructorReturn(this, (RefundMethod.__proto__ || Object.getPrototypeOf(RefundMethod)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>RefundMethod</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RefundMethod} obj Optional instance to populate.
    * @return {module:model/RefundMethod} The populated <code>RefundMethod</code> instance.
    */


    _createClass(RefundMethod, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new RefundMethod();
                _ApiClient2.default.constructFromObject(data, obj, 'PaymentOption');
            }
            return obj;
        }
    }]);
