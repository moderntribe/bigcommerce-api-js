...
/**
* The MetaEmptyFull model module.
* @module model/MetaEmptyFull
* @version 3.0
*/
var MetaEmptyFull = function () {
    /**
    * Constructs a new <code>MetaEmptyFull</code>.
    * @alias module:model/MetaEmptyFull
    * @class
    */

    function MetaEmptyFull() {
        _classCallCheck(this, MetaEmptyFull);
    }

    /**
    * Constructs a <code>MetaEmptyFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MetaEmptyFull} obj Optional instance to populate.
    * @return {module:model/MetaEmptyFull} The populated <code>MetaEmptyFull</code> instance.
    */


    _createClass(MetaEmptyFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new MetaEmptyFull();
            }
            return obj;
        }
    }]);

    return MetaEmptyFull;
}();

exports.default = MetaEmptyFull;