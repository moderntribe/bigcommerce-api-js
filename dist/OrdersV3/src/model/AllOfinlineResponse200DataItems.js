...
var AllOfinlineResponse200DataItems = function () {
    ...
    */
    ...
    function AllOfinlineResponse200DataItems() {
        ...
        this['payment_instrument_token'] = undefined;
        this['avs_result'] = undefined;
        this['cvv_result'] = undefined;
        this['credit_card'] = undefined;
        this['gift_certificate'] = undefined;
        this['store_credit'] = undefined;
    }
    ...
    */
    ...
    _createClass(AllOfinlineResponse200DataItems, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('payment_instrument_token')) {
                    obj['payment_instrument_token'] = _ApiClient2.default.convertToType(data['payment_instrument_token'], 'String');
                }
                if (data.hasOwnProperty('avs_result')) {
                    obj['avs_result'] = _ApiClient2.default.convertToType(data['avs_result'], Object);
                }
                if (data.hasOwnProperty('cvv_result')) {
                    obj['cvv_result'] = _ApiClient2.default.convertToType(data['cvv_result'], Object);
                }
                if (data.hasOwnProperty('credit_card')) {
                    obj['credit_card'] = _ApiClient2.default.convertToType(data['credit_card'], Object);
                }
                if (data.hasOwnProperty('gift_certificate')) {
                    obj['gift_certificate'] = _ApiClient2.default.convertToType(data['gift_certificate'], Object);
                }
                if (data.hasOwnProperty('store_credit')) {
                    obj['store_credit'] = _ApiClient2.default.convertToType(data['store_credit'], Object);
                }
            }
            return obj;
        }
        ...
        * @member {Object} avs_result
        */

        /**
        * Card Verification Value result from the payment gateway.
        * @member {Object} cvv_result
        */

        /**
        * A credit-card model.
        * @member {Object} credit_card
        */

        /**
        * A gift-certificate model.
        * @member {Object} gift_certificate
        */

        /**
        * A store credit model. 
        * @member {Object} store_credit
        */
