...
/**
* The UpdateReturnStatusesInner model module.
* @module model/UpdateReturnStatusesInner
* @version 3.0
*/
var UpdateReturnStatusesInner = function () {
    /**
    * Constructs a new <code>UpdateReturnStatusesInner</code>.
    * @alias module:model/UpdateReturnStatusesInner
    * @class
    */

    function UpdateReturnStatusesInner() {
        _classCallCheck(this, UpdateReturnStatusesInner);
    ...
    /**
    * Constructs a <code>UpdateReturnStatusesInner</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UpdateReturnStatusesInner} obj Optional instance to populate.
    * @return {module:model/UpdateReturnStatusesInner} The populated <code>UpdateReturnStatusesInner</code> instance.
    */


    _createClass(UpdateReturnStatusesInner, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new UpdateReturnStatusesInner();
        ...
        * @member {module:model/UpdateReturnStatusesInner.StatusEnum} status
        */
    ...
    return UpdateReturnStatusesInner;
}();

UpdateReturnStatusesInner.StatusEnum = {
    /**
     * value: "CLOSED"
     * @const
     */
     ...
     */
    "REMOVED": "REMOVED" };
exports.default = UpdateReturnStatusesInner;