...
/**
* The ReviewedItemsBaseInner model module.
* @module model/ReviewedItemsBaseInner
* @version 3.0
*/
var ReviewedItemsBaseInner = function () {
    /**
    * Constructs a new <code>ReviewedItemsBaseInner</code>.
    * @alias module:model/ReviewedItemsBaseInner
    * @class
    */

    function ReviewedItemsBaseInner() {
        _classCallCheck(this, ReviewedItemsBaseInner);
    ...
    /**
    * Constructs a <code>ReviewedItemsBaseInner</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReviewedItemsBaseInner} obj Optional instance to populate.
    * @return {module:model/ReviewedItemsBaseInner} The populated <code>ReviewedItemsBaseInner</code> instance.
    */


    _createClass(ReviewedItemsBaseInner, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReviewedItemsBaseInner();
    ...
    return ReviewedItemsBaseInner;
}();

exports.default = ReviewedItemsBaseInner;