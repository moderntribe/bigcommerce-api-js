...
var _FailedQuoteError = require('./FailedQuoteError1');

var _FailedQuoteError2 = _interopRequireDefault(_FailedQuoteError);

var _Meta = require('./Meta1');
...
* @version 3.0
*/
var InlineResponse503 = function () {
    /**
    ...
    */
    ...
    _createClass(InlineResponse503, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], [_FailedQuoteError2.default]);
                }
        ...
        /**
        * @member {Array.<module:model/FailedQuoteError1>} data
        */

        /**
        * @member {module:model/Meta1} meta
        */
...
exports.default = InlineResponse503;