...
/**
* Enum class StatusFull.
* @enum {}
* @readonly
*/
var StatusFull = function () {
  function StatusFull() {
    _classCallCheck(this, StatusFull);
  ...
  _createClass(StatusFull, null, [{
    key: "constructFromObject",


    /**
    * Returns a <code>StatusFull</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StatusFull} The enum <code>StatusFull</code> value.
    */
