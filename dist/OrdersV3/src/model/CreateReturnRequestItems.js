...
/**
* The CreateReturnRequestItems model module.
* @module model/CreateReturnRequestItems
* @version 3.0
*/
var CreateReturnRequestItems = function () {
    /**
    * Constructs a new <code>CreateReturnRequestItems</code>.
    * @alias module:model/CreateReturnRequestItems
    * @class
    * @param referenceId {module:model/CreateReturnRequestReferenceId} 
    * @param quantity {Number} 
    * @param preferredOutcomeId {Number} 
    * @param reasonId {Number} 
    */

    function CreateReturnRequestItems(referenceId, quantity, preferredOutcomeId, reasonId) {
        _classCallCheck(this, CreateReturnRequestItems);

        this['reference_id'] = undefined;
        this['quantity'] = undefined;
        this['preferred_outcome_id'] = undefined;
        this['reason_id'] = undefined;


        this['reference_id'] = referenceId;
        this['quantity'] = quantity;
        this['preferred_outcome_id'] = preferredOutcomeId;
        this['reason_id'] = reasonId;
    }

    /**
    * Constructs a <code>CreateReturnRequestItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnRequestItems} obj Optional instance to populate.
    * @return {module:model/CreateReturnRequestItems} The populated <code>CreateReturnRequestItems</code> instance.
    */


    _createClass(CreateReturnRequestItems, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnRequestItems();
                ...
                if (data.hasOwnProperty('preferred_outcome_id')) {
                    obj['preferred_outcome_id'] = _ApiClient2.default.convertToType(data['preferred_outcome_id'], 'Number');
                }
                if (data.hasOwnProperty('reason_id')) {
                    obj['reason_id'] = _ApiClient2.default.convertToType(data['reason_id'], 'Number');
                }
            }
            return obj;
        }
        ...
        */
        ...
        /**
        * @member {Number} preferred_outcome_id
        */
    ...
    return CreateReturnRequestItems;
}();

exports.default = CreateReturnRequestItems;