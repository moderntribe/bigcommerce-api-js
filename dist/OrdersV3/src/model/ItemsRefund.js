...
/**
* The ItemsRefund model module.
* @module model/ItemsRefund
* @version 3.0
*/
var ItemsRefund = function (_extendableBuiltin2) {
    _inherits(ItemsRefund, _extendableBuiltin2);

    /**
    * Constructs a new <code>ItemsRefund</code>.
    * @alias module:model/ItemsRefund
    * @class
    * @extends Array
    */

    function ItemsRefund() {
        var _ret;

        _classCallCheck(this, ItemsRefund);

        var _this = _possibleConstructorReturn(this, (ItemsRefund.__proto__ || Object.getPrototypeOf(ItemsRefund)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>ItemsRefund</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemsRefund} obj Optional instance to populate.
    * @return {module:model/ItemsRefund} The populated <code>ItemsRefund</code> instance.
    */


    _createClass(ItemsRefund, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ItemsRefund();
