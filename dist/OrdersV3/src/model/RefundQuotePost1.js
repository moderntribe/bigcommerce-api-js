...
/**
* The RefundQuotePost1 model module.
* @module model/RefundQuotePost1
* @version 3.0
*/
var RefundQuotePost1 = function () {
    /**
    * Constructs a new <code>RefundQuotePost1</code>.
    * Request body for refund quotes.
    * @alias module:model/RefundQuotePost1
    * @class
    * @param orderId {Number} Order ID against which this refund will be created. This is optional for creating a single refund request. The order ID is included in the request path.
    * @param items {Array.<Object>} 
    */

    function RefundQuotePost1(orderId, items) {
        _classCallCheck(this, RefundQuotePost1);
    ...
    /**
    * Constructs a <code>RefundQuotePost1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RefundQuotePost1} obj Optional instance to populate.
    * @return {module:model/RefundQuotePost1} The populated <code>RefundQuotePost1</code> instance.
    */


    _createClass(RefundQuotePost1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new RefundQuotePost1();
    ...
    return RefundQuotePost1;
}();

exports.default = RefundQuotePost1;