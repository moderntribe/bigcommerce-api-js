...
/**
* The Custom1 model module.
* @module model/Custom1
* @version 3.0
*/
var Custom1 = function () {
    /**
    * Constructs a new <code>Custom1</code>.
    * Custom payment from manual order.
    * @alias module:model/Custom1
    * @class
    */

    function Custom1() {
        _classCallCheck(this, Custom1);

        this['payment_method'] = undefined;
    }

    /**
    * Constructs a <code>Custom1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Custom1} obj Optional instance to populate.
    * @return {module:model/Custom1} The populated <code>Custom1</code> instance.
    */


    _createClass(Custom1, null, [{
