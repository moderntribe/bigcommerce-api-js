...
/**
* The RefundPayment model module.
* @module model/RefundPayment
* @version 3.0
*/
var RefundPayment = function () {
    /**
    * Constructs a new <code>RefundPayment</code>.
    * @alias module:model/RefundPayment
    * @class
    */

    function RefundPayment() {
        _classCallCheck(this, RefundPayment);

        this['id'] = undefined;
        this['provider_id'] = undefined;
        this['amount'] = undefined;
        this['offline'] = undefined;
        this['is_declined'] = undefined;
        this['declined_message'] = undefined;
    }

    /**
    * Constructs a <code>RefundPayment</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RefundPayment} obj Optional instance to populate.
    * @return {module:model/RefundPayment} The populated <code>RefundPayment</code> instance.
    */


    _createClass(RefundPayment, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new RefundPayment();
                ...
                if (data.hasOwnProperty('is_declined')) {
                    obj['is_declined'] = _ApiClient2.default.convertToType(data['is_declined'], 'Boolean');
                }
                if (data.hasOwnProperty('declined_message')) {
                    obj['declined_message'] = _ApiClient2.default.convertToType(data['declined_message'], 'String');
                }
            }
            return obj;
        }
        ...
        * @member {Boolean} is_declined
        */

        /**
        * Message indicate why payment was declined
        * @member {String} declined_message
        */
