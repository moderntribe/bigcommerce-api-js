...
/**
* The FailedQuoteError model module.
* @module model/FailedQuoteError
* @version 3.0
*/
var FailedQuoteError = function () {
    /**
    * Constructs a new <code>FailedQuoteError</code>.
    * Failed quote response.
    * @alias module:model/FailedQuoteError
    * @class
    */

    function FailedQuoteError() {
        _classCallCheck(this, FailedQuoteError);
    ...
    /**
    * Constructs a <code>FailedQuoteError</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FailedQuoteError} obj Optional instance to populate.
    * @return {module:model/FailedQuoteError} The populated <code>FailedQuoteError</code> instance.
    */


    _createClass(FailedQuoteError, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new FailedQuoteError();
    ...
    return FailedQuoteError;
}();

exports.default = FailedQuoteError;