...
* @version 3.0
*/
var CategoryImagesApi = function () {
  ...
  */
  function CategoryImagesApi(apiClient) {
    _classCallCheck(this, CategoryImagesApi);
  ...
  _createClass(CategoryImagesApi, [{
    key: 'createCategoryImage',
    value: function createCategoryImage(categoryId, accept, contentType, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      return this.apiClient.callApi('/catalog/categories/{category_id}/image', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
    /**
    ...
    value: function deleteCategoryImage(categoryId, accept, contentType, callback) {
      var postBody = null;
      ...
      return this.apiClient.callApi('/catalog/categories/{category_id}/image', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
  }]);

  return CategoryImagesApi;
}();

exports.default = CategoryImagesApi;