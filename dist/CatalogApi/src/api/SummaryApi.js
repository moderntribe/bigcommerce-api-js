...
var SummaryApi = function () {
  ...
  */
  function SummaryApi(apiClient) {
    _classCallCheck(this, SummaryApi);

    this.apiClient = apiClient || _ApiClient2.default.instance;
  }

  /**
   * Callback function to receive the result of the getCatalogSummary operation.
   * @callback module:api/SummaryApi~getCatalogSummaryCallback
   ...
   * @param {module:api/SummaryApi~getCatalogSummaryCallback} callback The callback function, accepting three arguments: error, data, response
   * data is of type: {@link module:model/CatalogSummaryResponse}
   */


  _createClass(SummaryApi, [{
    key: 'getCatalogSummary',
    value: function getCatalogSummary(accept, contentType, callback) {
      var postBody = null;
      ...
      var returnType = _CatalogSummaryResponse2.default;

      return this.apiClient.callApi('/catalog/summary', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
  }]);
