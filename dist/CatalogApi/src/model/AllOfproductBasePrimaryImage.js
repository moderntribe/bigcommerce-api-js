...
/**
* The AllOfproductBasePrimaryImage model module.
* @module model/AllOfproductBasePrimaryImage
* @version 3.0
*/
var AllOfproductBasePrimaryImage = function () {
    /**
    * Constructs a new <code>AllOfproductBasePrimaryImage</code>.
    * Common ProductImage properties.
    * @alias module:model/AllOfproductBasePrimaryImage
    * @class
    */

    function AllOfproductBasePrimaryImage() {
        _classCallCheck(this, AllOfproductBasePrimaryImage);
    ...
    /**
    * Constructs a <code>AllOfproductBasePrimaryImage</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfproductBasePrimaryImage} obj Optional instance to populate.
    * @return {module:model/AllOfproductBasePrimaryImage} The populated <code>AllOfproductBasePrimaryImage</code> instance.
    */


    _createClass(AllOfproductBasePrimaryImage, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfproductBasePrimaryImage();
...
exports.default = AllOfproductBasePrimaryImage;