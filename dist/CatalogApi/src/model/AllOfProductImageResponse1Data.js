...
/**
* The AllOfProductImageResponse1Data model module.
* @module model/AllOfProductImageResponse1Data
* @version 3.0
*/
var AllOfProductImageResponse1Data = function () {
    /**
    * Constructs a new <code>AllOfProductImageResponse1Data</code>.
    * Common ProductImage properties.
    * @alias module:model/AllOfProductImageResponse1Data
    * @class
    */

    function AllOfProductImageResponse1Data() {
        _classCallCheck(this, AllOfProductImageResponse1Data);
    ...
    /**
    * Constructs a <code>AllOfProductImageResponse1Data</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfProductImageResponse1Data} obj Optional instance to populate.
    * @return {module:model/AllOfProductImageResponse1Data} The populated <code>AllOfProductImageResponse1Data</code> instance.
    */


    _createClass(AllOfProductImageResponse1Data, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfProductImageResponse1Data();
...
exports.default = AllOfProductImageResponse1Data;