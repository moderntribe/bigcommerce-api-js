...
* @version 3.0
*/
var GiftCertificateFull = function () {
    /**
    ...
    */
    ...
    function GiftCertificateFull() {
        _classCallCheck(this, GiftCertificateFull);

        this['code'] = undefined;
        this['original_balance'] = undefined;
        this['starting_balance'] = undefined;
    ...
    */
    ...
    _createClass(GiftCertificateFull, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('original_balance')) {
                    obj['original_balance'] = _ApiClient2.default.convertToType(data['original_balance'], 'Number');
                }
                if (data.hasOwnProperty('starting_balance')) {
                    obj['starting_balance'] = _ApiClient2.default.convertToType(data['starting_balance'], 'Number');
                }
                if (data.hasOwnProperty('remaining_balance')) {
                    obj['remaining_balance'] = _ApiClient2.default.convertToType(data['remaining_balance'], 'Number');
                }
    ...
    return GiftCertificateFull;
}();

GiftCertificateFull.StatusEnum = {
    /**
     * value: "active"
     * @const
     */
     ...
     */
    "expired": "expired" };
exports.default = GiftCertificateFull;