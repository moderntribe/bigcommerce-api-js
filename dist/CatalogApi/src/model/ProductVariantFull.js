...
var _ProductVariantOptionValueBase = require('./ProductVariantOptionValueBase1');
...
/**
* The ProductVariantFull model module.
* @module model/ProductVariantFull
* @version 3.0
*/
var ProductVariantFull = function () {
    /**
    * Constructs a new <code>ProductVariantFull</code>.
    * @alias module:model/ProductVariantFull
    * @class
    */

    function ProductVariantFull() {
        _classCallCheck(this, ProductVariantFull);
    ...
    /**
    * Constructs a <code>ProductVariantFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProductVariantFull} obj Optional instance to populate.
    * @return {module:model/ProductVariantFull} The populated <code>ProductVariantFull</code> instance.
    */


    _createClass(ProductVariantFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductVariantFull();
                ...
                if (data.hasOwnProperty('option_values')) {
                    obj['option_values'] = _ApiClient2.default.convertToType(data['option_values'], [_ProductVariantOptionValueBase2.default]);
                }
        ...
        * @member {Array.<module:model/ProductVariantOptionValueBase1>} option_values
        */
    ...
    return ProductVariantFull;
}();

exports.default = ProductVariantFull;