...
var _CategoriesTreeNodeFull = require('./CategoriesTreeNodeFull');
...
/**
* The CategoriesTreeNodeFull1 model module.
* @module model/CategoriesTreeNodeFull1
* @version 3.0
*/
var CategoriesTreeNodeFull1 = function () {
    /**
    * Constructs a new <code>CategoriesTreeNodeFull1</code>.
    * Used to reflect parent &lt;&gt; child category relationships. Used by Category Tree.
    * @alias module:model/CategoriesTreeNodeFull1
    * @class
    */

    function CategoriesTreeNodeFull1() {
        _classCallCheck(this, CategoriesTreeNodeFull1);
    ...
    /**
    * Constructs a <code>CategoriesTreeNodeFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoriesTreeNodeFull1} obj Optional instance to populate.
    * @return {module:model/CategoriesTreeNodeFull1} The populated <code>CategoriesTreeNodeFull1</code> instance.
    */


    _createClass(CategoriesTreeNodeFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CategoriesTreeNodeFull1();
        ...
        * @member {Array.<module:model/CategoriesTreeNodeFull>} children
        */

    }]);

    return CategoriesTreeNodeFull1;
}();

exports.default = CategoriesTreeNodeFull1;