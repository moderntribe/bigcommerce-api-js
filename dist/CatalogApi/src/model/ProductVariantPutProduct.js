...
/**
* The ProductVariantPutProduct model module.
* @module model/ProductVariantPutProduct
* @version 3.0
*/
var ProductVariantPutProduct = function () {
    /**
    * Constructs a new <code>ProductVariantPutProduct</code>.
    * The model for a PUT to update variants on a product. 
    * @alias module:model/ProductVariantPutProduct
    * @class
    */

    function ProductVariantPutProduct() {
        _classCallCheck(this, ProductVariantPutProduct);
    ...
    /**
    * Constructs a <code>ProductVariantPutProduct</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProductVariantPutProduct} obj Optional instance to populate.
    * @return {module:model/ProductVariantPutProduct} The populated <code>ProductVariantPutProduct</code> instance.
    */


    _createClass(ProductVariantPutProduct, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductVariantPutProduct();
    ...
    return ProductVariantPutProduct;
}();

exports.default = ProductVariantPutProduct;