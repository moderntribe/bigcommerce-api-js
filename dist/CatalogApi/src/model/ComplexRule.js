...
/**
* The ComplexRule model module.
* @module model/ComplexRule
* @version 3.0
*/
var ComplexRule = function () {
    /**
    ...
    */
    ...
    function ComplexRule() {
        _classCallCheck(this, ComplexRule);
    ...
    /**
    * Constructs a <code>ComplexRule</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ComplexRule} obj Optional instance to populate.
    * @return {module:model/ComplexRule} The populated <code>ComplexRule</code> instance.
    */


    _createClass(ComplexRule, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ComplexRule();
