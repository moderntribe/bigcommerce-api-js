...
/**
* The BrandFull1 model module.
* @module model/BrandFull1
* @version 3.0
*/
var BrandFull1 = function () {
    /**
    * Constructs a new <code>BrandFull1</code>.
    * Common Brand properties.
    * @alias module:model/BrandFull1
    * @class
    * @param name {String} The name of the brand. Must be unique. Required in POST.
    */

    function BrandFull1(name) {
        _classCallCheck(this, BrandFull1);
    ...
    /**
    * Constructs a <code>BrandFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BrandFull1} obj Optional instance to populate.
    * @return {module:model/BrandFull1} The populated <code>BrandFull1</code> instance.
    */


    _createClass(BrandFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BrandFull1();
