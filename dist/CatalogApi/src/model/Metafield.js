...
var Metafield = function () {
    ...
    * @class
    * @param permissionSet {module:model/Metafield.PermissionSetEnum} Determines whether the field is completely private to the app that owns the field (`app_only`), or visible to other API consumers (`read`), or completely open for reading and writing to other apps (`write`). Required for POST. 
    ...
    */
    ...
    function Metafield(permissionSet, namespace, key, value) {
    ...
    */
    ...
    _createClass(Metafield, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('created_at')) {
                    obj['created_at'] = _ApiClient2.default.convertToType(data['created_at'], 'Date');
                }
                if (data.hasOwnProperty('updated_at')) {
                    obj['updated_at'] = _ApiClient2.default.convertToType(data['updated_at'], 'Date');
                }
            }
            return obj;
        }
        ...
        * @member {module:model/Metafield.PermissionSetEnum} permission_set
        */
        ...
        * @member {module:model/Metafield.ResourceTypeEnum} resource_type
        */
