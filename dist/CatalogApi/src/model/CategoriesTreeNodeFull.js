...
/**
* The CategoriesTreeNodeFull model module.
* @module model/CategoriesTreeNodeFull
* @version 3.0
*/
var CategoriesTreeNodeFull = function () {
    /**
    * Constructs a new <code>CategoriesTreeNodeFull</code>.
    * Used to reflect parent &lt;&gt; child category relationships. Used by Category Tree.
    * @alias module:model/CategoriesTreeNodeFull
    * @class
    */

    function CategoriesTreeNodeFull() {
        _classCallCheck(this, CategoriesTreeNodeFull);
    ...
    /**
    * Constructs a <code>CategoriesTreeNodeFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoriesTreeNodeFull} obj Optional instance to populate.
    * @return {module:model/CategoriesTreeNodeFull} The populated <code>CategoriesTreeNodeFull</code> instance.
    */


    _createClass(CategoriesTreeNodeFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CategoriesTreeNodeFull();
                ...
                if (data.hasOwnProperty('children')) {
                    obj['children'] = _ApiClient2.default.convertToType(data['children'], [CategoriesTreeNodeFull]);
                }
            }
            return obj;
        }
    ...
    return CategoriesTreeNodeFull;
}();

exports.default = CategoriesTreeNodeFull;