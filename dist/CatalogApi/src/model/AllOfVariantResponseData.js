...
/**
* The AllOfVariantResponseData model module.
* @module model/AllOfVariantResponseData
* @version 3.0
*/
var AllOfVariantResponseData = function () {
    /**
    * Constructs a new <code>AllOfVariantResponseData</code>.
    * @alias module:model/AllOfVariantResponseData
    * @class
    */

    function AllOfVariantResponseData() {
        _classCallCheck(this, AllOfVariantResponseData);
    ...
    /**
    * Constructs a <code>AllOfVariantResponseData</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfVariantResponseData} obj Optional instance to populate.
    * @return {module:model/AllOfVariantResponseData} The populated <code>AllOfVariantResponseData</code> instance.
    */


    _createClass(AllOfVariantResponseData, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfVariantResponseData();
...
exports.default = AllOfVariantResponseData;