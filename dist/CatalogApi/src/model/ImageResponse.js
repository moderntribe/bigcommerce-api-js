...
var _ResourceImage = require('./ResourceImage2');
...
var ImageResponse = function () {
    ...
    */
    ...
    _createClass(ImageResponse, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ResourceImage2.default.constructFromObject(data['data']);
                }
        ...
        /**
        * @member {module:model/ResourceImage2} data
        */
