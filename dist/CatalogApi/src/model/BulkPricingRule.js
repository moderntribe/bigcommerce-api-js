...
var BulkPricingRule = function () {
    ...
    * @param type {module:model/BulkPricingRule.TypeEnum} The type of adjustment that is made. Values: `price` - the adjustment amount per product; `percent` - the adjustment as a percentage of the original price; `fixed` - the adjusted absolute price of the product. Required in /POST.
    ...
    */
    ...
    function BulkPricingRule(quantityMin, quantityMax, type, amount) {
        _classCallCheck(this, BulkPricingRule);
    ...
    */
    ...
    _createClass(BulkPricingRule, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BulkPricingRule();
        ...
        * @member {module:model/BulkPricingRule.TypeEnum} type
        */
...
BulkPricingRule.TypeEnum = {
     ...
     */
    "fixed": "fixed" };
exports.default = BulkPricingRule;