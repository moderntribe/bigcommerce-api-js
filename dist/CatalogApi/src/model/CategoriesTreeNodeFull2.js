...
var _CategoriesTreeNodeFull = require('./CategoriesTreeNodeFull1');
...
/**
* The CategoriesTreeNodeFull2 model module.
* @module model/CategoriesTreeNodeFull2
* @version 3.0
*/
var CategoriesTreeNodeFull2 = function () {
    /**
    * Constructs a new <code>CategoriesTreeNodeFull2</code>.
    * Used to reflect parent &lt;&gt; child category relationships. Used by Category Tree.
    * @alias module:model/CategoriesTreeNodeFull2
    * @class
    */

    function CategoriesTreeNodeFull2() {
        _classCallCheck(this, CategoriesTreeNodeFull2);
    ...
    /**
    * Constructs a <code>CategoriesTreeNodeFull2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoriesTreeNodeFull2} obj Optional instance to populate.
    * @return {module:model/CategoriesTreeNodeFull2} The populated <code>CategoriesTreeNodeFull2</code> instance.
    */


    _createClass(CategoriesTreeNodeFull2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CategoriesTreeNodeFull2();
                ...
                if (data.hasOwnProperty('children')) {
                    obj['children'] = _ApiClient2.default.convertToType(data['children'], [_CategoriesTreeNodeFull2.default]);
                }
            }
            return obj;
        }
        ...
        * @member {Array.<module:model/CategoriesTreeNodeFull1>} children
        */

    }]);

    return CategoriesTreeNodeFull2;
}();

exports.default = CategoriesTreeNodeFull2;