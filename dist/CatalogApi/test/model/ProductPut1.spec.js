...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ProductPut1', function () {
      beforeEach(function () {
        instance = new Catalog.ProductPut1();
      });

      it('should create an instance of ProductPut1', function () {
        expect(instance).to.be.a(Catalog.ProductPut1);
      });
