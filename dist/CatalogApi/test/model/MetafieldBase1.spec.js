...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetafieldBase1', function () {
      beforeEach(function () {
        instance = new Catalog.MetafieldBase1();
      });

      it('should create an instance of MetafieldBase1', function () {
        expect(instance).to.be.a(Catalog.MetafieldBase1);
      });
      ...
      it('should have the property permission_set (base name: "permission_set")', function () {
        expect(instance).to.have.property('permission_set');
        // expect(instance.permission_set).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property resource_id (base name: "resource_id")', function () {
        expect(instance).to.have.property('resource_id');
        // expect(instance.resource_id).to.be(expectedValueLiteral);
      });
