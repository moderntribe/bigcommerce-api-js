...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfMetaFieldCollectionResponse1DataItems', function () {
      beforeEach(function () {
        instance = new Catalog.AllOfMetaFieldCollectionResponse1DataItems();
      });

      it('should create an instance of AllOfMetaFieldCollectionResponse1DataItems', function () {
        expect(instance).to.be.a(Catalog.AllOfMetaFieldCollectionResponse1DataItems);
      });
