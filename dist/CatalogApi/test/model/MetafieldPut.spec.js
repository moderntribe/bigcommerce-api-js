...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetafieldPut', function () {
      beforeEach(function () {
        instance = new Catalog.MetafieldPut();
      });

      it('should create an instance of MetafieldPut', function () {
        expect(instance).to.be.a(Catalog.MetafieldPut);
      });
