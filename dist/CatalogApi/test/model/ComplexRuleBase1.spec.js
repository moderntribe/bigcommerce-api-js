...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ComplexRuleBase1', function () {
      beforeEach(function () {
        instance = new Catalog.ComplexRuleBase1();
      });

      it('should create an instance of ComplexRuleBase1', function () {
        expect(instance).to.be.a(Catalog.ComplexRuleBase1);
      });
