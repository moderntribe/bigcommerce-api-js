...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PaginationFull1Links', function () {
      beforeEach(function () {
        instance = new Catalog.PaginationFull1Links();
      });

      it('should create an instance of PaginationFull1Links', function () {
        expect(instance).to.be.a(Catalog.PaginationFull1Links);
      });
