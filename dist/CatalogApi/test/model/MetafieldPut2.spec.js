...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetafieldPut2', function () {
      beforeEach(function () {
        instance = new Catalog.MetafieldPut2();
      });

      it('should create an instance of MetafieldPut2', function () {
        expect(instance).to.be.a(Catalog.MetafieldPut2);
      });
