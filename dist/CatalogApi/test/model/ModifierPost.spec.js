...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ModifierPost', function () {
      beforeEach(function () {
        instance = new Catalog.ModifierPost();
      });

      it('should create an instance of ModifierPost', function () {
        expect(instance).to.be.a(Catalog.ModifierPost);
      });
