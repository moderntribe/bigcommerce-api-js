...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CatalogSummary', function () {
      beforeEach(function () {
        instance = new Catalog.CatalogSummary();
      });

      it('should create an instance of CatalogSummary', function () {
        expect(instance).to.be.a(Catalog.CatalogSummary);
      });
