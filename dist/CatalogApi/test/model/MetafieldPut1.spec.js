...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetafieldPut1', function () {
      beforeEach(function () {
        instance = new Catalog.MetafieldPut1();
      });

      it('should create an instance of MetafieldPut1', function () {
        expect(instance).to.be.a(Catalog.MetafieldPut1);
      });
