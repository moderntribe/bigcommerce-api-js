...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CategoriesTreeNodeFull1', function () {
      beforeEach(function () {
        instance = new Catalog.CategoriesTreeNodeFull1();
      });

      it('should create an instance of CategoriesTreeNodeFull1', function () {
        expect(instance).to.be.a(Catalog.CategoriesTreeNodeFull1);
      });
