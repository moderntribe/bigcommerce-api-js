...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AdjustersFull', function () {
      beforeEach(function () {
        instance = new Catalog.AdjustersFull();
      });

      it('should create an instance of AdjustersFull', function () {
        expect(instance).to.be.a(Catalog.AdjustersFull);
      });
