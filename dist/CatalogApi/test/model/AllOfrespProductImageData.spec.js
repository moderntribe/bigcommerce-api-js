...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfrespProductImageData', function () {
      beforeEach(function () {
        instance = new Catalog.AllOfrespProductImageData();
      });

      it('should create an instance of AllOfrespProductImageData', function () {
        expect(instance).to.be.a(Catalog.AllOfrespProductImageData);
      });
