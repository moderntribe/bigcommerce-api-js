...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetafieldPut3', function () {
      beforeEach(function () {
        instance = new Catalog.MetafieldPut3();
      });

      it('should create an instance of MetafieldPut3', function () {
        expect(instance).to.be.a(Catalog.MetafieldPut3);
      });
