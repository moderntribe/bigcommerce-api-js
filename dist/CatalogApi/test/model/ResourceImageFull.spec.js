...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ResourceImageFull', function () {
      beforeEach(function () {
        instance = new Catalog.ResourceImageFull();
      });

      it('should create an instance of ResourceImageFull', function () {
        expect(instance).to.be.a(Catalog.ResourceImageFull);
      });
