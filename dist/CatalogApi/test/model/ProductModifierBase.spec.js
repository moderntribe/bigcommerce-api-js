...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ProductModifierBase', function () {
      beforeEach(function () {
        instance = new Catalog.ProductModifierBase();
      });

      it('should create an instance of ProductModifierBase', function () {
        expect(instance).to.be.a(Catalog.ProductModifierBase);
      });
