...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OptionConfig', function () {
      beforeEach(function () {
        instance = new Catalog.OptionConfig();
      });

      it('should create an instance of OptionConfig', function () {
        expect(instance).to.be.a(Catalog.OptionConfig);
      });
