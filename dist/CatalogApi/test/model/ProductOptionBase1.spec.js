...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ProductOptionBase1', function () {
      beforeEach(function () {
        instance = new Catalog.ProductOptionBase1();
      });

      it('should create an instance of ProductOptionBase1', function () {
        expect(instance).to.be.a(Catalog.ProductOptionBase1);
      });
