...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfproductBaseImagesItems', function () {
      beforeEach(function () {
        instance = new Catalog.AllOfproductBaseImagesItems();
      });

      it('should create an instance of AllOfproductBaseImagesItems', function () {
        expect(instance).to.be.a(Catalog.AllOfproductBaseImagesItems);
      });
