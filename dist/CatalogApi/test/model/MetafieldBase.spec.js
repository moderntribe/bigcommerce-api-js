...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetafieldBase', function () {
      beforeEach(function () {
        instance = new Catalog.MetafieldBase();
      });

      it('should create an instance of MetafieldBase', function () {
        expect(instance).to.be.a(Catalog.MetafieldBase);
      });
