...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetafieldPut4', function () {
      beforeEach(function () {
        instance = new Catalog.MetafieldPut4();
      });

      it('should create an instance of MetafieldPut4', function () {
        expect(instance).to.be.a(Catalog.MetafieldPut4);
      });
