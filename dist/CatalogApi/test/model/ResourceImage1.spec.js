...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ResourceImage1', function () {
      beforeEach(function () {
        instance = new Catalog.ResourceImage1();
      });

      it('should create an instance of ResourceImage1', function () {
        expect(instance).to.be.a(Catalog.ResourceImage1);
      });
