...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AdjustersFull1', function () {
      beforeEach(function () {
        instance = new Catalog.AdjustersFull1();
      });

      it('should create an instance of AdjustersFull1', function () {
        expect(instance).to.be.a(Catalog.AdjustersFull1);
      });
