...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('DetailedErrors1', function () {
      beforeEach(function () {
        instance = new Catalog.DetailedErrors1();
      });

      it('should create an instance of DetailedErrors1', function () {
        expect(instance).to.be.a(Catalog.DetailedErrors1);
      });
