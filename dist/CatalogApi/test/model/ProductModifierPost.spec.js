...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ProductModifierPost', function () {
      beforeEach(function () {
        instance = new Catalog.ProductModifierPost();
      });

      it('should create an instance of ProductModifierPost', function () {
        expect(instance).to.be.a(Catalog.ProductModifierPost);
      });
