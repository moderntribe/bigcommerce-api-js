...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ProductVariantPutProduct', function () {
      beforeEach(function () {
        instance = new Catalog.ProductVariantPutProduct();
      });

      it('should create an instance of ProductVariantPutProduct', function () {
        expect(instance).to.be.a(Catalog.ProductVariantPutProduct);
      });
