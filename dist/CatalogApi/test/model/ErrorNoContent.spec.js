...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ErrorNoContent', function () {
      beforeEach(function () {
        instance = new Catalog.ErrorNoContent();
      });

      it('should create an instance of ErrorNoContent', function () {
        expect(instance).to.be.a(Catalog.ErrorNoContent);
      });
