...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ProductFull', function () {
      beforeEach(function () {
        instance = new Catalog.ProductFull();
      });

      it('should create an instance of ProductFull', function () {
        expect(instance).to.be.a(Catalog.ProductFull);
      });
