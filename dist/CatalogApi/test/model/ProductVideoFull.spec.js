...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ProductVideoFull', function () {
      beforeEach(function () {
        instance = new Catalog.ProductVideoFull();
      });

      it('should create an instance of ProductVideoFull', function () {
        expect(instance).to.be.a(Catalog.ProductVideoFull);
      });
