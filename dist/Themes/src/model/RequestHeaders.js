...
var RequestHeaders = function () {
    ...
    */
    ...
    _createClass(RequestHeaders, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('X-Auth-Client')) {
                    obj['X-Auth-Client'] = _ApiClient2.default.convertToType(data['X-Auth-Client'], 'String');
                }
                if (data.hasOwnProperty('Accepts')) {
                    obj['Accepts'] = _ApiClient2.default.convertToType(data['Accepts'], 'String');
                }
            }
            return obj;
        }
