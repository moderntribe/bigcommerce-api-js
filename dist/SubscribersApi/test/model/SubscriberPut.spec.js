...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubscriberPut', function () {
      beforeEach(function () {
        instance = new Subscribers.SubscriberPut();
      });

      it('should create an instance of SubscriberPut', function () {
        expect(instance).to.be.a(Subscribers.SubscriberPut);
      });
    });
  });
});