...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubscriberResponse', function () {
      beforeEach(function () {
        instance = new Subscribers.SubscriberResponse();
      });

      it('should create an instance of SubscriberResponse', function () {
        expect(instance).to.be.a(Subscribers.SubscriberResponse);
      });
