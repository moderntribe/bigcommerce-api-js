...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubscriberCollectionResponse', function () {
      beforeEach(function () {
        instance = new Subscribers.SubscriberCollectionResponse();
      });

      it('should create an instance of SubscriberCollectionResponse', function () {
        expect(instance).to.be.a(Subscribers.SubscriberCollectionResponse);
      });
