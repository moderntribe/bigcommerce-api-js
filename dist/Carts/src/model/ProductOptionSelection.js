...
* @version 3.0
*/
var ProductOptionSelection = function () {
    /**
    ...
    */
    ...
    function ProductOptionSelection() {
        _classCallCheck(this, ProductOptionSelection);

        this['option_id'] = undefined;
        this['option_value'] = undefined;
    }
    ...
    */
    ...
    _createClass(ProductOptionSelection, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('option_value')) {
                    obj['option_value'] = _ApiClient2.default.convertToType(data['option_value'], 'String');
                }
            }
            return obj;
        }
...
exports.default = ProductOptionSelection;