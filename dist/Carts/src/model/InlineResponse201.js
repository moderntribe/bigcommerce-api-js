...
var InlineResponse201 = function () {
    ...
    */
    ...
    function InlineResponse201() {
        ...
        this['cart_url'] = undefined;
        this['checkout_url'] = undefined;
    }
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('cart_url')) {
                    obj['cart_url'] = _ApiClient2.default.convertToType(data['cart_url'], 'String');
                }
                if (data.hasOwnProperty('checkout_url')) {
                    obj['checkout_url'] = _ApiClient2.default.convertToType(data['checkout_url'], 'String');
                }
            }
            return obj;
        }
