...
/**
* The CartLineItemUpdatePost model module.
* @module model/CartLineItemUpdatePost
* @version 3.0
*/
var CartLineItemUpdatePost = function () {
    /**
    * Constructs a new <code>CartLineItemUpdatePost</code>.
    * @alias module:model/CartLineItemUpdatePost
    * @class
    */

    function CartLineItemUpdatePost() {
        _classCallCheck(this, CartLineItemUpdatePost);
    ...
    /**
    * Constructs a <code>CartLineItemUpdatePost</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CartLineItemUpdatePost} obj Optional instance to populate.
    * @return {module:model/CartLineItemUpdatePost} The populated <code>CartLineItemUpdatePost</code> instance.
    */


    _createClass(CartLineItemUpdatePost, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CartLineItemUpdatePost();
    ...
    return CartLineItemUpdatePost;
}();

exports.default = CartLineItemUpdatePost;