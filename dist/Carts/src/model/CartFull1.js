...
/**
* The CartFull1 model module.
* @module model/CartFull1
* @version 3.0
*/
var CartFull1 = function () {
    /**
    * Constructs a new <code>CartFull1</code>.
    * A cart contains a collection of items, prices, discounts, etc.. It does not contain customer-related data.
    * @alias module:model/CartFull1
    * @class
    */

    function CartFull1() {
        _classCallCheck(this, CartFull1);
    ...
    /**
    * Constructs a <code>CartFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CartFull1} obj Optional instance to populate.
    * @return {module:model/CartFull1} The populated <code>CartFull1</code> instance.
    */


    _createClass(CartFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CartFull1();
