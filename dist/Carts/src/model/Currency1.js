...
/**
* The Currency1 model module.
* @module model/Currency1
* @version 3.0
*/
var Currency1 = function () {
    /**
    * Constructs a new <code>Currency1</code>.
    * This will always be the same between cart and checkout.
    * @alias module:model/Currency1
    * @class
    */

    function Currency1() {
        _classCallCheck(this, Currency1);

        this['code'] = undefined;
    }

    /**
    * Constructs a <code>Currency1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Currency1} obj Optional instance to populate.
    * @return {module:model/Currency1} The populated <code>Currency1</code> instance.
    */


    _createClass(Currency1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new Currency1();
