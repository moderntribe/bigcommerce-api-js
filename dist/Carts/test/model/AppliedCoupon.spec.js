...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AppliedCoupon', function () {
      beforeEach(function () {
        instance = new Carts.AppliedCoupon();
      });

      it('should create an instance of AppliedCoupon', function () {
        expect(instance).to.be.a(Carts.AppliedCoupon);
      });
      ...
      it('should have the property coupon_type (base name: "coupon_type")', function () {
        expect(instance).to.have.property('coupon_type');
        // expect(instance.coupon_type).to.be(expectedValueLiteral);
      });

      it('should have the property discounted_amount (base name: "discounted_amount")', function () {
        expect(instance).to.have.property('discounted_amount');
        // expect(instance.discounted_amount).to.be(expectedValueLiteral);
      });
    });
  });
});