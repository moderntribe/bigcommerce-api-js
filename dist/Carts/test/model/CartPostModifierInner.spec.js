...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CartPostModifierInner', function () {
      beforeEach(function () {
        instance = new Carts.CartPostModifierInner();
      });

      it('should create an instance of CartPostModifierInner', function () {
        expect(instance).to.be.a(Carts.CartPostModifierInner);
      });
