...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CartLineItemUpdatePost2', function () {
      beforeEach(function () {
        instance = new Carts.CartLineItemUpdatePost2();
      });

      it('should create an instance of CartLineItemUpdatePost2', function () {
        expect(instance).to.be.a(Carts.CartLineItemUpdatePost2);
      });
