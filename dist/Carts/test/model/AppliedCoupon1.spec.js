...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AppliedCoupon1', function () {
      beforeEach(function () {
        instance = new Carts.AppliedCoupon1();
      });

      it('should create an instance of AppliedCoupon1', function () {
        expect(instance).to.be.a(Carts.AppliedCoupon1);
      });
