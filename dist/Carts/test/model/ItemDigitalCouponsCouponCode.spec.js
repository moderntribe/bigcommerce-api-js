...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ItemDigitalCouponsCouponCode', function () {
      beforeEach(function () {
        instance = new Carts.ItemDigitalCouponsCouponCode();
      });

      it('should create an instance of ItemDigitalCouponsCouponCode', function () {
        expect(instance).to.be.a(Carts.ItemDigitalCouponsCouponCode);
      });
      ...
      it('should have the property expiresDate (base name: "expiresDate")', function () {
        expect(instance).to.have.property('expiresDate');
        // expect(instance.expiresDate).to.be(expectedValueLiteral);
      });
