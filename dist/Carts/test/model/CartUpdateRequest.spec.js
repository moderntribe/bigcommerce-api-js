...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CartUpdateRequest', function () {
      beforeEach(function () {
        instance = new Carts.CartUpdateRequest();
      });

      it('should create an instance of CartUpdateRequest', function () {
        expect(instance).to.be.a(Carts.CartUpdateRequest);
      });

      it('should have the property line_item (base name: "line_item")', function () {
        expect(instance).to.have.property('line_item');
        // expect(instance.line_item).to.be(expectedValueLiteral);
      });
