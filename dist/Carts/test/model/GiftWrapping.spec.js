...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GiftWrapping', function () {
      beforeEach(function () {
        instance = new Carts.GiftWrapping();
      });

      it('should create an instance of GiftWrapping', function () {
        expect(instance).to.be.a(Carts.GiftWrapping);
      });
