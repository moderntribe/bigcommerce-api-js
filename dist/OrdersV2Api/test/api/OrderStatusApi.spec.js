...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OrdersV2.OrderStatusApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('OrderStatusApi', function () {
      describe('getAOrderStatus', function () {
        it('should call getAOrderStatus successfully', _asyncToGenerator(function* () {
          // const getAOrderStatusResponse = await instance.getAOrderStatus();
          // expect(getAOrderStatusResponse.ok).to.be(true);
          // expect(getAOrderStatusResponse.body.data).to.be.an('array');
        }));
      });
      describe('getOrderStatus', function () {
        it('should call getOrderStatus successfully', _asyncToGenerator(function* () {
          // const getOrderStatusResponse = await instance.getOrderStatus();
          // expect(getOrderStatusResponse.ok).to.be(true);
          // expect(getOrderStatusResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
