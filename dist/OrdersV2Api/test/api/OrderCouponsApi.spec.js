...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OrdersV2.OrderCouponsApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('OrderCouponsApi', function () {
      describe('getAllOrderCoupons', function () {
        it('should call getAllOrderCoupons successfully', _asyncToGenerator(function* () {
          // const getAllOrderCouponsResponse = await instance.getAllOrderCoupons();
          // expect(getAllOrderCouponsResponse.ok).to.be(true);
          // expect(getAllOrderCouponsResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
