...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OrdersV2.OrderMessagesApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('OrderMessagesApi', function () {
      describe('getOrderMessages', function () {
        it('should call getOrderMessages successfully', _asyncToGenerator(function* () {
          // const getOrderMessagesResponse = await instance.getOrderMessages();
          // expect(getOrderMessagesResponse.ok).to.be(true);
          // expect(getOrderMessagesResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
