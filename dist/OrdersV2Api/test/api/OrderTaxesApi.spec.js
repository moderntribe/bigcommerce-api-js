...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OrdersV2.OrderTaxesApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('OrderTaxesApi', function () {
      describe('getOrderTaxes', function () {
        it('should call getOrderTaxes successfully', _asyncToGenerator(function* () {
          // const getOrderTaxesResponse = await instance.getOrderTaxes();
          // expect(getOrderTaxesResponse.ok).to.be(true);
          // expect(getOrderTaxesResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
