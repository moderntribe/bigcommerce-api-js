...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OrdersV2.OrderShippingAddressesQuotesApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('OrderShippingAddressesQuotesApi', function () {
      describe('getShippingQuotes', function () {
        it('should call getShippingQuotes successfully', _asyncToGenerator(function* () {
          // const getShippingQuotesResponse = await instance.getShippingQuotes();
          // expect(getShippingQuotesResponse.ok).to.be(true);
          // expect(getShippingQuotesResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
