...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OrdersV2.OrderProductsApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('OrderProductsApi', function () {
      describe('getAllOrderProducts', function () {
        it('should call getAllOrderProducts successfully', _asyncToGenerator(function* () {
          // const getAllOrderProductsResponse = await instance.getAllOrderProducts();
          // expect(getAllOrderProductsResponse.ok).to.be(true);
          // expect(getAllOrderProductsResponse.body.data).to.be.an('array');
        }));
      });
      describe('getAnOrderProduct', function () {
        it('should call getAnOrderProduct successfully', _asyncToGenerator(function* () {
          // const getAnOrderProductResponse = await instance.getAnOrderProduct();
          // expect(getAnOrderProductResponse.ok).to.be(true);
          // expect(getAnOrderProductResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
