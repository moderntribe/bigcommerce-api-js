...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderStatusOrderStatuses', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderStatusOrderStatuses();
      });

      it('should create an instance of OrderStatusOrderStatuses', function () {
        expect(instance).to.be.a(OrdersV2.OrderStatusOrderStatuses);
      });
