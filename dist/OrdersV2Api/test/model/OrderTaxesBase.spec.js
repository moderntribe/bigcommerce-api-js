...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderTaxesBase', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderTaxesBase();
      });

      it('should create an instance of OrderTaxesBase', function () {
        expect(instance).to.be.a(OrdersV2.OrderTaxesBase);
      });
