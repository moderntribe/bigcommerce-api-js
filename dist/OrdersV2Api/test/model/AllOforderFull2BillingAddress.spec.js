...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOforderFull2BillingAddress', function () {
      beforeEach(function () {
        instance = new OrdersV2.AllOforderFull2BillingAddress();
      });

      it('should create an instance of AllOforderFull2BillingAddress', function () {
        expect(instance).to.be.a(OrdersV2.AllOforderFull2BillingAddress);
      });
