...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderFull', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderFull();
      });

      it('should create an instance of OrderFull', function () {
        expect(instance).to.be.a(OrdersV2.OrderFull);
      });
