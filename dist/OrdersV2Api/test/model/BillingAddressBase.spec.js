...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('BillingAddressBase', function () {
      beforeEach(function () {
        instance = new OrdersV2.BillingAddressBase();
      });

      it('should create an instance of BillingAddressBase', function () {
        expect(instance).to.be.a(OrdersV2.BillingAddressBase);
      });
