...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ShippingAddressBase1', function () {
      beforeEach(function () {
        instance = new OrdersV2.ShippingAddressBase1();
      });

      it('should create an instance of ShippingAddressBase1', function () {
        expect(instance).to.be.a(OrdersV2.ShippingAddressBase1);
      });
