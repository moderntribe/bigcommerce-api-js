...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrdersCountFull1', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrdersCountFull1();
      });

      it('should create an instance of OrdersCountFull1', function () {
        expect(instance).to.be.a(OrdersV2.OrdersCountFull1);
      });
