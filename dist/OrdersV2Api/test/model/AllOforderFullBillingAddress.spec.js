...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOforderFullBillingAddress', function () {
      beforeEach(function () {
        instance = new OrdersV2.AllOforderFullBillingAddress();
      });

      it('should create an instance of AllOforderFullBillingAddress', function () {
        expect(instance).to.be.a(OrdersV2.AllOforderFullBillingAddress);
      });
