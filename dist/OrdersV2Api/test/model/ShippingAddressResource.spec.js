...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ShippingAddressResource', function () {
      beforeEach(function () {
        instance = new OrdersV2.ShippingAddressResource();
      });

      it('should create an instance of ShippingAddressResource', function () {
        expect(instance).to.be.a(OrdersV2.ShippingAddressResource);
      });
