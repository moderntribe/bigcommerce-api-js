...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('BillingAddressBase1', function () {
      beforeEach(function () {
        instance = new OrdersV2.BillingAddressBase1();
      });

      it('should create an instance of BillingAddressBase1', function () {
        expect(instance).to.be.a(OrdersV2.BillingAddressBase1);
      });
