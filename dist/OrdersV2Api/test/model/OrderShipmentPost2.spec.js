...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderShipmentPost2', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderShipmentPost2();
      });

      it('should create an instance of OrderShipmentPost2', function () {
        expect(instance).to.be.a(OrdersV2.OrderShipmentPost2);
      });
