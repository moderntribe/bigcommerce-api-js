...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderProductAppliedDiscounts1', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderProductAppliedDiscounts1();
      });

      it('should create an instance of OrderProductAppliedDiscounts1', function () {
        expect(instance).to.be.a(OrdersV2.OrderProductAppliedDiscounts1);
      });
