...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOforderFull1BillingAddress', function () {
      beforeEach(function () {
        instance = new OrdersV2.AllOforderFull1BillingAddress();
      });

      it('should create an instance of AllOforderFull1BillingAddress', function () {
        expect(instance).to.be.a(OrdersV2.AllOforderFull1BillingAddress);
      });
