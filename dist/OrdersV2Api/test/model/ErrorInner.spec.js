...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ErrorInner', function () {
      beforeEach(function () {
        instance = new OrdersV2.ErrorInner();
      });

      it('should create an instance of ErrorInner', function () {
        expect(instance).to.be.a(OrdersV2.ErrorInner);
      });
