...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrdersorderIdshipmentsItems', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrdersorderIdshipmentsItems();
      });

      it('should create an instance of OrdersorderIdshipmentsItems', function () {
        expect(instance).to.be.a(OrdersV2.OrdersorderIdshipmentsItems);
      });
