...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderProductOptions1', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderProductOptions1();
      });

      it('should create an instance of OrderProductOptions1', function () {
        expect(instance).to.be.a(OrdersV2.OrderProductOptions1);
      });
      ...
      it('should have the property product_option_id (base name: "product_option_id")', function () {
        expect(instance).to.have.property('product_option_id');
        // expect(instance.product_option_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property display_style (base name: "display_style")', function () {
        expect(instance).to.have.property('display_style');
        // expect(instance.display_style).to.be(expectedValueLiteral);
      });
    });
  });
});