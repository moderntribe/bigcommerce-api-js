...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderShipment1', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderShipment1();
      });

      it('should create an instance of OrderShipment1', function () {
        expect(instance).to.be.a(OrdersV2.OrderShipment1);
      });
      ...
      it('should have the property shipping_address (base name: "shipping_address")', function () {
        expect(instance).to.have.property('shipping_address');
        // expect(instance.shipping_address).to.be(expectedValueLiteral);
      });
