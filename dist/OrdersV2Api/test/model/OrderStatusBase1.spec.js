...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderStatusBase1', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderStatusBase1();
      });

      it('should create an instance of OrderStatusBase1', function () {
        expect(instance).to.be.a(OrdersV2.OrderStatusBase1);
      });
      ...
      it('should have the property system_label (base name: "system_label")', function () {
        expect(instance).to.have.property('system_label');
        // expect(instance.system_label).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property system_description (base name: "system_description")', function () {
        expect(instance).to.have.property('system_description');
        // expect(instance.system_description).to.be(expectedValueLiteral);
      });
    });
  });
});