...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderMessages', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderMessages();
      });

      it('should create an instance of OrderMessages', function () {
        expect(instance).to.be.a(OrdersV2.OrderMessages);
      });
    });
  });
});