...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ShippingAddressesPost', function () {
      beforeEach(function () {
        instance = new OrdersV2.ShippingAddressesPost();
      });

      it('should create an instance of ShippingAddressesPost', function () {
        expect(instance).to.be.a(OrdersV2.ShippingAddressesPost);
      });
