...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CouponsResource1', function () {
      beforeEach(function () {
        instance = new OrdersV2.CouponsResource1();
      });

      it('should create an instance of CouponsResource1', function () {
        expect(instance).to.be.a(OrdersV2.CouponsResource1);
      });
