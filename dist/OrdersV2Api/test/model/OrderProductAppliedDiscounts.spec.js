...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderProductAppliedDiscounts', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderProductAppliedDiscounts();
      });

      it('should create an instance of OrderProductAppliedDiscounts', function () {
        expect(instance).to.be.a(OrdersV2.OrderProductAppliedDiscounts);
      });
