...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderProductProductOptions', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderProductProductOptions();
      });

      it('should create an instance of OrderProductProductOptions', function () {
        expect(instance).to.be.a(OrdersV2.OrderProductProductOptions);
      });
