...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrderCustomProduct', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrderCustomProduct();
      });

      it('should create an instance of OrderCustomProduct', function () {
        expect(instance).to.be.a(OrdersV2.OrderCustomProduct);
      });
