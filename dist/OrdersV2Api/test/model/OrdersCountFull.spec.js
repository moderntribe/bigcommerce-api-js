...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('OrdersCountFull', function () {
      beforeEach(function () {
        instance = new OrdersV2.OrdersCountFull();
      });

      it('should create an instance of OrdersCountFull', function () {
        expect(instance).to.be.a(OrdersV2.OrdersCountFull);
      });
