...
var OrderProductsApi = function () {
  ...
  */
  ...
  _createClass(OrderProductsApi, [{
    ...
    value: function getAnOrderProduct(orderId, productId, accept, contentType, callback) {
      var postBody = null;
      ...
      return this.apiClient.callApi('/orders/{order_id}/products/{product_id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
  }]);
