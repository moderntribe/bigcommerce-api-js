...
/**
* The OrderFull model module.
* @module model/OrderFull
* @version 2.0
*/
var OrderFull = function () {
    /**
    * Constructs a new <code>OrderFull</code>.
    * @alias module:model/OrderFull
    * @class
    */

    function OrderFull() {
        _classCallCheck(this, OrderFull);
    ...
    /**
    * Constructs a <code>OrderFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderFull} obj Optional instance to populate.
    * @return {module:model/OrderFull} The populated <code>OrderFull</code> instance.
    */


    _createClass(OrderFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderFull();
        ...
        * @member {module:model/OrderFull.TaxProviderIdEnum} tax_provider_id
        */
