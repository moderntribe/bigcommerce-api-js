...
* @version 2.0
*/
var OrderMessages = function (_extendableBuiltin2) {
    _inherits(OrderMessages, _extendableBuiltin2);
    ...
    */
    ...
    function OrderMessages() {
        ...
        _classCallCheck(this, OrderMessages);

        var _this = _possibleConstructorReturn(this, (OrderMessages.__proto__ || Object.getPrototypeOf(OrderMessages)).call(this));
    ...
    */
    ...
    _createClass(OrderMessages, null, [{
