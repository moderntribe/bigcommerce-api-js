...
/**
* The ProductsResource1 model module.
* @module model/ProductsResource1
* @version 2.0
*/
var ProductsResource1 = function () {
    /**
    * Constructs a new <code>ProductsResource1</code>.
    * @alias module:model/ProductsResource1
    * @class
    */

    function ProductsResource1() {
        _classCallCheck(this, ProductsResource1);
    ...
    /**
    * Constructs a <code>ProductsResource1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProductsResource1} obj Optional instance to populate.
    * @return {module:model/ProductsResource1} The populated <code>ProductsResource1</code> instance.
    */


    _createClass(ProductsResource1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductsResource1();
    ...
    return ProductsResource1;
}();

exports.default = ProductsResource1;