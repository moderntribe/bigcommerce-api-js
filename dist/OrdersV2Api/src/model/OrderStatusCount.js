...
/**
* The OrderStatusCount model module.
* @module model/OrderStatusCount
* @version 2.0
*/
var OrderStatusCount = function () {
    /**
    * Constructs a new <code>OrderStatusCount</code>.
    * @alias module:model/OrderStatusCount
    * @class
    */

    function OrderStatusCount() {
        _classCallCheck(this, OrderStatusCount);
    ...
    /**
    * Constructs a <code>OrderStatusCount</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderStatusCount} obj Optional instance to populate.
    * @return {module:model/OrderStatusCount} The populated <code>OrderStatusCount</code> instance.
    */


    _createClass(OrderStatusCount, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderStatusCount();
...
exports.default = OrderStatusCount;