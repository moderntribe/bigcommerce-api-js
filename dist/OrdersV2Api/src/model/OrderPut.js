...
/**
* The OrderPut model module.
* @module model/OrderPut
* @version 2.0
*/
var OrderPut = function () {
    /**
    * Constructs a new <code>OrderPut</code>.
    * @alias module:model/OrderPut
    * @class
    */

    function OrderPut() {
        _classCallCheck(this, OrderPut);
    ...
    /**
    * Constructs a <code>OrderPut</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderPut} obj Optional instance to populate.
    * @return {module:model/OrderPut} The populated <code>OrderPut</code> instance.
    */


    _createClass(OrderPut, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderPut();
        ...
        * @member {module:model/OrderPut.PaymentMethodEnum} payment_method
        */
        ...
        * @member {module:model/OrderPut.TaxProviderIdEnum} tax_provider_id
        */
