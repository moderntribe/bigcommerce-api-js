...
/**
* The OrderShipment1 model module.
* @module model/OrderShipment1
* @version 2.0
*/
var OrderShipment1 = function () {
    /**
    * Constructs a new <code>OrderShipment1</code>.
    * @alias module:model/OrderShipment1
    * @class
    */

    function OrderShipment1() {
        _classCallCheck(this, OrderShipment1);
    ...
    /**
    * Constructs a <code>OrderShipment1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderShipment1} obj Optional instance to populate.
    * @return {module:model/OrderShipment1} The populated <code>OrderShipment1</code> instance.
    */


    _createClass(OrderShipment1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderShipment1();
        ...
        * @member {module:model/OrderShipment1.ShippingProviderEnum} shipping_provider
        */
    ...
    return OrderShipment1;
}();

OrderShipment1.ShippingProviderEnum = {
    /**
     * value: "auspost"
     * @const
     */
     ...
     */
    " ": " " };
exports.default = OrderShipment1;