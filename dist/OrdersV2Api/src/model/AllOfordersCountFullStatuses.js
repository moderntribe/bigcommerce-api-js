...
/**
* The AllOfordersCountFullStatuses model module.
* @module model/AllOfordersCountFullStatuses
* @version 2.0
*/
var AllOfordersCountFullStatuses = function () {
    /**
    * Constructs a new <code>AllOfordersCountFullStatuses</code>.
    * @alias module:model/AllOfordersCountFullStatuses
    * @class
    */

    function AllOfordersCountFullStatuses() {
        _classCallCheck(this, AllOfordersCountFullStatuses);
    ...
    /**
    * Constructs a <code>AllOfordersCountFullStatuses</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfordersCountFullStatuses} obj Optional instance to populate.
    * @return {module:model/AllOfordersCountFullStatuses} The populated <code>AllOfordersCountFullStatuses</code> instance.
    */


    _createClass(AllOfordersCountFullStatuses, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfordersCountFullStatuses();
...
exports.default = AllOfordersCountFullStatuses;