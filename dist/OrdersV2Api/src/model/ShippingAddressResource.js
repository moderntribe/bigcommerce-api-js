...
/**
* The ShippingAddressResource model module.
* @module model/ShippingAddressResource
* @version 2.0
*/
var ShippingAddressResource = function () {
    /**
    * Constructs a new <code>ShippingAddressResource</code>.
    * @alias module:model/ShippingAddressResource
    * @class
    */

    function ShippingAddressResource() {
        _classCallCheck(this, ShippingAddressResource);
    ...
    /**
    * Constructs a <code>ShippingAddressResource</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ShippingAddressResource} obj Optional instance to populate.
    * @return {module:model/ShippingAddressResource} The populated <code>ShippingAddressResource</code> instance.
    */


    _createClass(ShippingAddressResource, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ShippingAddressResource();
...
exports.default = ShippingAddressResource;