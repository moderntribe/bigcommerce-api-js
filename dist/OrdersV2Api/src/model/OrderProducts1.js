...
/**
* The OrderProducts1 model module.
* @module model/OrderProducts1
* @version 2.0
*/
var OrderProducts1 = function () {
    /**
    * Constructs a new <code>OrderProducts1</code>.
    * @alias module:model/OrderProducts1
    * @class
    */

    function OrderProducts1() {
        _classCallCheck(this, OrderProducts1);
    ...
    /**
    * Constructs a <code>OrderProducts1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderProducts1} obj Optional instance to populate.
    * @return {module:model/OrderProducts1} The populated <code>OrderProducts1</code> instance.
    */


    _createClass(OrderProducts1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderProducts1();
        ...
        */
        ...
        /**
        * Type of product
        * @member {module:model/OrderProducts1.TypeEnum} type
        */
...
OrderProducts1.TypeEnum = {
     ...
     */
    "digital": "digital" };
exports.default = OrderProducts1;