...
/**
* The BillingAddressFull model module.
* @module model/BillingAddressFull
* @version 2.0
*/
var BillingAddressFull = function () {
    /**
    * Constructs a new <code>BillingAddressFull</code>.
    * Required to create an order.
    * @alias module:model/BillingAddressFull
    * @class
    */

    function BillingAddressFull() {
        _classCallCheck(this, BillingAddressFull);

        this['form_fields'] = undefined;
    }

    /**
    * Constructs a <code>BillingAddressFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BillingAddressFull} obj Optional instance to populate.
    * @return {module:model/BillingAddressFull} The populated <code>BillingAddressFull</code> instance.
    */


    _createClass(BillingAddressFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BillingAddressFull();
...
exports.default = BillingAddressFull;