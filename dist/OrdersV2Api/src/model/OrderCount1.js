...
/**
* The OrderCount1 model module.
* @module model/OrderCount1
* @version 2.0
*/
var OrderCount1 = function () {
    /**
    * Constructs a new <code>OrderCount1</code>.
    * @alias module:model/OrderCount1
    * @class
    */

    function OrderCount1() {
        _classCallCheck(this, OrderCount1);

        this['count'] = undefined;
    }

    /**
    * Constructs a <code>OrderCount1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderCount1} obj Optional instance to populate.
    * @return {module:model/OrderCount1} The populated <code>OrderCount1</code> instance.
    */


    _createClass(OrderCount1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderCount1();
