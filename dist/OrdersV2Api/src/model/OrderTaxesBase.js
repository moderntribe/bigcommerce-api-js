...
/**
* The OrderTaxesBase model module.
* @module model/OrderTaxesBase
* @version 2.0
*/
var OrderTaxesBase = function () {
    /**
    * Constructs a new <code>OrderTaxesBase</code>.
    * @alias module:model/OrderTaxesBase
    * @class
    */

    function OrderTaxesBase() {
        _classCallCheck(this, OrderTaxesBase);
    ...
    /**
    * Constructs a <code>OrderTaxesBase</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderTaxesBase} obj Optional instance to populate.
    * @return {module:model/OrderTaxesBase} The populated <code>OrderTaxesBase</code> instance.
    */


    _createClass(OrderTaxesBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderTaxesBase();
        ...
        */
        ...
        /**
        * Type of tax on item
        * @member {module:model/OrderTaxesBase.LineItemTypeEnum} line_item_type
        */
    ...
    return OrderTaxesBase;
}();

OrderTaxesBase.LineItemTypeEnum = {
    /**
     * value: "item"
     * @const
     */
...
exports.default = OrderTaxesBase;