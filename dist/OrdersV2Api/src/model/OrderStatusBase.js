...
var OrderStatusBase = function () {
    ...
    */
    ...
    function OrderStatusBase() {
        _classCallCheck(this, OrderStatusBase);

        this['id'] = undefined;
        this['name'] = undefined;
        this['system_label'] = undefined;
        this['custom_label'] = undefined;
        this['system_description'] = undefined;
    }
    ...
    */
    ...
    _createClass(OrderStatusBase, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('system_label')) {
                    obj['system_label'] = _ApiClient2.default.convertToType(data['system_label'], 'String');
                }
                if (data.hasOwnProperty('custom_label')) {
                    obj['custom_label'] = _ApiClient2.default.convertToType(data['custom_label'], 'String');
                }
                if (data.hasOwnProperty('system_description')) {
                    obj['system_description'] = _ApiClient2.default.convertToType(data['system_description'], 'String');
                }
            }
            return obj;
        }
...
exports.default = OrderStatusBase;