...
/**
* The OrderStatusBase1 model module.
* @module model/OrderStatusBase1
* @version 2.0
*/
var OrderStatusBase1 = function () {
    /**
    * Constructs a new <code>OrderStatusBase1</code>.
    * @alias module:model/OrderStatusBase1
    * @class
    */

    function OrderStatusBase1() {
        _classCallCheck(this, OrderStatusBase1);
    ...
    /**
    * Constructs a <code>OrderStatusBase1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderStatusBase1} obj Optional instance to populate.
    * @return {module:model/OrderStatusBase1} The populated <code>OrderStatusBase1</code> instance.
    */


    _createClass(OrderStatusBase1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderStatusBase1();
    ...
    return OrderStatusBase1;
}();

exports.default = OrderStatusBase1;