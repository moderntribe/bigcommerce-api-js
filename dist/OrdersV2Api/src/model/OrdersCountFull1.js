...
/**
* The OrdersCountFull1 model module.
* @module model/OrdersCountFull1
* @version 2.0
*/
var OrdersCountFull1 = function () {
    /**
    * Constructs a new <code>OrdersCountFull1</code>.
    * @alias module:model/OrdersCountFull1
    * @class
    */

    function OrdersCountFull1() {
        _classCallCheck(this, OrdersCountFull1);
    ...
    /**
    * Constructs a <code>OrdersCountFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrdersCountFull1} obj Optional instance to populate.
    * @return {module:model/OrdersCountFull1} The populated <code>OrdersCountFull1</code> instance.
    */


    _createClass(OrdersCountFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrdersCountFull1();

                if (data.hasOwnProperty('statuses')) {
                    obj['statuses'] = _ApiClient2.default.convertToType(data['statuses'], Object);
                }
    ...
    return OrdersCountFull1;
}();

exports.default = OrdersCountFull1;