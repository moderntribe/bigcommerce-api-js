...
/**
* The AllOforderFullBillingAddress model module.
* @module model/AllOforderFullBillingAddress
* @version 2.0
*/
var AllOforderFullBillingAddress = function () {
    /**
    * Constructs a new <code>AllOforderFullBillingAddress</code>.
    * Required to create an order.
    * @alias module:model/AllOforderFullBillingAddress
    * @class
    */

    function AllOforderFullBillingAddress() {
        _classCallCheck(this, AllOforderFullBillingAddress);

        this['form_fields'] = undefined;
    }

    /**
    * Constructs a <code>AllOforderFullBillingAddress</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOforderFullBillingAddress} obj Optional instance to populate.
    * @return {module:model/AllOforderFullBillingAddress} The populated <code>AllOforderFullBillingAddress</code> instance.
    */


    _createClass(AllOforderFullBillingAddress, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOforderFullBillingAddress();
    ...
    return AllOforderFullBillingAddress;
}();

exports.default = AllOforderFullBillingAddress;