...
/**
* The ShippingAddressBase model module.
* @module model/ShippingAddressBase
* @version 2.0
*/
var ShippingAddressBase = function () {
    /**
    * Constructs a new <code>ShippingAddressBase</code>.
    * @alias module:model/ShippingAddressBase
    * @class
    */

    function ShippingAddressBase() {
        _classCallCheck(this, ShippingAddressBase);
    ...
    /**
    * Constructs a <code>ShippingAddressBase</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ShippingAddressBase} obj Optional instance to populate.
    * @return {module:model/ShippingAddressBase} The populated <code>ShippingAddressBase</code> instance.
    */


    _createClass(ShippingAddressBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ShippingAddressBase();
...
exports.default = ShippingAddressBase;