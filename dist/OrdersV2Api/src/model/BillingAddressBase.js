...
/**
* The BillingAddressBase model module.
* @module model/BillingAddressBase
* @version 2.0
*/
var BillingAddressBase = function () {
    /**
    * Constructs a new <code>BillingAddressBase</code>.
    * @alias module:model/BillingAddressBase
    * @class
    */

    function BillingAddressBase() {
        _classCallCheck(this, BillingAddressBase);
    ...
    /**
    * Constructs a <code>BillingAddressBase</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BillingAddressBase} obj Optional instance to populate.
    * @return {module:model/BillingAddressBase} The populated <code>BillingAddressBase</code> instance.
    */


    _createClass(BillingAddressBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BillingAddressBase();
    ...
    return BillingAddressBase;
}();

exports.default = BillingAddressBase;