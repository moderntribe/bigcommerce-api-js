...
/**
* The FormFields1 model module.
* @module model/FormFields1
* @version 2.0
*/
var FormFields1 = function () {
    /**
    * Constructs a new <code>FormFields1</code>.
    * Read-Only. If you have required address form fields they will need to be set as optional before creating an order via API.
    * @alias module:model/FormFields1
    * @class
    */

    function FormFields1() {
        _classCallCheck(this, FormFields1);
    ...
    /**
    * Constructs a <code>FormFields1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FormFields1} obj Optional instance to populate.
    * @return {module:model/FormFields1} The populated <code>FormFields1</code> instance.
    */


    _createClass(FormFields1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new FormFields1();
