...
/**
* The ErrorInner model module.
* @module model/ErrorInner
* @version 2.0
*/
var ErrorInner = function () {
    /**
    * Constructs a new <code>ErrorInner</code>.
    * @alias module:model/ErrorInner
    * @class
    */

    function ErrorInner() {
        _classCallCheck(this, ErrorInner);
    ...
    /**
    * Constructs a <code>ErrorInner</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ErrorInner} obj Optional instance to populate.
    * @return {module:model/ErrorInner} The populated <code>ErrorInner</code> instance.
    */


    _createClass(ErrorInner, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ErrorInner();
