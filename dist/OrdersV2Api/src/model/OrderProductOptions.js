...
* @version 2.0
*/
var OrderProductOptions = function () {
    /**
    ...
    */
    ...
    function OrderProductOptions() {
        _classCallCheck(this, OrderProductOptions);
    ...
    */
    ...
    _createClass(OrderProductOptions, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderProductOptions();
        ...
        */
        ...
        /**
        * Option Type
        * @member {module:model/OrderProductOptions.TypeEnum} type
        */
...
exports.default = OrderProductOptions;