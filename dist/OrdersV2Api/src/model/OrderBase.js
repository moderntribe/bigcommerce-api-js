...
var OrderBase = function () {
    ...
    * @class
    * @param billingAddress {Object} Required to create an order.
    * @param products {Array.<Object>} 
    */

    function OrderBase(billingAddress, products) {
        _classCallCheck(this, OrderBase);
    ...
    */
    ...
    _createClass(OrderBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderBase();
