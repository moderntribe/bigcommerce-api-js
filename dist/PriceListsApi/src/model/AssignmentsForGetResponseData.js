...
/**
* The AssignmentsForGetResponseData model module.
* @module model/AssignmentsForGetResponseData
* @version 3.0
*/
var AssignmentsForGetResponseData = function () {
    /**
    * Constructs a new <code>AssignmentsForGetResponseData</code>.
    * @alias module:model/AssignmentsForGetResponseData
    * @class
    */

    function AssignmentsForGetResponseData() {
        _classCallCheck(this, AssignmentsForGetResponseData);
    ...
    /**
    * Constructs a <code>AssignmentsForGetResponseData</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AssignmentsForGetResponseData} obj Optional instance to populate.
    * @return {module:model/AssignmentsForGetResponseData} The populated <code>AssignmentsForGetResponseData</code> instance.
    */


    _createClass(AssignmentsForGetResponseData, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AssignmentsForGetResponseData();
    ...
    return AssignmentsForGetResponseData;
}();

exports.default = AssignmentsForGetResponseData;