...
var _AssignmentsForGetResponseData = require('./AssignmentsForGetResponseData');
...
/**
* The AssignmentsForGetResponse model module.
* @module model/AssignmentsForGetResponse
* @version 3.0
*/
var AssignmentsForGetResponse = function () {
    /**
    * Constructs a new <code>AssignmentsForGetResponse</code>.
    * Array of the price list assignments matching the filter. The response is paginated.
    * @alias module:model/AssignmentsForGetResponse
    * @class
    */

    function AssignmentsForGetResponse() {
        _classCallCheck(this, AssignmentsForGetResponse);
    ...
    /**
    * Constructs a <code>AssignmentsForGetResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AssignmentsForGetResponse} obj Optional instance to populate.
    * @return {module:model/AssignmentsForGetResponse} The populated <code>AssignmentsForGetResponse</code> instance.
    */


    _createClass(AssignmentsForGetResponse, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AssignmentsForGetResponse();

                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], [_AssignmentsForGetResponseData2.default]);
                }
        ...
        /**
        * @member {Array.<module:model/AssignmentsForGetResponseData>} data
        */
    ...
    return AssignmentsForGetResponse;
}();

exports.default = AssignmentsForGetResponse;