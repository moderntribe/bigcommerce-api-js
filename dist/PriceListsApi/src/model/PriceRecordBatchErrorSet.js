...
* @version 3.0
*/
var PriceRecordBatchErrorSet = function () {
    /**
    ...
    */
    ...
    function PriceRecordBatchErrorSet() {
        _classCallCheck(this, PriceRecordBatchErrorSet);
    ...
    */
    ...
    _createClass(PriceRecordBatchErrorSet, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceRecordBatchErrorSet();
    ...
    return PriceRecordBatchErrorSet;
}();

exports.default = PriceRecordBatchErrorSet;