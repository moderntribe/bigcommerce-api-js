...
/**
* The PriceListAssignmentsBatchErrorResponseBatchErrors model module.
* @module model/PriceListAssignmentsBatchErrorResponseBatchErrors
* @version 3.0
*/
var PriceListAssignmentsBatchErrorResponseBatchErrors = function () {
    /**
    * Constructs a new <code>PriceListAssignmentsBatchErrorResponseBatchErrors</code>.
    * Error during &#x60;Price List Assignments&#x60; batch POST. Includes data sent in the request and errors.
    * @alias module:model/PriceListAssignmentsBatchErrorResponseBatchErrors
    * @class
    */

    function PriceListAssignmentsBatchErrorResponseBatchErrors() {
        _classCallCheck(this, PriceListAssignmentsBatchErrorResponseBatchErrors);
    ...
    /**
    * Constructs a <code>PriceListAssignmentsBatchErrorResponseBatchErrors</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PriceListAssignmentsBatchErrorResponseBatchErrors} obj Optional instance to populate.
    * @return {module:model/PriceListAssignmentsBatchErrorResponseBatchErrors} The populated <code>PriceListAssignmentsBatchErrorResponseBatchErrors</code> instance.
    */


    _createClass(PriceListAssignmentsBatchErrorResponseBatchErrors, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceListAssignmentsBatchErrorResponseBatchErrors();

                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], Object);
                }
                if (data.hasOwnProperty('field_errors')) {
                    obj['field_errors'] = _ApiClient2.default.convertToType(data['field_errors'], { 'String': 'String' });
                }
            }
            return obj;
        }
        ...
        */
        ...
        /**
        * @member {Object.<String, String>} field_errors
        */

    }]);

    return PriceListAssignmentsBatchErrorResponseBatchErrors;
}();

exports.default = PriceListAssignmentsBatchErrorResponseBatchErrors;