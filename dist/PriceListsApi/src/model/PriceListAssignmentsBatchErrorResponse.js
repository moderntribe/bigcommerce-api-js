...
var _PriceListAssignmentsBatchErrorResponseBatchErrors = require('./PriceListAssignmentsBatchErrorResponseBatchErrors');
...
/**
* The PriceListAssignmentsBatchErrorResponse model module.
* @module model/PriceListAssignmentsBatchErrorResponse
* @version 3.0
*/
var PriceListAssignmentsBatchErrorResponse = function () {
    /**
    * Constructs a new <code>PriceListAssignmentsBatchErrorResponse</code>.
    * Errors during batch usage for the BigCommerce API.
    * @alias module:model/PriceListAssignmentsBatchErrorResponse
    * @class
    */

    function PriceListAssignmentsBatchErrorResponse() {
        _classCallCheck(this, PriceListAssignmentsBatchErrorResponse);

        this['batch_errors'] = undefined;
    }

    /**
    * Constructs a <code>PriceListAssignmentsBatchErrorResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PriceListAssignmentsBatchErrorResponse} obj Optional instance to populate.
    * @return {module:model/PriceListAssignmentsBatchErrorResponse} The populated <code>PriceListAssignmentsBatchErrorResponse</code> instance.
    */


    _createClass(PriceListAssignmentsBatchErrorResponse, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceListAssignmentsBatchErrorResponse();

                if (data.hasOwnProperty('batch_errors')) {
                    obj['batch_errors'] = _ApiClient2.default.convertToType(data['batch_errors'], [_PriceListAssignmentsBatchErrorResponseBatchErrors2.default]);
                }
            }
            return obj;
        }
        ...
        /**
        * @member {Array.<module:model/PriceListAssignmentsBatchErrorResponseBatchErrors>} batch_errors
        */

    }]);

    return PriceListAssignmentsBatchErrorResponse;
}();

exports.default = PriceListAssignmentsBatchErrorResponse;