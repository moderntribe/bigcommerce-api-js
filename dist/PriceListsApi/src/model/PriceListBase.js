...
* @version 3.0
*/
var PriceListBase = function () {
    /**
    * Constructs a new <code>PriceListBase</code>.
    * Common Price List properties.
    * @alias module:model/PriceListBase
    * @class
    * @param name {String} The unique name of the Price List. Required in /POST.  
    */

    function PriceListBase(name) {
        _classCallCheck(this, PriceListBase);
    ...
    */
    ...
    _createClass(PriceListBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceListBase();
