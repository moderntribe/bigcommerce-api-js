...
/**
* The AllOfPriceListCollectionResponseDataItems model module.
* @module model/AllOfPriceListCollectionResponseDataItems
* @version 3.0
*/
var AllOfPriceListCollectionResponseDataItems = function () {
    /**
    * Constructs a new <code>AllOfPriceListCollectionResponseDataItems</code>.
    * @alias module:model/AllOfPriceListCollectionResponseDataItems
    * @class
    * @param name {} The unique name of the Price List. Required in /POST.  
    */

    function AllOfPriceListCollectionResponseDataItems(name) {
        _classCallCheck(this, AllOfPriceListCollectionResponseDataItems);
    ...
    /**
    * Constructs a <code>AllOfPriceListCollectionResponseDataItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfPriceListCollectionResponseDataItems} obj Optional instance to populate.
    * @return {module:model/AllOfPriceListCollectionResponseDataItems} The populated <code>AllOfPriceListCollectionResponseDataItems</code> instance.
    */


    _createClass(AllOfPriceListCollectionResponseDataItems, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfPriceListCollectionResponseDataItems();
    ...
    return AllOfPriceListCollectionResponseDataItems;
}();

exports.default = AllOfPriceListCollectionResponseDataItems;