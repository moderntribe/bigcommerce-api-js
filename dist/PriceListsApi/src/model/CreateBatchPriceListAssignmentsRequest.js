...
/**
* The CreateBatchPriceListAssignmentsRequest model module.
* @module model/CreateBatchPriceListAssignmentsRequest
* @version 3.0
*/
var CreateBatchPriceListAssignmentsRequest = function (_extendableBuiltin2) {
    _inherits(CreateBatchPriceListAssignmentsRequest, _extendableBuiltin2);

    /**
    * Constructs a new <code>CreateBatchPriceListAssignmentsRequest</code>.
    * Batch of price list assignments.
    * @alias module:model/CreateBatchPriceListAssignmentsRequest
    * @class
    * @extends Array
    */

    function CreateBatchPriceListAssignmentsRequest() {
        var _ret;

        _classCallCheck(this, CreateBatchPriceListAssignmentsRequest);

        var _this = _possibleConstructorReturn(this, (CreateBatchPriceListAssignmentsRequest.__proto__ || Object.getPrototypeOf(CreateBatchPriceListAssignmentsRequest)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>CreateBatchPriceListAssignmentsRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateBatchPriceListAssignmentsRequest} obj Optional instance to populate.
    * @return {module:model/CreateBatchPriceListAssignmentsRequest} The populated <code>CreateBatchPriceListAssignmentsRequest</code> instance.
    */


    _createClass(CreateBatchPriceListAssignmentsRequest, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateBatchPriceListAssignmentsRequest();
                _ApiClient2.default.constructFromObject(data, obj, 'Body');
            }
            return obj;
        }
    }]);

    return CreateBatchPriceListAssignmentsRequest;
}(_extendableBuiltin(Array));

exports.default = CreateBatchPriceListAssignmentsRequest;