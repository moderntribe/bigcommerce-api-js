...
/**
* The PriceListAssignmentsBatchErrorSet model module.
* @module model/PriceListAssignmentsBatchErrorSet
* @version 3.0
*/
var PriceListAssignmentsBatchErrorSet = function () {
    /**
    * Constructs a new <code>PriceListAssignmentsBatchErrorSet</code>.
    * Error during &#x60;Price List Assignments&#x60; batch POST. Includes data sent in the request and errors.
    * @alias module:model/PriceListAssignmentsBatchErrorSet
    * @class
    */

    function PriceListAssignmentsBatchErrorSet() {
        _classCallCheck(this, PriceListAssignmentsBatchErrorSet);
    ...
    /**
    * Constructs a <code>PriceListAssignmentsBatchErrorSet</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PriceListAssignmentsBatchErrorSet} obj Optional instance to populate.
    * @return {module:model/PriceListAssignmentsBatchErrorSet} The populated <code>PriceListAssignmentsBatchErrorSet</code> instance.
    */


    _createClass(PriceListAssignmentsBatchErrorSet, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PriceListAssignmentsBatchErrorSet();
    ...
    return PriceListAssignmentsBatchErrorSet;
}();

exports.default = PriceListAssignmentsBatchErrorSet;