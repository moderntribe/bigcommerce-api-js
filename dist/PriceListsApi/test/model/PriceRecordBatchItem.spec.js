...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordBatchItem', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordBatchItem();
      });

      it('should create an instance of PriceRecordBatchItem', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordBatchItem);
      });
