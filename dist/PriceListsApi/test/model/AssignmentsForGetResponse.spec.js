...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AssignmentsForGetResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.AssignmentsForGetResponse();
      });

      it('should create an instance of AssignmentsForGetResponse', function () {
        expect(instance).to.be.a(PriceLists.AssignmentsForGetResponse);
      });
