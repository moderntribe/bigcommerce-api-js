...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('Pagination1Links', function () {
      beforeEach(function () {
        instance = new PriceLists.Pagination1Links();
      });

      it('should create an instance of Pagination1Links', function () {
        expect(instance).to.be.a(PriceLists.Pagination1Links);
      });
