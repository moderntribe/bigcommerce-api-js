...
})(undefined, function (expect, PriceLists) {
  'use strict';

  var instance;

  describe('(package)', function () {
    describe('AssignmentsForGetResponseData', function () {
      beforeEach(function () {
        instance = new PriceLists.AssignmentsForGetResponseData();
      });

      it('should create an instance of AssignmentsForGetResponseData', function () {
        expect(instance).to.be.a(PriceLists.AssignmentsForGetResponseData);
      });
      ...
      it('should have the property customer_group_id (base name: "customer_group_id")', function () {
        expect(instance).to.have.property('customer_group_id');
        // expect(instance.customer_group_id).to.be(expectedValueLiteral);
      });

      it('should have the property price_list_id (base name: "price_list_id")', function () {
        expect(instance).to.have.property('price_list_id');
        // expect(instance.price_list_id).to.be(expectedValueLiteral);
      });
