...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfPriceListCollectionResponseDataItems', function () {
      beforeEach(function () {
        instance = new PriceLists.AllOfPriceListCollectionResponseDataItems();
      });

      it('should create an instance of AllOfPriceListCollectionResponseDataItems', function () {
        expect(instance).to.be.a(PriceLists.AllOfPriceListCollectionResponseDataItems);
      });
