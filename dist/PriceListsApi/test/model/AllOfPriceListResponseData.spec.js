...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfPriceListResponseData', function () {
      beforeEach(function () {
        instance = new PriceLists.AllOfPriceListResponseData();
      });

      it('should create an instance of AllOfPriceListResponseData', function () {
        expect(instance).to.be.a(PriceLists.AllOfPriceListResponseData);
      });
