...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordCollectionResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordCollectionResponse();
      });

      it('should create an instance of PriceRecordCollectionResponse', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordCollectionResponse);
      });
