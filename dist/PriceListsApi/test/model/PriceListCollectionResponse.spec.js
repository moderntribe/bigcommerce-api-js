...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListCollectionResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListCollectionResponse();
      });

      it('should create an instance of PriceListCollectionResponse', function () {
        expect(instance).to.be.a(PriceLists.PriceListCollectionResponse);
      });
