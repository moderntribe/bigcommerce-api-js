...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfPriceRecordBatchErrorSetData', function () {
      beforeEach(function () {
        instance = new PriceLists.AllOfPriceRecordBatchErrorSetData();
      });

      it('should create an instance of AllOfPriceRecordBatchErrorSetData', function () {
        expect(instance).to.be.a(PriceLists.AllOfPriceRecordBatchErrorSetData);
      });
    });
  });
});