...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordPut', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordPut();
      });

      it('should create an instance of PriceRecordPut', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordPut);
      });
    });
  });
});