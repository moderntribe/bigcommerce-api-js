...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AssignmentsForRequest', function () {
      beforeEach(function () {
        instance = new PriceLists.AssignmentsForRequest();
      });

      it('should create an instance of AssignmentsForRequest', function () {
        expect(instance).to.be.a(PriceLists.AssignmentsForRequest);
      });
