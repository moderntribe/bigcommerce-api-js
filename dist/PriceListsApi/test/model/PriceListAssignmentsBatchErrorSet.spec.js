...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListAssignmentsBatchErrorSet', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListAssignmentsBatchErrorSet();
      });

      it('should create an instance of PriceListAssignmentsBatchErrorSet', function () {
        expect(instance).to.be.a(PriceLists.PriceListAssignmentsBatchErrorSet);
      });
