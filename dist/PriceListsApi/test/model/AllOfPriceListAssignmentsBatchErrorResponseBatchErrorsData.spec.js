...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData', function () {
      beforeEach(function () {
        instance = new PriceLists.AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData();
      });

      it('should create an instance of AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData', function () {
        expect(instance).to.be.a(PriceLists.AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData);
      });
    });
  });
});