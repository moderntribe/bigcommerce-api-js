...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfPriceRecordCollectionResponseDataItems', function () {
      beforeEach(function () {
        instance = new PriceLists.AllOfPriceRecordCollectionResponseDataItems();
      });

      it('should create an instance of AllOfPriceRecordCollectionResponseDataItems', function () {
        expect(instance).to.be.a(PriceLists.AllOfPriceRecordCollectionResponseDataItems);
      });
      ...
      it('should have the property bulk_pricing_tiers (base name: "bulk_pricing_tiers")', function () {
        expect(instance).to.have.property('bulk_pricing_tiers');
        // expect(instance.bulk_pricing_tiers).to.be(expectedValueLiteral);
      });
