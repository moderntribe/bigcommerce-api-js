...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SuccessBatchResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.SuccessBatchResponse();
      });

      it('should create an instance of SuccessBatchResponse', function () {
        expect(instance).to.be.a(PriceLists.SuccessBatchResponse);
      });
    });
  });
});