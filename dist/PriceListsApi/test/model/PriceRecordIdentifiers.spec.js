...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordIdentifiers', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordIdentifiers();
      });

      it('should create an instance of PriceRecordIdentifiers', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordIdentifiers);
      });
    });
  });
});