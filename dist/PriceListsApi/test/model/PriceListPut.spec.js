...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListPut', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListPut();
      });

      it('should create an instance of PriceListPut', function () {
        expect(instance).to.be.a(PriceLists.PriceListPut);
      });
    });
  });
});