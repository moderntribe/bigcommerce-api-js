...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListPost', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListPost();
      });

      it('should create an instance of PriceListPost', function () {
        expect(instance).to.be.a(PriceLists.PriceListPost);
      });
    });
  });
});