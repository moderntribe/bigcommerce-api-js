...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AssignmentForGetResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.AssignmentForGetResponse();
      });

      it('should create an instance of AssignmentForGetResponse', function () {
        expect(instance).to.be.a(PriceLists.AssignmentForGetResponse);
      });
