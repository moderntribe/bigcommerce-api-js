...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateBatchPriceListAssignmentsRequest', function () {
      beforeEach(function () {
        instance = new PriceLists.CreateBatchPriceListAssignmentsRequest();
      });

      it('should create an instance of CreateBatchPriceListAssignmentsRequest', function () {
        expect(instance).to.be.a(PriceLists.CreateBatchPriceListAssignmentsRequest);
      });
    });
  });
});