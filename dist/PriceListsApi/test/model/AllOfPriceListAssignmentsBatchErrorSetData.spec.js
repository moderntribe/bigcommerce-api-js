...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfPriceListAssignmentsBatchErrorSetData', function () {
      beforeEach(function () {
        instance = new PriceLists.AllOfPriceListAssignmentsBatchErrorSetData();
      });

      it('should create an instance of AllOfPriceListAssignmentsBatchErrorSetData', function () {
        expect(instance).to.be.a(PriceLists.AllOfPriceListAssignmentsBatchErrorSetData);
      });
    });
  });
});