...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordResponse();
      });

      it('should create an instance of PriceRecordResponse', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordResponse);
      });
