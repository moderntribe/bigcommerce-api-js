...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListAssignmentsBatchErrorResponseBatchErrors', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListAssignmentsBatchErrorResponseBatchErrors();
      });

      it('should create an instance of PriceListAssignmentsBatchErrorResponseBatchErrors', function () {
        expect(instance).to.be.a(PriceLists.PriceListAssignmentsBatchErrorResponseBatchErrors);
      });
      ...
      it('should have the property field_errors (base name: "field_errors")', function () {
        expect(instance).to.have.property('field_errors');
        // expect(instance.field_errors).to.be(expectedValueLiteral);
      });
    });
  });
});