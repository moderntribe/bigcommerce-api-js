...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordBase', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordBase();
      });

      it('should create an instance of PriceRecordBase', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordBase);
      });
