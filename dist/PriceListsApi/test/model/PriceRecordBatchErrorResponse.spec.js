...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordBatchErrorResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordBatchErrorResponse();
      });

      it('should create an instance of PriceRecordBatchErrorResponse', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordBatchErrorResponse);
      });
