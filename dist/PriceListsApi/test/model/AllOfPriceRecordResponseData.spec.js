...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfPriceRecordResponseData', function () {
      beforeEach(function () {
        instance = new PriceLists.AllOfPriceRecordResponseData();
      });

      it('should create an instance of AllOfPriceRecordResponseData', function () {
        expect(instance).to.be.a(PriceLists.AllOfPriceRecordResponseData);
      });
