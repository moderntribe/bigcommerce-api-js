...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListAssignmentsIdentifiers', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListAssignmentsIdentifiers();
      });

      it('should create an instance of PriceListAssignmentsIdentifiers', function () {
        expect(instance).to.be.a(PriceLists.PriceListAssignmentsIdentifiers);
      });
    });
  });
});