...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordCollectionPut', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordCollectionPut();
      });

      it('should create an instance of PriceRecordCollectionPut', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordCollectionPut);
      });
    });
  });
});