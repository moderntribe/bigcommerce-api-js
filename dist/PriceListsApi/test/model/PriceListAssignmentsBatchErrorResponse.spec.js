...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListAssignmentsBatchErrorResponse', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListAssignmentsBatchErrorResponse();
      });

      it('should create an instance of PriceListAssignmentsBatchErrorResponse', function () {
        expect(instance).to.be.a(PriceLists.PriceListAssignmentsBatchErrorResponse);
      });

      it('should have the property batch_errors (base name: "batch_errors")', function () {
        expect(instance).to.have.property('batch_errors');
        // expect(instance.batch_errors).to.be(expectedValueLiteral);
      });
    });
  });
});