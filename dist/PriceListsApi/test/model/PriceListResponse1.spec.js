...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListResponse1', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListResponse1();
      });

      it('should create an instance of PriceListResponse1', function () {
        expect(instance).to.be.a(PriceLists.PriceListResponse1);
      });
