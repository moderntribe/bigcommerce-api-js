...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceRecordBatchErrorSet', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceRecordBatchErrorSet();
      });

      it('should create an instance of PriceRecordBatchErrorSet', function () {
        expect(instance).to.be.a(PriceLists.PriceRecordBatchErrorSet);
      });
