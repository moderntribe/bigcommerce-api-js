...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('BulkPricingTier', function () {
      beforeEach(function () {
        instance = new PriceLists.BulkPricingTier();
      });

      it('should create an instance of BulkPricingTier', function () {
        expect(instance).to.be.a(PriceLists.BulkPricingTier);
      });

      it('should have the property quantity_min (base name: "quantity_min")', function () {
        expect(instance).to.have.property('quantity_min');
        // expect(instance.quantity_min).to.be(expectedValueLiteral);
      });

      it('should have the property quantity_max (base name: "quantity_max")', function () {
        expect(instance).to.have.property('quantity_max');
        // expect(instance.quantity_max).to.be(expectedValueLiteral);
      });
