...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PriceListBase', function () {
      beforeEach(function () {
        instance = new PriceLists.PriceListBase();
      });

      it('should create an instance of PriceListBase', function () {
        expect(instance).to.be.a(PriceLists.PriceListBase);
      });
