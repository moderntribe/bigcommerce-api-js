...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.PriceLists);
  }
})(undefined, function (expect, PriceLists, BCApiClient, config) {
  'use strict';

  var instance;

  beforeEach(function () {
    instance = new PriceLists.PriceListsRecordsApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('PriceListsRecordsApi', function () {
      describe('deletePriceListRecord', function () {
        it('should call deletePriceListRecord successfully', _asyncToGenerator(function* () {
          // const deletePriceListRecordResponse = await instance.deletePriceListRecord();
          // expect(deletePriceListRecordResponse.ok).to.be(true);
          // expect(deletePriceListRecordResponse.body.data).to.be.an('array');
        }));
      });
      describe('deletePriceListRecordsByFilter', function () {
        it('should call deletePriceListRecordsByFilter successfully', _asyncToGenerator(function* () {
          // const deletePriceListRecordsByFilterResponse = await instance.deletePriceListRecordsByFilter();
          // expect(deletePriceListRecordsByFilterResponse.ok).to.be(true);
          // expect(deletePriceListRecordsByFilterResponse.body.data).to.be.an('array');
        }));
      });
      describe('getPriceListRecord', function () {
        it('should call getPriceListRecord successfully', _asyncToGenerator(function* () {
          // const getPriceListRecordResponse = await instance.getPriceListRecord();
          // expect(getPriceListRecordResponse.ok).to.be(true);
          // expect(getPriceListRecordResponse.body.data).to.be.an('array');
        }));
      });
      describe('getPriceListRecordCollection', function () {
        it('should call getPriceListRecordCollection successfully', _asyncToGenerator(function* () {
          // const getPriceListRecordCollectionResponse = await instance.getPriceListRecordCollection();
          // expect(getPriceListRecordCollectionResponse.ok).to.be(true);
          // expect(getPriceListRecordCollectionResponse.body.data).to.be.an('array');
        }));
      });
      describe('getPriceListRecordsByVariantId', function () {
        it('should call getPriceListRecordsByVariantId successfully', _asyncToGenerator(function* () {
          // const getPriceListRecordsByVariantIdResponse = await instance.getPriceListRecordsByVariantId();
          // expect(getPriceListRecordsByVariantIdResponse.ok).to.be(true);
          // expect(getPriceListRecordsByVariantIdResponse.body.data).to.be.an('array');
        }));
      });
      describe('setPriceListRecord', function () {
        it('should call setPriceListRecord successfully', _asyncToGenerator(function* () {
          // const setPriceListRecordResponse = await instance.setPriceListRecord();
          // expect(setPriceListRecordResponse.ok).to.be(true);
          // expect(setPriceListRecordResponse.body.data).to.be.an('array');
        }));
      });
      describe('setPriceListRecordCollection', function () {
        it('should call setPriceListRecordCollection successfully', _asyncToGenerator(function* () {
          // const setPriceListRecordCollectionResponse = await instance.setPriceListRecordCollection();
          // expect(setPriceListRecordCollectionResponse.ok).to.be(true);
          // expect(setPriceListRecordCollectionResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
