...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PriceLists.PriceListsAssignmentsApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('PriceListsAssignmentsApi', function () {
      describe('createPriceListAssignments', function () {
        it('should call createPriceListAssignments successfully', _asyncToGenerator(function* () {
          // const createPriceListAssignmentsResponse = await instance.createPriceListAssignments();
          // expect(createPriceListAssignmentsResponse.ok).to.be(true);
          // expect(createPriceListAssignmentsResponse.body.data).to.be.an('array');
        }));
      });
      describe('deletePriceListAssignmentsByFilter', function () {
        it('should call deletePriceListAssignmentsByFilter successfully', _asyncToGenerator(function* () {
          // const deletePriceListAssignmentsByFilterResponse = await instance.deletePriceListAssignmentsByFilter();
          // expect(deletePriceListAssignmentsByFilterResponse.ok).to.be(true);
          // expect(deletePriceListAssignmentsByFilterResponse.body.data).to.be.an('array');
        }));
      });
      describe('getListOfPriceListAssignments', function () {
        it('should call getListOfPriceListAssignments successfully', _asyncToGenerator(function* () {
          // const getListOfPriceListAssignmentsResponse = await instance.getListOfPriceListAssignments();
          // expect(getListOfPriceListAssignmentsResponse.ok).to.be(true);
          // expect(getListOfPriceListAssignmentsResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
