...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PriceLists.PriceListsApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('PriceListsApi', function () {
      describe('createPriceList', function () {
        it('should call createPriceList successfully', _asyncToGenerator(function* () {
          // const createPriceListResponse = await instance.createPriceList();
          // expect(createPriceListResponse.ok).to.be(true);
          // expect(createPriceListResponse.body.data).to.be.an('array');
        }));
      });
      describe('deletePriceList', function () {
        it('should call deletePriceList successfully', _asyncToGenerator(function* () {
          // const deletePriceListResponse = await instance.deletePriceList();
          // expect(deletePriceListResponse.ok).to.be(true);
          // expect(deletePriceListResponse.body.data).to.be.an('array');
        }));
      });
      describe('deletePriceListsByFilter', function () {
        it('should call deletePriceListsByFilter successfully', _asyncToGenerator(function* () {
          // const deletePriceListsByFilterResponse = await instance.deletePriceListsByFilter();
          // expect(deletePriceListsByFilterResponse.ok).to.be(true);
          // expect(deletePriceListsByFilterResponse.body.data).to.be.an('array');
        }));
      });
      describe('getPriceList', function () {
        it('should call getPriceList successfully', _asyncToGenerator(function* () {
          // const getPriceListResponse = await instance.getPriceList();
          // expect(getPriceListResponse.ok).to.be(true);
          // expect(getPriceListResponse.body.data).to.be.an('array');
        }));
      });
      describe('getPriceListCollection', function () {
        it('should call getPriceListCollection successfully', _asyncToGenerator(function* () {
          // const getPriceListCollectionResponse = await instance.getPriceListCollection();
          // expect(getPriceListCollectionResponse.ok).to.be(true);
          // expect(getPriceListCollectionResponse.body.data).to.be.an('array');
        }));
      });
      describe('updatePriceList', function () {
        it('should call updatePriceList successfully', _asyncToGenerator(function* () {
          // const updatePriceListResponse = await instance.updatePriceList();
          // expect(updatePriceListResponse.ok).to.be(true);
          // expect(updatePriceListResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
