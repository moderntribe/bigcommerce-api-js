...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('JobWarnings', function () {
      beforeEach(function () {
        instance = new Themes.JobWarnings();
      });

      it('should create an instance of JobWarnings', function () {
        expect(instance).to.be.a(Themes.JobWarnings);
      });
