...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ThemesCollectionResponse', function () {
      beforeEach(function () {
        instance = new Themes.ThemesCollectionResponse();
      });

      it('should create an instance of ThemesCollectionResponse', function () {
        expect(instance).to.be.a(Themes.ThemesCollectionResponse);
      });
