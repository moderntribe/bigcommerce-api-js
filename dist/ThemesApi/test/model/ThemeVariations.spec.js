...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ThemeVariations', function () {
      beforeEach(function () {
        instance = new Themes.ThemeVariations();
      });

      it('should create an instance of ThemeVariations', function () {
        expect(instance).to.be.a(Themes.ThemeVariations);
      });
