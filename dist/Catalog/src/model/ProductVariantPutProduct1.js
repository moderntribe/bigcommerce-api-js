...
/**
* The ProductVariantPutProduct1 model module.
* @module model/ProductVariantPutProduct1
* @version 3.0
*/
var ProductVariantPutProduct1 = function () {
    /**
    * Constructs a new <code>ProductVariantPutProduct1</code>.
    * The model for a PUT to update variants on a product. 
    * @alias module:model/ProductVariantPutProduct1
    * @class
    */

    function ProductVariantPutProduct1() {
        _classCallCheck(this, ProductVariantPutProduct1);
    ...
    /**
    * Constructs a <code>ProductVariantPutProduct1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProductVariantPutProduct1} obj Optional instance to populate.
    * @return {module:model/ProductVariantPutProduct1} The populated <code>ProductVariantPutProduct1</code> instance.
    */


    _createClass(ProductVariantPutProduct1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductVariantPutProduct1();
    ...
    return ProductVariantPutProduct1;
}();

exports.default = ProductVariantPutProduct1;