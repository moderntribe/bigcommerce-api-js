...
var _ProductOptionBase = require('./ProductOptionBase1');
...
var ProductFull = function () {
    ...
    */
    ...
    function ProductFull() {
        _classCallCheck(this, ProductFull);
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('options')) {
                    obj['options'] = _ApiClient2.default.convertToType(data['options'], [_ProductOptionBase2.default]);
                }
