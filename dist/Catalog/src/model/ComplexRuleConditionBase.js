...
* @version 3.0
*/
var ComplexRuleConditionBase = function () {
    /**
    ...
    */
    ...
    function ComplexRuleConditionBase(modifierId, modifierValueId, variantId) {
        _classCallCheck(this, ComplexRuleConditionBase);

        this['id'] = undefined;
        this['rule_id'] = undefined;
        this['modifier_id'] = undefined;
        this['modifier_value_id'] = undefined;
        this['variant_id'] = undefined;
        this['combination_id'] = undefined;
    ...
    */
    ...
    _createClass(ComplexRuleConditionBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ComplexRuleConditionBase();

                if (data.hasOwnProperty('id')) {
                    obj['id'] = _ApiClient2.default.convertToType(data['id'], 'Number');
                }
                if (data.hasOwnProperty('rule_id')) {
                    obj['rule_id'] = _ApiClient2.default.convertToType(data['rule_id'], 'Number');
                }
                if (data.hasOwnProperty('modifier_id')) {
                    obj['modifier_id'] = _ApiClient2.default.convertToType(data['modifier_id'], 'Number');
                }
                if (data.hasOwnProperty('modifier_value_id')) {
                    obj['modifier_value_id'] = _ApiClient2.default.convertToType(data['modifier_value_id'], 'Number');
                }
                ...
                if (data.hasOwnProperty('combination_id')) {
                    obj['combination_id'] = _ApiClient2.default.convertToType(data['combination_id'], 'Number');
                }
            }
            return obj;
        }
    ...
    return ComplexRuleConditionBase;
}();

exports.default = ComplexRuleConditionBase;