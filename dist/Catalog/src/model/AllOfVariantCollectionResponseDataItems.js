...
/**
* The AllOfVariantCollectionResponseDataItems model module.
* @module model/AllOfVariantCollectionResponseDataItems
* @version 3.0
*/
var AllOfVariantCollectionResponseDataItems = function () {
    /**
    * Constructs a new <code>AllOfVariantCollectionResponseDataItems</code>.
    * @alias module:model/AllOfVariantCollectionResponseDataItems
    * @class
    */

    function AllOfVariantCollectionResponseDataItems() {
        _classCallCheck(this, AllOfVariantCollectionResponseDataItems);
    ...
    /**
    * Constructs a <code>AllOfVariantCollectionResponseDataItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfVariantCollectionResponseDataItems} obj Optional instance to populate.
    * @return {module:model/AllOfVariantCollectionResponseDataItems} The populated <code>AllOfVariantCollectionResponseDataItems</code> instance.
    */


    _createClass(AllOfVariantCollectionResponseDataItems, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfVariantCollectionResponseDataItems();
    ...
    return AllOfVariantCollectionResponseDataItems;
}();

exports.default = AllOfVariantCollectionResponseDataItems;