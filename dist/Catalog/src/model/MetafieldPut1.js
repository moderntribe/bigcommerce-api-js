...
/**
* The MetafieldPut1 model module.
* @module model/MetafieldPut1
* @version 3.0
*/
var MetafieldPut1 = function () {
    /**
    * Constructs a new <code>MetafieldPut1</code>.
    * Properties for updating metafields.
    * @alias module:model/MetafieldPut1
    * @class
    ...
    */
    ...
    function MetafieldPut1(permissionSet, namespace, key, value) {
        _classCallCheck(this, MetafieldPut1);
    ...
    /**
    * Constructs a <code>MetafieldPut1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MetafieldPut1} obj Optional instance to populate.
    * @return {module:model/MetafieldPut1} The populated <code>MetafieldPut1</code> instance.
    */


    _createClass(MetafieldPut1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new MetafieldPut1();
        ...
        * @member {module:model/MetafieldPut1.PermissionSetEnum} permission_set
        */
        ...
        * @member {module:model/MetafieldPut1.ResourceTypeEnum} resource_type
        */
    ...
    return MetafieldPut1;
}();

MetafieldPut1.PermissionSetEnum = {
    /**
     * value: "app_only"
     * @const
     */
...
MetafieldPut1.ResourceTypeEnum = {
    /**
     * value: "category"
     * @const
     */
