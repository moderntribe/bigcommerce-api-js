...
/**
* The BulkPricingRuleFull2 model module.
* @module model/BulkPricingRuleFull2
* @version 3.0
*/
var BulkPricingRuleFull2 = function () {
    /**
    * Constructs a new <code>BulkPricingRuleFull2</code>.
    * Common Bulk Pricing Rule properties
    * @alias module:model/BulkPricingRuleFull2
    * @class
    ...
    * @param type {module:model/BulkPricingRuleFull2.TypeEnum} The type of adjustment that is made. Values: `price` - the adjustment amount per product; `percent` - the adjustment as a percentage of the original price; `fixed` - the adjusted absolute price of the product. Required in /POST.
    ...
    */
    ...
    function BulkPricingRuleFull2(quantityMin, quantityMax, type, amount) {
        _classCallCheck(this, BulkPricingRuleFull2);
    ...
    /**
    * Constructs a <code>BulkPricingRuleFull2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BulkPricingRuleFull2} obj Optional instance to populate.
    * @return {module:model/BulkPricingRuleFull2} The populated <code>BulkPricingRuleFull2</code> instance.
    */


    _createClass(BulkPricingRuleFull2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BulkPricingRuleFull2();
        ...
        * @member {module:model/BulkPricingRuleFull2.TypeEnum} type
        */
    ...
    return BulkPricingRuleFull2;
}();

BulkPricingRuleFull2.TypeEnum = {
    /**
     * value: "price"
     * @const
     */
     ...
     */
    "fixed": "fixed" };
exports.default = BulkPricingRuleFull2;