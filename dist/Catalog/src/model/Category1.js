...
/**
* The Category1 model module.
* @module model/Category1
* @version 3.0
*/
var Category1 = function () {
    /**
    * Constructs a new <code>Category1</code>.
    * Common Category object properties.
    * @alias module:model/Category1
    * @class
    ...
    */
    ...
    function Category1(parentId, name) {
        _classCallCheck(this, Category1);
    ...
    /**
    * Constructs a <code>Category1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Category1} obj Optional instance to populate.
    * @return {module:model/Category1} The populated <code>Category1</code> instance.
    */


    _createClass(Category1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new Category1();
        ...
        * @member {module:model/Category1.DefaultProductSortEnum} default_product_sort
        */
...
Category1.DefaultProductSortEnum = {
    /**
