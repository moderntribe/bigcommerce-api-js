...
* @version 3.0
*/
var ProductModifierBase = function () {
  /**
  ...
  */
  ...
  function ProductModifierBase(type, required) {
    _classCallCheck(this, ProductModifierBase);
  ...
  */
  ...
  _createClass(ProductModifierBase, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('required')) {
          obj['required'] = _ApiClient2.default.convertToType(data['required'], 'Boolean');
        }
  ...
  return ProductModifierBase;
}();

ProductModifierBase.TypeEnum = {
  /**
   * value: "date"
   * @const
   */
   ...
   */
  "swatch": "swatch" };
exports.default = ProductModifierBase;