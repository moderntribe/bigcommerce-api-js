...
/**
* The BulkPricingRuleFull3 model module.
* @module model/BulkPricingRuleFull3
* @version 3.0
*/
var BulkPricingRuleFull3 = function () {
    /**
    * Constructs a new <code>BulkPricingRuleFull3</code>.
    * Common Bulk Pricing Rule properties
    * @alias module:model/BulkPricingRuleFull3
    * @class
    ...
    * @param type {module:model/BulkPricingRuleFull3.TypeEnum} The type of adjustment that is made. Values: `price` - the adjustment amount per product; `percent` - the adjustment as a percentage of the original price; `fixed` - the adjusted absolute price of the product. Required in /POST.
    ...
    */
    ...
    function BulkPricingRuleFull3(quantityMin, quantityMax, type, amount) {
        _classCallCheck(this, BulkPricingRuleFull3);
    ...
    /**
    * Constructs a <code>BulkPricingRuleFull3</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BulkPricingRuleFull3} obj Optional instance to populate.
    * @return {module:model/BulkPricingRuleFull3} The populated <code>BulkPricingRuleFull3</code> instance.
    */


    _createClass(BulkPricingRuleFull3, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BulkPricingRuleFull3();
        ...
        * @member {module:model/BulkPricingRuleFull3.TypeEnum} type
        */
    ...
    return BulkPricingRuleFull3;
}();

BulkPricingRuleFull3.TypeEnum = {
    /**
     * value: "price"
     * @const
     */
     ...
     */
    "fixed": "fixed" };
exports.default = BulkPricingRuleFull3;