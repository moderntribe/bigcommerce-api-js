...
var _OptionConfig = require('./OptionConfig');
...
/**
* The ProductOptionBase1 model module.
* @module model/ProductOptionBase1
* @version 3.0
*/
var ProductOptionBase1 = function () {
    /**
    * Constructs a new <code>ProductOptionBase1</code>.
    * Common Option properties.
    * @alias module:model/ProductOptionBase1
    * @class
    */

    function ProductOptionBase1() {
        _classCallCheck(this, ProductOptionBase1);
    ...
    /**
    * Constructs a <code>ProductOptionBase1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProductOptionBase1} obj Optional instance to populate.
    * @return {module:model/ProductOptionBase1} The populated <code>ProductOptionBase1</code> instance.
    */


    _createClass(ProductOptionBase1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductOptionBase1();
                ...
                if (data.hasOwnProperty('config')) {
                    obj['config'] = _OptionConfig2.default.constructFromObject(data['config']);
                }
        ...
        * @member {module:model/ProductOptionBase1.TypeEnum} type
        */
    ...
    return ProductOptionBase1;
}();

ProductOptionBase1.TypeEnum = {
    /**
     * value: "radio_buttons"
     * @const
     */
     ...
     */
    "swatch": "swatch" };
exports.default = ProductOptionBase1;