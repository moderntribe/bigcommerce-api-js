...
/**
* The ProductImageFull model module.
* @module model/ProductImageFull
* @version 3.0
*/
var ProductImageFull = function () {
    /**
    * Constructs a new <code>ProductImageFull</code>.
    * Common ProductImage properties.
    * @alias module:model/ProductImageFull
    * @class
    */

    function ProductImageFull() {
        _classCallCheck(this, ProductImageFull);
    ...
    /**
    * Constructs a <code>ProductImageFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProductImageFull} obj Optional instance to populate.
    * @return {module:model/ProductImageFull} The populated <code>ProductImageFull</code> instance.
    */


    _createClass(ProductImageFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductImageFull();
...
exports.default = ProductImageFull;