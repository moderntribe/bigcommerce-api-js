...
var ProductImageBase = function () {
    ...
    */
    ...
    function ProductImageBase() {
        _classCallCheck(this, ProductImageBase);

        this['image_file'] = undefined;
        this['is_thumbnail'] = undefined;
    ...
    */
    ...
    _createClass(ProductImageBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductImageBase();

                if (data.hasOwnProperty('image_file')) {
                    obj['image_file'] = _ApiClient2.default.convertToType(data['image_file'], 'String');
                }
                if (data.hasOwnProperty('is_thumbnail')) {
                    obj['is_thumbnail'] = _ApiClient2.default.convertToType(data['is_thumbnail'], 'Boolean');
                }
...
exports.default = ProductImageBase;