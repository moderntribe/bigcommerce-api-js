...
/**
* The CategoryFull1 model module.
* @module model/CategoryFull1
* @version 3.0
*/
var CategoryFull1 = function () {
    /**
    * Constructs a new <code>CategoryFull1</code>.
    * Common Category object properties.
    * @alias module:model/CategoryFull1
    * @class
    ...
    */
    ...
    function CategoryFull1(parentId, name) {
        _classCallCheck(this, CategoryFull1);
    ...
    /**
    * Constructs a <code>CategoryFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CategoryFull1} obj Optional instance to populate.
    * @return {module:model/CategoryFull1} The populated <code>CategoryFull1</code> instance.
    */


    _createClass(CategoryFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CategoryFull1();
        ...
        * @member {module:model/CategoryFull1.DefaultProductSortEnum} default_product_sort
        */
    ...
    return CategoryFull1;
}();

CategoryFull1.DefaultProductSortEnum = {
    /**
