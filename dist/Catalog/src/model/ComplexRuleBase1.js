...
/**
* The ComplexRuleBase1 model module.
* @module model/ComplexRuleBase1
* @version 3.0
*/
var ComplexRuleBase1 = function () {
    /**
    * Constructs a new <code>ComplexRuleBase1</code>.
    * Common ComplexRule properties.
    * @alias module:model/ComplexRuleBase1
    * @class
    */

    function ComplexRuleBase1() {
        _classCallCheck(this, ComplexRuleBase1);
    ...
    /**
    * Constructs a <code>ComplexRuleBase1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ComplexRuleBase1} obj Optional instance to populate.
    * @return {module:model/ComplexRuleBase1} The populated <code>ComplexRuleBase1</code> instance.
    */


    _createClass(ComplexRuleBase1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ComplexRuleBase1();
    ...
    return ComplexRuleBase1;
}();

exports.default = ComplexRuleBase1;