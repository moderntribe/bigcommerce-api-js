...
/**
* The MetafieldPut2 model module.
* @module model/MetafieldPut2
* @version 3.0
*/
var MetafieldPut2 = function () {
    /**
    * Constructs a new <code>MetafieldPut2</code>.
    * Properties for updating metafields.
    * @alias module:model/MetafieldPut2
    * @class
    ...
    */
    ...
    function MetafieldPut2(permissionSet, namespace, key, value) {
        _classCallCheck(this, MetafieldPut2);
    ...
    /**
    * Constructs a <code>MetafieldPut2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MetafieldPut2} obj Optional instance to populate.
    * @return {module:model/MetafieldPut2} The populated <code>MetafieldPut2</code> instance.
    */


    _createClass(MetafieldPut2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new MetafieldPut2();
        ...
        * @member {module:model/MetafieldPut2.PermissionSetEnum} permission_set
        */
        ...
        * @member {module:model/MetafieldPut2.ResourceTypeEnum} resource_type
        */
    ...
    return MetafieldPut2;
}();

MetafieldPut2.PermissionSetEnum = {
    /**
     * value: "app_only"
     * @const
     */
...
MetafieldPut2.ResourceTypeEnum = {
    /**
     * value: "category"
     * @const
     */
