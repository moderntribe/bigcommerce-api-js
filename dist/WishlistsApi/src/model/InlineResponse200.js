...
var _MetaCollection = require('./MetaCollection1');
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], [_WishlistFull2.default]);
                }
                if (data.hasOwnProperty('meta')) {
                    obj['meta'] = _MetaCollection2.default.constructFromObject(data['meta']);
                }
            }
            return obj;
        }
