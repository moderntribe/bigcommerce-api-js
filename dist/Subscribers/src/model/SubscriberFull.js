...
/**
* The SubscriberFull model module.
* @module model/SubscriberFull
* @version 3.0
*/
var SubscriberFull = function () {
    /**
    * Constructs a new <code>SubscriberFull</code>.
    * Full subscriber object returned in responses.
    * @alias module:model/SubscriberFull
    * @class
    */

    function SubscriberFull() {
        _classCallCheck(this, SubscriberFull);
    ...
    /**
    * Constructs a <code>SubscriberFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/SubscriberFull} obj Optional instance to populate.
    * @return {module:model/SubscriberFull} The populated <code>SubscriberFull</code> instance.
    */


    _createClass(SubscriberFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new SubscriberFull();
    ...
    return SubscriberFull;
}();

exports.default = SubscriberFull;