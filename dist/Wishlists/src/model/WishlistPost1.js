...
/**
* The WishlistPost1 model module.
* @module model/WishlistPost1
* @version 3.0
*/
var WishlistPost1 = function () {
    /**
    * Constructs a new <code>WishlistPost1</code>.
    * @alias module:model/WishlistPost1
    * @class
    * @param customerId {Number} The customer id.
    */

    function WishlistPost1(customerId) {
        _classCallCheck(this, WishlistPost1);
    ...
    /**
    * Constructs a <code>WishlistPost1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/WishlistPost1} obj Optional instance to populate.
    * @return {module:model/WishlistPost1} The populated <code>WishlistPost1</code> instance.
    */


    _createClass(WishlistPost1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new WishlistPost1();
    ...
    return WishlistPost1;
}();

exports.default = WishlistPost1;