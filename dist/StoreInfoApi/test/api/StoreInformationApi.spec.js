...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new StoreInformation.StoreInformationApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('StoreInformationApi', function () {
      describe('storeGet', function () {
        it('should call storeGet successfully', _asyncToGenerator(function* () {
          // const storeGetResponse = await instance.storeGet();
          // expect(storeGetResponse.ok).to.be(true);
          // expect(storeGetResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
