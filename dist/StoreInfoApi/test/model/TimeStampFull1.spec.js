...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('TimeStampFull1', function () {
      beforeEach(function () {
        instance = new StoreInformation.TimeStampFull1();
      });

      it('should create an instance of TimeStampFull1', function () {
        expect(instance).to.be.a(StoreInformation.TimeStampFull1);
      });
