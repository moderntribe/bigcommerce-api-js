...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('TimeStampFull', function () {
      beforeEach(function () {
        instance = new StoreInformation.TimeStampFull();
      });

      it('should create an instance of TimeStampFull', function () {
        expect(instance).to.be.a(StoreInformation.TimeStampFull);
      });
