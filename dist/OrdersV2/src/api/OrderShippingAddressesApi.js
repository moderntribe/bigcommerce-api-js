...
var _ShippingAddressBase = require('../model/ShippingAddressBase2');
...
var OrderShippingAddressesApi = function () {
  ...
  */
  ...
  _createClass(OrderShippingAddressesApi, [{
    ...
    key: 'updateAShippingAddress',
    value: function updateAShippingAddress(orderId, id, accept, contentType, opts, callback) {
      opts = opts || {};
      ...
      return this.apiClient.callApi('/orders/{order_id}/shipping_addresses/{id}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
  }]);
