...
/**
* The OrderPost1 model module.
* @module model/OrderPost1
* @version 2.0
*/
var OrderPost1 = function () {
    /**
    * Constructs a new <code>OrderPost1</code>.
    * Products and Billing address only required for POST operation.
    * @alias module:model/OrderPost1
    * @class
    * @param billingAddress {} Required to create an order.
    * @param products {} 
    */

    function OrderPost1(billingAddress, products) {
        _classCallCheck(this, OrderPost1);
    ...
    /**
    * Constructs a <code>OrderPost1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderPost1} obj Optional instance to populate.
    * @return {module:model/OrderPost1} The populated <code>OrderPost1</code> instance.
    */


    _createClass(OrderPost1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderPost1();
