...
/**
* The OrdersCountFull model module.
* @module model/OrdersCountFull
* @version 2.0
*/
var OrdersCountFull = function () {
    /**
    * Constructs a new <code>OrdersCountFull</code>.
    * @alias module:model/OrdersCountFull
    * @class
    */

    function OrdersCountFull() {
        _classCallCheck(this, OrdersCountFull);
    ...
    /**
    * Constructs a <code>OrdersCountFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrdersCountFull} obj Optional instance to populate.
    * @return {module:model/OrdersCountFull} The populated <code>OrdersCountFull</code> instance.
    */


    _createClass(OrdersCountFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrdersCountFull();
    ...
    return OrdersCountFull;
}();

exports.default = OrdersCountFull;