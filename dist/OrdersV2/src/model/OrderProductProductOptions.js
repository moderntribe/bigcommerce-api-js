...
/**
* The OrderProductProductOptions model module.
* @module model/OrderProductProductOptions
* @version 2.0
*/
var OrderProductProductOptions = function () {
    /**
    * Constructs a new <code>OrderProductProductOptions</code>.
    * @alias module:model/OrderProductProductOptions
    * @class
    */

    function OrderProductProductOptions() {
        _classCallCheck(this, OrderProductProductOptions);
    ...
    /**
    * Constructs a <code>OrderProductProductOptions</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderProductProductOptions} obj Optional instance to populate.
    * @return {module:model/OrderProductProductOptions} The populated <code>OrderProductProductOptions</code> instance.
    */


    _createClass(OrderProductProductOptions, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderProductProductOptions();
    ...
    return OrderProductProductOptions;
}();

exports.default = OrderProductProductOptions;