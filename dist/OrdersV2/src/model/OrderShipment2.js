...
/**
* The OrderShipment2 model module.
* @module model/OrderShipment2
* @version 2.0
*/
var OrderShipment2 = function () {
    /**
    * Constructs a new <code>OrderShipment2</code>.
    * @alias module:model/OrderShipment2
    * @class
    */

    function OrderShipment2() {
        _classCallCheck(this, OrderShipment2);
    ...
    /**
    * Constructs a <code>OrderShipment2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderShipment2} obj Optional instance to populate.
    * @return {module:model/OrderShipment2} The populated <code>OrderShipment2</code> instance.
    */


    _createClass(OrderShipment2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderShipment2();
        ...
        * @member {module:model/OrderShipment2.ShippingProviderEnum} shipping_provider
        */
    ...
    return OrderShipment2;
}();

OrderShipment2.ShippingProviderEnum = {
    /**
     * value: "auspost"
     * @const
     */
     ...
     */
    " ": " " };
exports.default = OrderShipment2;