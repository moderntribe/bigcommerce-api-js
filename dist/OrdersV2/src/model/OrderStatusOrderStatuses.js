...
/**
* The OrderStatusOrderStatuses model module.
* @module model/OrderStatusOrderStatuses
* @version 2.0
*/
var OrderStatusOrderStatuses = function () {
    /**
    * Constructs a new <code>OrderStatusOrderStatuses</code>.
    * @alias module:model/OrderStatusOrderStatuses
    * @class
    */

    function OrderStatusOrderStatuses() {
        _classCallCheck(this, OrderStatusOrderStatuses);

        this['order'] = undefined;
    }

    /**
    * Constructs a <code>OrderStatusOrderStatuses</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderStatusOrderStatuses} obj Optional instance to populate.
    * @return {module:model/OrderStatusOrderStatuses} The populated <code>OrderStatusOrderStatuses</code> instance.
    */


    _createClass(OrderStatusOrderStatuses, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderStatusOrderStatuses();
    ...
    return OrderStatusOrderStatuses;
}();

exports.default = OrderStatusOrderStatuses;