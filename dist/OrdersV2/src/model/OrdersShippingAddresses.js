...
/**
* The OrdersShippingAddresses model module.
* @module model/OrdersShippingAddresses
* @version 2.0
*/
var OrdersShippingAddresses = function () {
    /**
    * Constructs a new <code>OrdersShippingAddresses</code>.
    * @alias module:model/OrdersShippingAddresses
    * @class
    */

    function OrdersShippingAddresses() {
        _classCallCheck(this, OrdersShippingAddresses);
    ...
    /**
    * Constructs a <code>OrdersShippingAddresses</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrdersShippingAddresses} obj Optional instance to populate.
    * @return {module:model/OrdersShippingAddresses} The populated <code>OrdersShippingAddresses</code> instance.
    */


    _createClass(OrdersShippingAddresses, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrdersShippingAddresses();
    ...
    return OrdersShippingAddresses;
}();

exports.default = OrdersShippingAddresses;