...
/**
* The ProductsResource model module.
* @module model/ProductsResource
* @version 2.0
*/
var ProductsResource = function () {
    /**
    * Constructs a new <code>ProductsResource</code>.
    * @alias module:model/ProductsResource
    * @class
    */

    function ProductsResource() {
        _classCallCheck(this, ProductsResource);
    ...
    /**
    * Constructs a <code>ProductsResource</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProductsResource} obj Optional instance to populate.
    * @return {module:model/ProductsResource} The populated <code>ProductsResource</code> instance.
    */


    _createClass(ProductsResource, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ProductsResource();
...
exports.default = ProductsResource;