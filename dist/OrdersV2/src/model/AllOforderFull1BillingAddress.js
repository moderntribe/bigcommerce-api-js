...
/**
* The AllOforderFull1BillingAddress model module.
* @module model/AllOforderFull1BillingAddress
* @version 2.0
*/
var AllOforderFull1BillingAddress = function () {
    /**
    * Constructs a new <code>AllOforderFull1BillingAddress</code>.
    * Required to create an order.
    * @alias module:model/AllOforderFull1BillingAddress
    * @class
    */

    function AllOforderFull1BillingAddress() {
        _classCallCheck(this, AllOforderFull1BillingAddress);

        this['form_fields'] = undefined;
    }

    /**
    * Constructs a <code>AllOforderFull1BillingAddress</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOforderFull1BillingAddress} obj Optional instance to populate.
    * @return {module:model/AllOforderFull1BillingAddress} The populated <code>AllOforderFull1BillingAddress</code> instance.
    */


    _createClass(AllOforderFull1BillingAddress, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOforderFull1BillingAddress();

                if (data.hasOwnProperty('form_fields')) {
                    obj['form_fields'] = _ApiClient2.default.convertToType(data['form_fields'], [Object]);
                }
            }
            return obj;
        }
    ...
    return AllOforderFull1BillingAddress;
}();

exports.default = AllOforderFull1BillingAddress;