...
/**
* The OrderCount model module.
* @module model/OrderCount
* @version 2.0
*/
var OrderCount = function () {
    /**
    * Constructs a new <code>OrderCount</code>.
    * @alias module:model/OrderCount
    * @class
    */

    function OrderCount() {
        _classCallCheck(this, OrderCount);

        this['count'] = undefined;
    }

    /**
    * Constructs a <code>OrderCount</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderCount} obj Optional instance to populate.
    * @return {module:model/OrderCount} The populated <code>OrderCount</code> instance.
    */


    _createClass(OrderCount, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderCount();
