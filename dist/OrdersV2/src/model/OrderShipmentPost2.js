...
/**
* The OrderShipmentPost2 model module.
* @module model/OrderShipmentPost2
* @version 2.0
*/
var OrderShipmentPost2 = function () {
    /**
    * Constructs a new <code>OrderShipmentPost2</code>.
    * @alias module:model/OrderShipmentPost2
    * @class
    */

    function OrderShipmentPost2() {
        _classCallCheck(this, OrderShipmentPost2);
    ...
    /**
    * Constructs a <code>OrderShipmentPost2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderShipmentPost2} obj Optional instance to populate.
    * @return {module:model/OrderShipmentPost2} The populated <code>OrderShipmentPost2</code> instance.
    */


    _createClass(OrderShipmentPost2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderShipmentPost2();
        ...
        * @member {module:model/OrderShipmentPost2.ShippingProviderEnum} shipping_provider
        */
    ...
    return OrderShipmentPost2;
}();

OrderShipmentPost2.ShippingProviderEnum = {
    /**
     * value: "auspost"
     * @const
     */
     ...
     */
    "shipperhq": "shipperhq" };
exports.default = OrderShipmentPost2;