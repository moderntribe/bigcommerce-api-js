...
/**
* The OrderCustomProduct model module.
* @module model/OrderCustomProduct
* @version 2.0
*/
var OrderCustomProduct = function () {
    /**
    * Constructs a new <code>OrderCustomProduct</code>.
    * @alias module:model/OrderCustomProduct
    * @class
    * @param name {String} 
    * @param quantity {Number} 
    * @param priceExTax {Number} 
    * @param priceIncTax {Number} 
    */

    function OrderCustomProduct(name, quantity, priceExTax, priceIncTax) {
        _classCallCheck(this, OrderCustomProduct);
        ...
        this['price_ex_tax'] = priceExTax;
        this['price_inc_tax'] = priceIncTax;
    }

    /**
    * Constructs a <code>OrderCustomProduct</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderCustomProduct} obj Optional instance to populate.
    * @return {module:model/OrderCustomProduct} The populated <code>OrderCustomProduct</code> instance.
    */


    _createClass(OrderCustomProduct, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderCustomProduct();
...
exports.default = OrderCustomProduct;