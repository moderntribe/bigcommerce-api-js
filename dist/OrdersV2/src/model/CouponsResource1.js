...
/**
* The CouponsResource1 model module.
* @module model/CouponsResource1
* @version 2.0
*/
var CouponsResource1 = function () {
    /**
    * Constructs a new <code>CouponsResource1</code>.
    * @alias module:model/CouponsResource1
    * @class
    */

    function CouponsResource1() {
        _classCallCheck(this, CouponsResource1);
    ...
    /**
    * Constructs a <code>CouponsResource1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CouponsResource1} obj Optional instance to populate.
    * @return {module:model/CouponsResource1} The populated <code>CouponsResource1</code> instance.
    */


    _createClass(CouponsResource1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CouponsResource1();
    ...
    return CouponsResource1;
}();

exports.default = CouponsResource1;