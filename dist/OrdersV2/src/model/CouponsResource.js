...
/**
* The CouponsResource model module.
* @module model/CouponsResource
* @version 2.0
*/
var CouponsResource = function () {
    /**
    * Constructs a new <code>CouponsResource</code>.
    * @alias module:model/CouponsResource
    * @class
    */

    function CouponsResource() {
        _classCallCheck(this, CouponsResource);
    ...
    /**
    * Constructs a <code>CouponsResource</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CouponsResource} obj Optional instance to populate.
    * @return {module:model/CouponsResource} The populated <code>CouponsResource</code> instance.
    */


    _createClass(CouponsResource, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CouponsResource();
