...
/**
* The OrderFull2 model module.
* @module model/OrderFull2
* @version 2.0
*/
var OrderFull2 = function () {
    /**
    * Constructs a new <code>OrderFull2</code>.
    * @alias module:model/OrderFull2
    * @class
    */

    function OrderFull2() {
        _classCallCheck(this, OrderFull2);
    ...
    /**
    * Constructs a <code>OrderFull2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrderFull2} obj Optional instance to populate.
    * @return {module:model/OrderFull2} The populated <code>OrderFull2</code> instance.
    */


    _createClass(OrderFull2, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new OrderFull2();
        ...
        * @member {module:model/OrderFull2.TaxProviderIdEnum} tax_provider_id
        */
