...
/**
* The ShippingQuotesResource1 model module.
* @module model/ShippingQuotesResource1
* @version 2.0
*/
var ShippingQuotesResource1 = function () {
    /**
    * Constructs a new <code>ShippingQuotesResource1</code>.
    * @alias module:model/ShippingQuotesResource1
    * @class
    */

    function ShippingQuotesResource1() {
        _classCallCheck(this, ShippingQuotesResource1);
    ...
    /**
    * Constructs a <code>ShippingQuotesResource1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ShippingQuotesResource1} obj Optional instance to populate.
    * @return {module:model/ShippingQuotesResource1} The populated <code>ShippingQuotesResource1</code> instance.
    */


    _createClass(ShippingQuotesResource1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ShippingQuotesResource1();
    ...
    return ShippingQuotesResource1;
}();

exports.default = ShippingQuotesResource1;