...
/**
* The ShippingQuotesBase model module.
* @module model/ShippingQuotesBase
* @version 2.0
*/
var ShippingQuotesBase = function () {
    /**
    * Constructs a new <code>ShippingQuotesBase</code>.
    * @alias module:model/ShippingQuotesBase
    * @class
    */

    function ShippingQuotesBase() {
        _classCallCheck(this, ShippingQuotesBase);
    ...
    /**
    * Constructs a <code>ShippingQuotesBase</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ShippingQuotesBase} obj Optional instance to populate.
    * @return {module:model/ShippingQuotesBase} The populated <code>ShippingQuotesBase</code> instance.
    */


    _createClass(ShippingQuotesBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ShippingQuotesBase();
    ...
    return ShippingQuotesBase;
}();

exports.default = ShippingQuotesBase;