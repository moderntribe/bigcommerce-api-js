...
/**
* The BillingAddressBase1 model module.
* @module model/BillingAddressBase1
* @version 2.0
*/
var BillingAddressBase1 = function () {
    /**
    * Constructs a new <code>BillingAddressBase1</code>.
    * @alias module:model/BillingAddressBase1
    * @class
    */

    function BillingAddressBase1() {
        _classCallCheck(this, BillingAddressBase1);
    ...
    /**
    * Constructs a <code>BillingAddressBase1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/BillingAddressBase1} obj Optional instance to populate.
    * @return {module:model/BillingAddressBase1} The populated <code>BillingAddressBase1</code> instance.
    */


    _createClass(BillingAddressBase1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new BillingAddressBase1();
    ...
    return BillingAddressBase1;
}();

exports.default = BillingAddressBase1;