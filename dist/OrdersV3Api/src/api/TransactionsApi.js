...
var TransactionsApi = function () {
  ...
  */
   ...
   * @param {module:model/Meta1} data The data returned by the service call.
   ...
   * data is of type: {@link module:model/Meta1}
   */


  _createClass(TransactionsApi, [{
    key: 'getTransactions',
    value: function getTransactions(orderId, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      var returnType = _Meta2.default;

      return this.apiClient.callApi('/orders/{order_id}/transactions', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
  }]);
