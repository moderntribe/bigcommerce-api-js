...
/**
* The StatusUpdateFull model module.
* @module model/StatusUpdateFull
* @version 3.0
*/
var StatusUpdateFull = function () {
    /**
    * Constructs a new <code>StatusUpdateFull</code>.
    * @alias module:model/StatusUpdateFull
    * @class
    */

    function StatusUpdateFull() {
        _classCallCheck(this, StatusUpdateFull);
    ...
    /**
    * Constructs a <code>StatusUpdateFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/StatusUpdateFull} obj Optional instance to populate.
    * @return {module:model/StatusUpdateFull} The populated <code>StatusUpdateFull</code> instance.
    */


    _createClass(StatusUpdateFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new StatusUpdateFull();
        ...
        * @member {module:model/StatusUpdateFull.NewStatusEnum} new_status
        */
    ...
    return StatusUpdateFull;
}();

StatusUpdateFull.NewStatusEnum = {
    /**
     * value: "CLOSED"
     * @const
     */
     ...
     */
    "REMOVED": "REMOVED" };
exports.default = StatusUpdateFull;