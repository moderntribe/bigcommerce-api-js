...
/**
* The MetaRefund model module.
* @module model/MetaRefund
* @version 3.0
*/
var MetaRefund = function () {
    /**
    * Constructs a new <code>MetaRefund</code>.
    * Describes refund failures, success and totals.
    * @alias module:model/MetaRefund
    * @class
    */

    function MetaRefund() {
        _classCallCheck(this, MetaRefund);
    ...
    /**
    * Constructs a <code>MetaRefund</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MetaRefund} obj Optional instance to populate.
    * @return {module:model/MetaRefund} The populated <code>MetaRefund</code> instance.
    */


    _createClass(MetaRefund, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new MetaRefund();

                if (data.hasOwnProperty('failure')) {
                    obj['failure'] = _ApiClient2.default.convertToType(data['failure'], 'Number');
                }
