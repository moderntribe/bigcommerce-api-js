...
var _UpdateReturnStatusesInner = require('./UpdateReturnStatusesInner');
...
/**
* The UpdateReturnStatuses model module.
* @module model/UpdateReturnStatuses
* @version 3.0
*/
var UpdateReturnStatuses = function (_extendableBuiltin2) {
    _inherits(UpdateReturnStatuses, _extendableBuiltin2);

    /**
    * Constructs a new <code>UpdateReturnStatuses</code>.
    * @alias module:model/UpdateReturnStatuses
    * @class
    * @extends Array
    */
    ...
    function UpdateReturnStatuses() {
        ...
        _classCallCheck(this, UpdateReturnStatuses);

        var _this = _possibleConstructorReturn(this, (UpdateReturnStatuses.__proto__ || Object.getPrototypeOf(UpdateReturnStatuses)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>UpdateReturnStatuses</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UpdateReturnStatuses} obj Optional instance to populate.
    * @return {module:model/UpdateReturnStatuses} The populated <code>UpdateReturnStatuses</code> instance.
    */


    _createClass(UpdateReturnStatuses, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new UpdateReturnStatuses();
                _ApiClient2.default.constructFromObject(data, obj, 'UpdateReturnStatusesInner');
            }
            return obj;
        }
    }]);

    return UpdateReturnStatuses;
}(_extendableBuiltin(Array));

exports.default = UpdateReturnStatuses;