...
* @version 3.0
*/
var ReceivedItemsPutInner = function () {
    /**
    ...
    */
    ...
    function ReceivedItemsPutInner(itemId, receivedQuantity, pendingQuantity) {
        _classCallCheck(this, ReceivedItemsPutInner);

        this['item_id'] = undefined;
        this['received_quantity'] = undefined;
    ...
    */
    ...
    _createClass(ReceivedItemsPutInner, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('received_quantity')) {
                    obj['received_quantity'] = _ApiClient2.default.convertToType(data['received_quantity'], 'Number');
                }
    ...
    return ReceivedItemsPutInner;
}();

exports.default = ReceivedItemsPutInner;