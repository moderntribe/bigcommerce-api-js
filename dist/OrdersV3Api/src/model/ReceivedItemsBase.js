...
var _ReceivedItemsBaseInner = require('./ReceivedItemsBaseInner');
...
/**
* The ReceivedItemsBase model module.
* @module model/ReceivedItemsBase
* @version 3.0
*/
var ReceivedItemsBase = function (_extendableBuiltin2) {
    _inherits(ReceivedItemsBase, _extendableBuiltin2);

    /**
    * Constructs a new <code>ReceivedItemsBase</code>.
    * @alias module:model/ReceivedItemsBase
    * @class
    * @extends Array
    */

    function ReceivedItemsBase() {
        var _ret;

        _classCallCheck(this, ReceivedItemsBase);

        var _this = _possibleConstructorReturn(this, (ReceivedItemsBase.__proto__ || Object.getPrototypeOf(ReceivedItemsBase)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>ReceivedItemsBase</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReceivedItemsBase} obj Optional instance to populate.
    * @return {module:model/ReceivedItemsBase} The populated <code>ReceivedItemsBase</code> instance.
    */


    _createClass(ReceivedItemsBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReceivedItemsBase();
                _ApiClient2.default.constructFromObject(data, obj, 'ReceivedItemsBaseInner');
            }
            return obj;
        }
    }]);

    return ReceivedItemsBase;
}(_extendableBuiltin(Array));

exports.default = ReceivedItemsBase;