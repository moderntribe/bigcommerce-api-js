...
var _RefundQuoteFull = require('./RefundQuoteFull1');
...
var InlineResponse201 = function () {
    ...
    */
    ...
    _createClass(InlineResponse201, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj['data'] = _RefundQuoteFull2.default.constructFromObject(data['data']);
                }
        ...
        /**
        * @member {module:model/RefundQuoteFull1} data
        */
