...
/**
* The RefundRequestPost model module.
* @module model/RefundRequestPost
* @version 3.0
*/
var RefundRequestPost = function () {
    /**
    * Constructs a new <code>RefundRequestPost</code>.
    * Request body for refund requests.
    * @alias module:model/RefundRequestPost
    * @class
    ...
    */
    ...
    function RefundRequestPost(orderId, items, payments) {
        _classCallCheck(this, RefundRequestPost);
    ...
    /**
    * Constructs a <code>RefundRequestPost</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RefundRequestPost} obj Optional instance to populate.
    * @return {module:model/RefundRequestPost} The populated <code>RefundRequestPost</code> instance.
    */


    _createClass(RefundRequestPost, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new RefundRequestPost();
    ...
    return RefundRequestPost;
}();

exports.default = RefundRequestPost;