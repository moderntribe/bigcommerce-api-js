...
/**
* The CreateReturnRequestReferenceId model module.
* @module model/CreateReturnRequestReferenceId
* @version 3.0
*/
var CreateReturnRequestReferenceId = function () {
    /**
    * Constructs a new <code>CreateReturnRequestReferenceId</code>.
    * @alias module:model/CreateReturnRequestReferenceId
    * @class
    * @param type {module:model/CreateReturnRequestReferenceId.TypeEnum} The reference type
    * @param value {String} The value identifying the returned item
    */

    function CreateReturnRequestReferenceId(type, value) {
        _classCallCheck(this, CreateReturnRequestReferenceId);
    ...
    /**
    * Constructs a <code>CreateReturnRequestReferenceId</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnRequestReferenceId} obj Optional instance to populate.
    * @return {module:model/CreateReturnRequestReferenceId} The populated <code>CreateReturnRequestReferenceId</code> instance.
    */


    _createClass(CreateReturnRequestReferenceId, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnRequestReferenceId();
        ...
        /**
        * The reference type
        * @member {module:model/CreateReturnRequestReferenceId.TypeEnum} type
        */
    ...
    return CreateReturnRequestReferenceId;
}();

CreateReturnRequestReferenceId.TypeEnum = {
    /**
     * value: "ORDER_PRODUCT"
     * @const
     */
    "PRODUCT": "ORDER_PRODUCT" };
exports.default = CreateReturnRequestReferenceId;