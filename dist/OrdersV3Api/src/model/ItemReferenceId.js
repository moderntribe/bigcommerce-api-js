...
/**
* The ItemReferenceId model module.
* @module model/ItemReferenceId
* @version 3.0
*/
var ItemReferenceId = function () {
    /**
    * Constructs a new <code>ItemReferenceId</code>.
    * @alias module:model/ItemReferenceId
    * @class
    * @param type {module:model/ItemReferenceId.TypeEnum} The reference type
    * @param value {String} The value identifying the returned item
    */

    function ItemReferenceId(type, value) {
        _classCallCheck(this, ItemReferenceId);
    ...
    /**
    * Constructs a <code>ItemReferenceId</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemReferenceId} obj Optional instance to populate.
    * @return {module:model/ItemReferenceId} The populated <code>ItemReferenceId</code> instance.
    */


    _createClass(ItemReferenceId, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ItemReferenceId();
        ...
        /**
        * The reference type
        * @member {module:model/ItemReferenceId.TypeEnum} type
        */
...
ItemReferenceId.TypeEnum = {
    /**
     * value: "ORDER_PRODUCT"
     * @const
     */
    "PRODUCT": "ORDER_PRODUCT" };
exports.default = ItemReferenceId;