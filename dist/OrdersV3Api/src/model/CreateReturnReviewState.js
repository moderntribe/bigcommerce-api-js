...
/**
* The CreateReturnReviewState model module.
* @module model/CreateReturnReviewState
* @version 3.0
*/
var CreateReturnReviewState = function () {
    /**
    * Constructs a new <code>CreateReturnReviewState</code>.
    * @alias module:model/CreateReturnReviewState
    * @class
    */

    function CreateReturnReviewState() {
        _classCallCheck(this, CreateReturnReviewState);

        this['approved_quantity'] = undefined;
        this['pending_quantity'] = undefined;
        this['rejected_quantity'] = undefined;
    }

    /**
    * Constructs a <code>CreateReturnReviewState</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnReviewState} obj Optional instance to populate.
    * @return {module:model/CreateReturnReviewState} The populated <code>CreateReturnReviewState</code> instance.
    */


    _createClass(CreateReturnReviewState, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnReviewState();

                if (data.hasOwnProperty('approved_quantity')) {
                    obj['approved_quantity'] = _ApiClient2.default.convertToType(data['approved_quantity'], 'Number');
                }
        ...
        * @member {Number} approved_quantity
        */
    ...
    return CreateReturnReviewState;
}();

exports.default = CreateReturnReviewState;