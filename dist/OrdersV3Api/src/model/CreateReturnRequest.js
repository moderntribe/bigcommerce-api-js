...
var _CreateReturnRequestItems = require('./CreateReturnRequestItems');
...
/**
* The CreateReturnRequest model module.
* @module model/CreateReturnRequest
* @version 3.0
*/
var CreateReturnRequest = function () {
    /**
    * Constructs a new <code>CreateReturnRequest</code>.
    * @alias module:model/CreateReturnRequest
    * @class
    * @param items {Array.<module:model/CreateReturnRequestItems>} A collection of items to be returned
    */

    function CreateReturnRequest(items) {
        _classCallCheck(this, CreateReturnRequest);
    ...
    /**
    * Constructs a <code>CreateReturnRequest</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnRequest} obj Optional instance to populate.
    * @return {module:model/CreateReturnRequest} The populated <code>CreateReturnRequest</code> instance.
    */


    _createClass(CreateReturnRequest, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnRequest();

                if (data.hasOwnProperty('items')) {
                    obj['items'] = _ApiClient2.default.convertToType(data['items'], [_CreateReturnRequestItems2.default]);
                }
                if (data.hasOwnProperty('comment')) {
                    obj['comment'] = _ApiClient2.default.convertToType(data['comment'], 'String');
                }
            }
            return obj;
        }
        ...
        * @member {Array.<module:model/CreateReturnRequestItems>} items
        */
...
exports.default = CreateReturnRequest;