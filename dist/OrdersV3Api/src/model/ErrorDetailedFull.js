...
/**
* The ErrorDetailedFull model module.
* @module model/ErrorDetailedFull
* @version 3.0
*/
var ErrorDetailedFull = function () {
    /**
    * Constructs a new <code>ErrorDetailedFull</code>.
    * @alias module:model/ErrorDetailedFull
    * @class
    */

    function ErrorDetailedFull() {
        _classCallCheck(this, ErrorDetailedFull);

        this['errors'] = undefined;
    }

    /**
    * Constructs a <code>ErrorDetailedFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ErrorDetailedFull} obj Optional instance to populate.
    * @return {module:model/ErrorDetailedFull} The populated <code>ErrorDetailedFull</code> instance.
    */


    _createClass(ErrorDetailedFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ErrorDetailedFull();

                if (data.hasOwnProperty('errors')) {
                    obj['errors'] = _ApiClient2.default.convertToType(data['errors'], { 'String': 'String' });
                }
            }
            return obj;
        }
    ...
    return ErrorDetailedFull;
}();

exports.default = ErrorDetailedFull;