...
* @version 3.0
*/
var GetReturnableItemsInner = function () {
    /**
    ...
    */
    ...
    function GetReturnableItemsInner() {
        _classCallCheck(this, GetReturnableItemsInner);

        this['reference_id'] = undefined;
        this['name'] = undefined;
        this['returnable_quantity'] = undefined;
    ...
    */
    ...
    _createClass(GetReturnableItemsInner, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('reference_id')) {
                    obj['reference_id'] = _ApiClient2.default.convertToType(data['reference_id'], Object);
                }
                if (data.hasOwnProperty('name')) {
                    obj['name'] = _ApiClient2.default.convertToType(data['name'], 'String');
                }
                if (data.hasOwnProperty('returnable_quantity')) {
                    obj['returnable_quantity'] = _ApiClient2.default.convertToType(data['returnable_quantity'], 'Number');
                }
    ...
    return GetReturnableItemsInner;
}();

exports.default = GetReturnableItemsInner;