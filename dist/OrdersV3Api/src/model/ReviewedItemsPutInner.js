...
/**
* The ReviewedItemsPutInner model module.
* @module model/ReviewedItemsPutInner
* @version 3.0
*/
var ReviewedItemsPutInner = function () {
    /**
    * Constructs a new <code>ReviewedItemsPutInner</code>.
    * @alias module:model/ReviewedItemsPutInner
    * @class
    * @param itemId {Number} The ID of the item for which to update the reviewed state
    * @param authorizedQuantity {Number} The quantity of items to be marked as authorized
    * @param rejectedQuantity {Number} The quantity of items to be marked as rejected
    * @param pendingQuantity {Number} The quantity of items to be marked as pending
    */

    function ReviewedItemsPutInner(itemId, authorizedQuantity, rejectedQuantity, pendingQuantity) {
        _classCallCheck(this, ReviewedItemsPutInner);

        this['item_id'] = undefined;
        this['authorized_quantity'] = undefined;
        this['rejected_quantity'] = undefined;
        this['pending_quantity'] = undefined;


        this['item_id'] = itemId;
        this['authorized_quantity'] = authorizedQuantity;
        this['rejected_quantity'] = rejectedQuantity;
        this['pending_quantity'] = pendingQuantity;
    }

    /**
    * Constructs a <code>ReviewedItemsPutInner</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReviewedItemsPutInner} obj Optional instance to populate.
    * @return {module:model/ReviewedItemsPutInner} The populated <code>ReviewedItemsPutInner</code> instance.
    */


    _createClass(ReviewedItemsPutInner, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReviewedItemsPutInner();

                if (data.hasOwnProperty('item_id')) {
                    obj['item_id'] = _ApiClient2.default.convertToType(data['item_id'], 'Number');
                }
                if (data.hasOwnProperty('authorized_quantity')) {
                    obj['authorized_quantity'] = _ApiClient2.default.convertToType(data['authorized_quantity'], 'Number');
                }
                if (data.hasOwnProperty('rejected_quantity')) {
                    obj['rejected_quantity'] = _ApiClient2.default.convertToType(data['rejected_quantity'], 'Number');
                }
                if (data.hasOwnProperty('pending_quantity')) {
                    obj['pending_quantity'] = _ApiClient2.default.convertToType(data['pending_quantity'], 'Number');
                }
            }
            return obj;
        }
        ...
        * @member {Number} authorized_quantity
        */

        /**
        * The quantity of items to be marked as rejected
        * @member {Number} rejected_quantity
        */
    ...
    return ReviewedItemsPutInner;
}();

exports.default = ReviewedItemsPutInner;