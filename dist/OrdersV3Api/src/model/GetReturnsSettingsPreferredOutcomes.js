...
/**
* The GetReturnsSettingsPreferredOutcomes model module.
* @module model/GetReturnsSettingsPreferredOutcomes
* @version 3.0
*/
var GetReturnsSettingsPreferredOutcomes = function () {
    /**
    * Constructs a new <code>GetReturnsSettingsPreferredOutcomes</code>.
    * @alias module:model/GetReturnsSettingsPreferredOutcomes
    * @class
    */

    function GetReturnsSettingsPreferredOutcomes() {
        _classCallCheck(this, GetReturnsSettingsPreferredOutcomes);
    ...
    /**
    * Constructs a <code>GetReturnsSettingsPreferredOutcomes</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GetReturnsSettingsPreferredOutcomes} obj Optional instance to populate.
    * @return {module:model/GetReturnsSettingsPreferredOutcomes} The populated <code>GetReturnsSettingsPreferredOutcomes</code> instance.
    */


    _createClass(GetReturnsSettingsPreferredOutcomes, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new GetReturnsSettingsPreferredOutcomes();
                ...
                if (data.hasOwnProperty('is_archived')) {
                    obj['is_archived'] = _ApiClient2.default.convertToType(data['is_archived'], 'Boolean');
                }
            }
            return obj;
        }
    ...
    return GetReturnsSettingsPreferredOutcomes;
}();

exports.default = GetReturnsSettingsPreferredOutcomes;