...
/**
* The GetReturnsSettingsReasons model module.
* @module model/GetReturnsSettingsReasons
* @version 3.0
*/
var GetReturnsSettingsReasons = function () {
    /**
    * Constructs a new <code>GetReturnsSettingsReasons</code>.
    * @alias module:model/GetReturnsSettingsReasons
    * @class
    */

    function GetReturnsSettingsReasons() {
        _classCallCheck(this, GetReturnsSettingsReasons);
    ...
    /**
    * Constructs a <code>GetReturnsSettingsReasons</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GetReturnsSettingsReasons} obj Optional instance to populate.
    * @return {module:model/GetReturnsSettingsReasons} The populated <code>GetReturnsSettingsReasons</code> instance.
    */


    _createClass(GetReturnsSettingsReasons, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new GetReturnsSettingsReasons();
    ...
    return GetReturnsSettingsReasons;
}();

exports.default = GetReturnsSettingsReasons;