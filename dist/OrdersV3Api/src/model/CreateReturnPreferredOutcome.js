...
/**
* The CreateReturnPreferredOutcome model module.
* @module model/CreateReturnPreferredOutcome
* @version 3.0
*/
var CreateReturnPreferredOutcome = function () {
    /**
    * Constructs a new <code>CreateReturnPreferredOutcome</code>.
    * @alias module:model/CreateReturnPreferredOutcome
    * @class
    */

    function CreateReturnPreferredOutcome() {
        _classCallCheck(this, CreateReturnPreferredOutcome);
    ...
    /**
    * Constructs a <code>CreateReturnPreferredOutcome</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnPreferredOutcome} obj Optional instance to populate.
    * @return {module:model/CreateReturnPreferredOutcome} The populated <code>CreateReturnPreferredOutcome</code> instance.
    */


    _createClass(CreateReturnPreferredOutcome, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnPreferredOutcome();
    ...
    return CreateReturnPreferredOutcome;
}();

exports.default = CreateReturnPreferredOutcome;