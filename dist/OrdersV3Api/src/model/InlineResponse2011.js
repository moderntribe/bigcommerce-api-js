...
* @version 3.0
*/
var InlineResponse2011 = function () {
    /**
    ...
    */
    ...
    _createClass(InlineResponse2011, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj['data'] = _Refund2.default.constructFromObject(data['data']);
                }
        ...
        /**
        * @member {module:model/Refund1} data
        */
...
exports.default = InlineResponse2011;