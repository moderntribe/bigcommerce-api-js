...
var _ReviewedItemsPutInner = require('./ReviewedItemsPutInner');
...
/**
* The ReviewedItemsPut model module.
* @module model/ReviewedItemsPut
* @version 3.0
*/
var ReviewedItemsPut = function (_extendableBuiltin2) {
    _inherits(ReviewedItemsPut, _extendableBuiltin2);

    /**
    * Constructs a new <code>ReviewedItemsPut</code>.
    * @alias module:model/ReviewedItemsPut
    * @class
    * @extends Array
    */

    function ReviewedItemsPut() {
        var _ret;

        _classCallCheck(this, ReviewedItemsPut);

        var _this = _possibleConstructorReturn(this, (ReviewedItemsPut.__proto__ || Object.getPrototypeOf(ReviewedItemsPut)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>ReviewedItemsPut</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReviewedItemsPut} obj Optional instance to populate.
    * @return {module:model/ReviewedItemsPut} The populated <code>ReviewedItemsPut</code> instance.
    */


    _createClass(ReviewedItemsPut, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReviewedItemsPut();
                _ApiClient2.default.constructFromObject(data, obj, 'ReviewedItemsPutInner');
            }
            return obj;
        }
    }]);

    return ReviewedItemsPut;
}(_extendableBuiltin(Array));

exports.default = ReviewedItemsPut;