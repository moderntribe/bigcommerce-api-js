...
/**
* The ReceivedItemsBaseInner model module.
* @module model/ReceivedItemsBaseInner
* @version 3.0
*/
var ReceivedItemsBaseInner = function () {
    /**
    * Constructs a new <code>ReceivedItemsBaseInner</code>.
    * @alias module:model/ReceivedItemsBaseInner
    * @class
    */

    function ReceivedItemsBaseInner() {
        _classCallCheck(this, ReceivedItemsBaseInner);
    ...
    /**
    * Constructs a <code>ReceivedItemsBaseInner</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReceivedItemsBaseInner} obj Optional instance to populate.
    * @return {module:model/ReceivedItemsBaseInner} The populated <code>ReceivedItemsBaseInner</code> instance.
    */


    _createClass(ReceivedItemsBaseInner, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReceivedItemsBaseInner();
    ...
    return ReceivedItemsBaseInner;
}();

exports.default = ReceivedItemsBaseInner;