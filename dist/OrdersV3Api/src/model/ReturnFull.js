...
var _CreateReturnCustomer = require('./CreateReturnCustomer');

var _CreateReturnCustomer2 = _interopRequireDefault(_CreateReturnCustomer);

var _CreateReturnItems = require('./CreateReturnItems');
...
/**
* The ReturnFull model module.
* @module model/ReturnFull
* @version 3.0
*/
var ReturnFull = function () {
    /**
    * Constructs a new <code>ReturnFull</code>.
    * A view of a return
    * @alias module:model/ReturnFull
    * @class
    */

    function ReturnFull() {
        _classCallCheck(this, ReturnFull);
    ...
    /**
    * Constructs a <code>ReturnFull</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReturnFull} obj Optional instance to populate.
    * @return {module:model/ReturnFull} The populated <code>ReturnFull</code> instance.
    */


    _createClass(ReturnFull, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ReturnFull();

                if (data.hasOwnProperty('items')) {
                    obj['items'] = _ApiClient2.default.convertToType(data['items'], [_CreateReturnItems2.default]);
                }
                ...
                if (data.hasOwnProperty('customer')) {
                    obj['customer'] = _CreateReturnCustomer2.default.constructFromObject(data['customer']);
                }
        ...
        /**
        * @member {Array.<module:model/CreateReturnItems>} items
        */
        ...
        */
        ...
        /**
        * @member {module:model/CreateReturnCustomer} customer
        */
        ...
        * @member {module:model/ReturnFull.StatusEnum} status
        */
