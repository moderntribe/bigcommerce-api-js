...
var _GetReturnsSettingsPreferredOutcomes = require('./GetReturnsSettingsPreferredOutcomes');

var _GetReturnsSettingsPreferredOutcomes2 = _interopRequireDefault(_GetReturnsSettingsPreferredOutcomes);

var _GetReturnsSettingsReasons = require('./GetReturnsSettingsReasons');
...
/**
* The GetReturnsSettings model module.
* @module model/GetReturnsSettings
* @version 3.0
*/
var GetReturnsSettings = function () {
    /**
    * Constructs a new <code>GetReturnsSettings</code>.
    * @alias module:model/GetReturnsSettings
    * @class
    */

    function GetReturnsSettings() {
        _classCallCheck(this, GetReturnsSettings);

        this['reasons'] = undefined;
        this['preferred_outcomes'] = undefined;
    }

    /**
    * Constructs a <code>GetReturnsSettings</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GetReturnsSettings} obj Optional instance to populate.
    * @return {module:model/GetReturnsSettings} The populated <code>GetReturnsSettings</code> instance.
    */


    _createClass(GetReturnsSettings, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new GetReturnsSettings();

                if (data.hasOwnProperty('reasons')) {
                    obj['reasons'] = _ApiClient2.default.convertToType(data['reasons'], [_GetReturnsSettingsReasons2.default]);
                }
                if (data.hasOwnProperty('preferred_outcomes')) {
                    obj['preferred_outcomes'] = _ApiClient2.default.convertToType(data['preferred_outcomes'], [_GetReturnsSettingsPreferredOutcomes2.default]);
                }
            }
            return obj;
        }
        ...
        /**
        * @member {Array.<module:model/GetReturnsSettingsReasons>} reasons
        */

        /**
        * @member {Array.<module:model/GetReturnsSettingsPreferredOutcomes>} preferred_outcomes
        */

    }]);

    return GetReturnsSettings;
}();

exports.default = GetReturnsSettings;