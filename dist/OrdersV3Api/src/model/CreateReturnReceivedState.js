...
/**
* The CreateReturnReceivedState model module.
* @module model/CreateReturnReceivedState
* @version 3.0
*/
var CreateReturnReceivedState = function () {
    /**
    * Constructs a new <code>CreateReturnReceivedState</code>.
    * @alias module:model/CreateReturnReceivedState
    * @class
    */

    function CreateReturnReceivedState() {
        _classCallCheck(this, CreateReturnReceivedState);
    ...
    /**
    * Constructs a <code>CreateReturnReceivedState</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnReceivedState} obj Optional instance to populate.
    * @return {module:model/CreateReturnReceivedState} The populated <code>CreateReturnReceivedState</code> instance.
    */


    _createClass(CreateReturnReceivedState, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnReceivedState();
    ...
    return CreateReturnReceivedState;
}();

exports.default = CreateReturnReceivedState;