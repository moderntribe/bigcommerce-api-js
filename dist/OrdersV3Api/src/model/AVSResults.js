...
/**
* The AVSResults model module.
* @module model/AVSResults
* @version 3.0
*/
var AVSResults = function () {
    /**
    * Constructs a new <code>AVSResults</code>.
    * Address Verification Service (AVS) result from the payment gateway.
    * @alias module:model/AVSResults
    * @class
    */

    function AVSResults() {
        _classCallCheck(this, AVSResults);

        this['code'] = undefined;
        this['message'] = undefined;
        this['street_match'] = undefined;
        this['postal_match'] = undefined;
    }

    /**
    * Constructs a <code>AVSResults</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AVSResults} obj Optional instance to populate.
    * @return {module:model/AVSResults} The populated <code>AVSResults</code> instance.
    */


    _createClass(AVSResults, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AVSResults();
                ...
                if (data.hasOwnProperty('street_match')) {
                    obj['street_match'] = _ApiClient2.default.convertToType(data['street_match'], 'String');
                }
                if (data.hasOwnProperty('postal_match')) {
                    obj['postal_match'] = _ApiClient2.default.convertToType(data['postal_match'], 'String');
                }
            }
            return obj;
        }
