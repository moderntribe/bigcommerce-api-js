...
/**
* The Offline model module.
* @module model/Offline
* @version 3.0
*/
var Offline = function () {
    /**
    * Constructs a new <code>Offline</code>.
    * Offline payment (e.g., check or purchase order).
    * @alias module:model/Offline
    * @class
    */
    ...
    /**
    * Constructs a <code>Offline</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Offline} obj Optional instance to populate.
    * @return {module:model/Offline} The populated <code>Offline</code> instance.
    */


    _createClass(Offline, null, [{
