...
/**
* The RefundRequestPost1 model module.
* @module model/RefundRequestPost1
* @version 3.0
*/
var RefundRequestPost1 = function () {
    /**
    * Constructs a new <code>RefundRequestPost1</code>.
    * Request body for refund requests.
    * @alias module:model/RefundRequestPost1
    * @class
    * @param orderId {Number} Order id against which this refund will be created
    * @param items {Array.<Object>} 
    * @param payments {Array.<module:model/PaymentRequest>} 
    */

    function RefundRequestPost1(orderId, items, payments) {
        _classCallCheck(this, RefundRequestPost1);
    ...
    /**
    * Constructs a <code>RefundRequestPost1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RefundRequestPost1} obj Optional instance to populate.
    * @return {module:model/RefundRequestPost1} The populated <code>RefundRequestPost1</code> instance.
    */


    _createClass(RefundRequestPost1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new RefundRequestPost1();

                if (data.hasOwnProperty('order_id')) {
                    obj['order_id'] = _ApiClient2.default.convertToType(data['order_id'], 'Number');
                }
                if (data.hasOwnProperty('items')) {
                    obj['items'] = _ApiClient2.default.convertToType(data['items'], [Object]);
                }
                if (data.hasOwnProperty('reason')) {
                    obj['reason'] = _ApiClient2.default.convertToType(data['reason'], 'String');
                }
                if (data.hasOwnProperty('payments')) {
                    obj['payments'] = _ApiClient2.default.convertToType(data['payments'], [_PaymentRequest2.default]);
                }
            }
            return obj;
        }
    ...
    return RefundRequestPost1;
}();

exports.default = RefundRequestPost1;