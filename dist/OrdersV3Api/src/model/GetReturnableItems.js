...
var _GetReturnableItemsInner = require('./GetReturnableItemsInner');
...
/**
* The GetReturnableItems model module.
* @module model/GetReturnableItems
* @version 3.0
*/
var GetReturnableItems = function (_extendableBuiltin2) {
    _inherits(GetReturnableItems, _extendableBuiltin2);

    /**
    * Constructs a new <code>GetReturnableItems</code>.
    * @alias module:model/GetReturnableItems
    * @class
    * @extends Array
    */
    ...
    function GetReturnableItems() {
        ...
        _classCallCheck(this, GetReturnableItems);

        var _this = _possibleConstructorReturn(this, (GetReturnableItems.__proto__ || Object.getPrototypeOf(GetReturnableItems)).call(this));

        return _ret = _this, _possibleConstructorReturn(_this, _ret);
    }

    /**
    * Constructs a <code>GetReturnableItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GetReturnableItems} obj Optional instance to populate.
    * @return {module:model/GetReturnableItems} The populated <code>GetReturnableItems</code> instance.
    */


    _createClass(GetReturnableItems, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new GetReturnableItems();
                _ApiClient2.default.constructFromObject(data, obj, 'GetReturnableItemsInner');
            }
            return obj;
        }
    }]);
...
exports.default = GetReturnableItems;