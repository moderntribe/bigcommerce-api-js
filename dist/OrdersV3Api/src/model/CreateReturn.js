...
/**
* The CreateReturn model module.
* @module model/CreateReturn
* @version 3.0
*/
var CreateReturn = function () {
    /**
    * Constructs a new <code>CreateReturn</code>.
    * A view of a return
    * @alias module:model/CreateReturn
    * @class
    */

    function CreateReturn() {
        _classCallCheck(this, CreateReturn);
    ...
    /**
    * Constructs a <code>CreateReturn</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturn} obj Optional instance to populate.
    * @return {module:model/CreateReturn} The populated <code>CreateReturn</code> instance.
    */


    _createClass(CreateReturn, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturn();
        ...
        * @member {module:model/CreateReturn.StatusEnum} status
        */
