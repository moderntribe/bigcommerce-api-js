...
var _LinksFull = require('./LinksFull1');
...
/**
* The PaginationFull1 model module.
* @module model/PaginationFull1
* @version 3.0
*/
var PaginationFull1 = function () {
    /**
    * Constructs a new <code>PaginationFull1</code>.
    * @alias module:model/PaginationFull1
    * @class
    */

    function PaginationFull1() {
        _classCallCheck(this, PaginationFull1);
    ...
    /**
    * Constructs a <code>PaginationFull1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PaginationFull1} obj Optional instance to populate.
    * @return {module:model/PaginationFull1} The populated <code>PaginationFull1</code> instance.
    */


    _createClass(PaginationFull1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PaginationFull1();
                ...
                if (data.hasOwnProperty('links')) {
                    obj['links'] = _LinksFull2.default.constructFromObject(data['links']);
                }
            }
            return obj;
        }
    ...
    return PaginationFull1;
}();

exports.default = PaginationFull1;