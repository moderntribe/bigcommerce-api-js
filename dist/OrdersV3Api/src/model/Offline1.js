...
/**
* The Offline1 model module.
* @module model/Offline1
* @version 3.0
*/
var Offline1 = function () {
    /**
    * Constructs a new <code>Offline1</code>.
    * Offline payment (e.g., check or purchase order).
    * @alias module:model/Offline1
    * @class
    */

    function Offline1() {
        _classCallCheck(this, Offline1);

        this['display_name'] = undefined;
    }

    /**
    * Constructs a <code>Offline1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Offline1} obj Optional instance to populate.
    * @return {module:model/Offline1} The populated <code>Offline1</code> instance.
    */


    _createClass(Offline1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new Offline1();
