...
/**
* The CreateReturnCustomer model module.
* @module model/CreateReturnCustomer
* @version 3.0
*/
var CreateReturnCustomer = function () {
    /**
    * Constructs a new <code>CreateReturnCustomer</code>.
    * @alias module:model/CreateReturnCustomer
    * @class
    */

    function CreateReturnCustomer() {
        _classCallCheck(this, CreateReturnCustomer);
    ...
    /**
    * Constructs a <code>CreateReturnCustomer</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/CreateReturnCustomer} obj Optional instance to populate.
    * @return {module:model/CreateReturnCustomer} The populated <code>CreateReturnCustomer</code> instance.
    */


    _createClass(CreateReturnCustomer, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new CreateReturnCustomer();
    ...
    return CreateReturnCustomer;
}();

exports.default = CreateReturnCustomer;