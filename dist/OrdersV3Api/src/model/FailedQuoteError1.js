...
/**
* The FailedQuoteError1 model module.
* @module model/FailedQuoteError1
* @version 3.0
*/
var FailedQuoteError1 = function () {
    /**
    * Constructs a new <code>FailedQuoteError1</code>.
    * Failed quote response.
    * @alias module:model/FailedQuoteError1
    * @class
    */

    function FailedQuoteError1() {
        _classCallCheck(this, FailedQuoteError1);
    ...
    /**
    * Constructs a <code>FailedQuoteError1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/FailedQuoteError1} obj Optional instance to populate.
    * @return {module:model/FailedQuoteError1} The populated <code>FailedQuoteError1</code> instance.
    */


    _createClass(FailedQuoteError1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new FailedQuoteError1();
    ...
    return FailedQuoteError1;
}();

exports.default = FailedQuoteError1;