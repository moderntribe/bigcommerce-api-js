...
var RefundItem = function () {
    ...
    */
    ...
    function RefundItem() {
        _classCallCheck(this, RefundItem);

        this['item_type'] = undefined;
        this['item_id'] = undefined;
        this['reason'] = undefined;
        this['quantity'] = undefined;
        this['requested_amount'] = undefined;
    }
    ...
    */
    ...
    _createClass(RefundItem, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('requested_amount')) {
                    obj['requested_amount'] = _ApiClient2.default.convertToType(data['requested_amount'], 'Number');
                }
            }
            return obj;
        }
        ...
        * @member {module:model/RefundItem.ItemTypeEnum} item_type
        */
