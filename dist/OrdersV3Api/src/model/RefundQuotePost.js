...
/**
* The RefundQuotePost model module.
* @module model/RefundQuotePost
* @version 3.0
*/
var RefundQuotePost = function () {
    /**
    * Constructs a new <code>RefundQuotePost</code>.
    * Request body for refund quotes.
    * @alias module:model/RefundQuotePost
    * @class
    ...
    */
    ...
    function RefundQuotePost(orderId, items) {
        _classCallCheck(this, RefundQuotePost);
    ...
    /**
    * Constructs a <code>RefundQuotePost</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/RefundQuotePost} obj Optional instance to populate.
    * @return {module:model/RefundQuotePost} The populated <code>RefundQuotePost</code> instance.
    */


    _createClass(RefundQuotePost, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new RefundQuotePost();
    ...
    return RefundQuotePost;
}();

exports.default = RefundQuotePost;