...
var _AVSResults = require('./AVSResults');

var _AVSResults2 = _interopRequireDefault(_AVSResults);

var _CVVResult = require('./CVVResult');
...
var _GiftCertificate = require('./GiftCertificate');

var _GiftCertificate2 = _interopRequireDefault(_GiftCertificate);

var _TransactionStoreCredit = require('./TransactionStoreCredit');
    ...
    */
    ...
    _createClass(Transaction, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('avs_result')) {
                    obj['avs_result'] = _AVSResults2.default.constructFromObject(data['avs_result']);
                }
                if (data.hasOwnProperty('cvv_result')) {
                    obj['cvv_result'] = _CVVResult2.default.constructFromObject(data['cvv_result']);
                }
                if (data.hasOwnProperty('credit_card')) {
                    obj['credit_card'] = _CreditCard2.default.constructFromObject(data['credit_card']);
                }
                if (data.hasOwnProperty('gift_certificate')) {
                    obj['gift_certificate'] = _GiftCertificate2.default.constructFromObject(data['gift_certificate']);
                }
                if (data.hasOwnProperty('store_credit')) {
                    obj['store_credit'] = _TransactionStoreCredit2.default.constructFromObject(data['store_credit']);
                }
            }
            return obj;
        }
        ...
        */
        ...
        /**
        * @member {module:model/AVSResults} avs_result
        */
        ...
        */
        ...
        /**
        * @member {module:model/TransactionStoreCredit} store_credit
        */
