...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OrdersV3.TransactionsApi(new BCApiClient(config));
  });

  describe('(package)', function () {
    describe('TransactionsApi', function () {
      describe('getTransactions', function () {
        it('should call getTransactions successfully', _asyncToGenerator(function* () {
          // const getTransactionsResponse = await instance.getTransactions();
          // expect(getTransactionsResponse.ok).to.be(true);
          // expect(getTransactionsResponse.body.data).to.be.an('array');
        }));
      });
    });
  });
