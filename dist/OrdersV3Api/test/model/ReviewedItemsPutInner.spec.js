...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReviewedItemsPutInner', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReviewedItemsPutInner();
      });

      it('should create an instance of ReviewedItemsPutInner', function () {
        expect(instance).to.be.a(OrdersV3.ReviewedItemsPutInner);
      });
