...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnCustomer', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnCustomer();
      });

      it('should create an instance of CreateReturnCustomer', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnCustomer);
      });
