...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundQuotePost', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundQuotePost();
      });

      it('should create an instance of RefundQuotePost', function () {
        expect(instance).to.be.a(OrdersV3.RefundQuotePost);
      });
