...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('FailedQuoteError1', function () {
      beforeEach(function () {
        instance = new OrdersV3.FailedQuoteError1();
      });

      it('should create an instance of FailedQuoteError1', function () {
        expect(instance).to.be.a(OrdersV3.FailedQuoteError1);
      });
