...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AVSResults', function () {
      beforeEach(function () {
        instance = new OrdersV3.AVSResults();
      });

      it('should create an instance of AVSResults', function () {
        expect(instance).to.be.a(OrdersV3.AVSResults);
      });
      ...
      it('should have the property street_match (base name: "street_match")', function () {
        expect(instance).to.have.property('street_match');
        // expect(instance.street_match).to.be(expectedValueLiteral);
      });

      it('should have the property postal_match (base name: "postal_match")', function () {
        expect(instance).to.have.property('postal_match');
        // expect(instance.postal_match).to.be(expectedValueLiteral);
      });
    });
  });
});