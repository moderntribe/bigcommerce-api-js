...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PaymentOption', function () {
      beforeEach(function () {
        instance = new OrdersV3.PaymentOption();
      });

      it('should create an instance of PaymentOption', function () {
        expect(instance).to.be.a(OrdersV3.PaymentOption);
      });

      it('should have the property provider_id (base name: "provider_id")', function () {
        expect(instance).to.have.property('provider_id');
        // expect(instance.provider_id).to.be(expectedValueLiteral);
      });

      it('should have the property provider_description (base name: "provider_description")', function () {
        expect(instance).to.have.property('provider_description');
        // expect(instance.provider_description).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property offline_provider (base name: "offline_provider")', function () {
        expect(instance).to.have.property('offline_provider');
        // expect(instance.offline_provider).to.be(expectedValueLiteral);
      });

      it('should have the property offline_reason (base name: "offline_reason")', function () {
        expect(instance).to.have.property('offline_reason');
        // expect(instance.offline_reason).to.be(expectedValueLiteral);
      });
    });
  });
});