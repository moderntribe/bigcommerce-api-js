...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReceivedItemsPut', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReceivedItemsPut();
      });

      it('should create an instance of ReceivedItemsPut', function () {
        expect(instance).to.be.a(OrdersV3.ReceivedItemsPut);
      });
    });
  });
});