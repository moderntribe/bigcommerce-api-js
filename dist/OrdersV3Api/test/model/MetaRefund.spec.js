...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MetaRefund', function () {
      beforeEach(function () {
        instance = new OrdersV3.MetaRefund();
      });

      it('should create an instance of MetaRefund', function () {
        expect(instance).to.be.a(OrdersV3.MetaRefund);
      });
