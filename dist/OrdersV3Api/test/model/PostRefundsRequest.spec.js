...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PostRefundsRequest', function () {
      beforeEach(function () {
        instance = new OrdersV3.PostRefundsRequest();
      });

      it('should create an instance of PostRefundsRequest', function () {
        expect(instance).to.be.a(OrdersV3.PostRefundsRequest);
      });
    });
  });
});