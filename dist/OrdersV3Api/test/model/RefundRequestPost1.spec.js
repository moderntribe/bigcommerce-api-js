...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundRequestPost1', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundRequestPost1();
      });

      it('should create an instance of RefundRequestPost1', function () {
        expect(instance).to.be.a(OrdersV3.RefundRequestPost1);
      });
