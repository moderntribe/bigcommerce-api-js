...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('UpdateReturnStatusesRequest', function () {
      beforeEach(function () {
        instance = new OrdersV3.UpdateReturnStatusesRequest();
      });

      it('should create an instance of UpdateReturnStatusesRequest', function () {
        expect(instance).to.be.a(OrdersV3.UpdateReturnStatusesRequest);
      });
    });
  });
});