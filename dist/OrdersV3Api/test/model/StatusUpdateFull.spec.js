...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('StatusUpdateFull', function () {
      beforeEach(function () {
        instance = new OrdersV3.StatusUpdateFull();
      });

      it('should create an instance of StatusUpdateFull', function () {
        expect(instance).to.be.a(OrdersV3.StatusUpdateFull);
      });
