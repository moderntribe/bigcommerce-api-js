...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('FailedQuoteError', function () {
      beforeEach(function () {
        instance = new OrdersV3.FailedQuoteError();
      });

      it('should create an instance of FailedQuoteError', function () {
        expect(instance).to.be.a(OrdersV3.FailedQuoteError);
      });
