...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('LinksFull', function () {
      beforeEach(function () {
        instance = new OrdersV3.LinksFull();
      });

      it('should create an instance of LinksFull', function () {
        expect(instance).to.be.a(OrdersV3.LinksFull);
      });
