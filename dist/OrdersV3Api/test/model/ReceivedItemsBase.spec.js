...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReceivedItemsBase', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReceivedItemsBase();
      });

      it('should create an instance of ReceivedItemsBase', function () {
        expect(instance).to.be.a(OrdersV3.ReceivedItemsBase);
      });
    });
  });
});