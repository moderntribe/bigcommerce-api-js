...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('UpdateReturnStatusesInner', function () {
      beforeEach(function () {
        instance = new OrdersV3.UpdateReturnStatusesInner();
      });

      it('should create an instance of UpdateReturnStatusesInner', function () {
        expect(instance).to.be.a(OrdersV3.UpdateReturnStatusesInner);
      });
