...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('BatchOperationMeta', function () {
      beforeEach(function () {
        instance = new OrdersV3.BatchOperationMeta();
      });

      it('should create an instance of BatchOperationMeta', function () {
        expect(instance).to.be.a(OrdersV3.BatchOperationMeta);
      });
