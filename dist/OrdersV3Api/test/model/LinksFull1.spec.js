...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('LinksFull1', function () {
      beforeEach(function () {
        instance = new OrdersV3.LinksFull1();
      });

      it('should create an instance of LinksFull1', function () {
        expect(instance).to.be.a(OrdersV3.LinksFull1);
      });
