...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('TransactionStoreCredit', function () {
      beforeEach(function () {
        instance = new OrdersV3.TransactionStoreCredit();
      });

      it('should create an instance of TransactionStoreCredit', function () {
        expect(instance).to.be.a(OrdersV3.TransactionStoreCredit);
      });
