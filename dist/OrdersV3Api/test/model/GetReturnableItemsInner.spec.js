...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetReturnableItemsInner', function () {
      beforeEach(function () {
        instance = new OrdersV3.GetReturnableItemsInner();
      });

      it('should create an instance of GetReturnableItemsInner', function () {
        expect(instance).to.be.a(OrdersV3.GetReturnableItemsInner);
      });
      ...
      it('should have the property returnable_quantity (base name: "returnable_quantity")', function () {
        expect(instance).to.have.property('returnable_quantity');
        // expect(instance.returnable_quantity).to.be(expectedValueLiteral);
      });
