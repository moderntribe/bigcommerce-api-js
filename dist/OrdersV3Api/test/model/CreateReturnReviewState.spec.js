...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnReviewState', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnReviewState();
      });

      it('should create an instance of CreateReturnReviewState', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnReviewState);
      });

      it('should have the property approved_quantity (base name: "approved_quantity")', function () {
        expect(instance).to.have.property('approved_quantity');
        // expect(instance.approved_quantity).to.be(expectedValueLiteral);
      });
