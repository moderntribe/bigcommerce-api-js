...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PostRefundQuotesRequest', function () {
      beforeEach(function () {
        instance = new OrdersV3.PostRefundQuotesRequest();
      });

      it('should create an instance of PostRefundQuotesRequest', function () {
        expect(instance).to.be.a(OrdersV3.PostRefundQuotesRequest);
      });
    });
  });
});