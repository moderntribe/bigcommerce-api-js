...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnRequestItem', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnRequestItem();
      });

      it('should create an instance of CreateReturnRequestItem', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnRequestItem);
      });
