...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AmountBoundItem', function () {
      beforeEach(function () {
        instance = new OrdersV3.AmountBoundItem();
      });

      it('should create an instance of AmountBoundItem', function () {
        expect(instance).to.be.a(OrdersV3.AmountBoundItem);
      });
