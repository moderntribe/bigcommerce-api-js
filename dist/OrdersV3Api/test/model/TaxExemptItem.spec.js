...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('TaxExemptItem', function () {
      beforeEach(function () {
        instance = new OrdersV3.TaxExemptItem();
      });

      it('should create an instance of TaxExemptItem', function () {
        expect(instance).to.be.a(OrdersV3.TaxExemptItem);
      });
