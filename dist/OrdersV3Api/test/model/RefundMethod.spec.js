...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundMethod', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundMethod();
      });

      it('should create an instance of RefundMethod', function () {
        expect(instance).to.be.a(OrdersV3.RefundMethod);
      });
    });
  });
});