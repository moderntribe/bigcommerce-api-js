...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnReason', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnReason();
      });

      it('should create an instance of CreateReturnReason', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnReason);
      });
