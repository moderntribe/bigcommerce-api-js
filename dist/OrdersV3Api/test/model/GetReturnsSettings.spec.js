...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetReturnsSettings', function () {
      beforeEach(function () {
        instance = new OrdersV3.GetReturnsSettings();
      });

      it('should create an instance of GetReturnsSettings', function () {
        expect(instance).to.be.a(OrdersV3.GetReturnsSettings);
      });
      ...
      it('should have the property preferred_outcomes (base name: "preferred_outcomes")', function () {
        expect(instance).to.have.property('preferred_outcomes');
        // expect(instance.preferred_outcomes).to.be(expectedValueLiteral);
      });
    });
  });
});