...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundRequestPost', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundRequestPost();
      });

      it('should create an instance of RefundRequestPost', function () {
        expect(instance).to.be.a(OrdersV3.RefundRequestPost);
      });
