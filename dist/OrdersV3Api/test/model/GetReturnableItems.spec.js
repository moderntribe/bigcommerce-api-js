...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetReturnableItems', function () {
      beforeEach(function () {
        instance = new OrdersV3.GetReturnableItems();
      });

      it('should create an instance of GetReturnableItems', function () {
        expect(instance).to.be.a(OrdersV3.GetReturnableItems);
      });
    });
  });
});