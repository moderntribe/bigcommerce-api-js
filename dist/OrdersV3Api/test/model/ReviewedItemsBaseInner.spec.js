...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReviewedItemsBaseInner', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReviewedItemsBaseInner();
      });

      it('should create an instance of ReviewedItemsBaseInner', function () {
        expect(instance).to.be.a(OrdersV3.ReviewedItemsBaseInner);
      });
      ...
      it('should have the property authorized_quantity (base name: "authorized_quantity")', function () {
        expect(instance).to.have.property('authorized_quantity');
        // expect(instance.authorized_quantity).to.be(expectedValueLiteral);
      });

      it('should have the property rejected_quantity (base name: "rejected_quantity")', function () {
        expect(instance).to.have.property('rejected_quantity');
        // expect(instance.rejected_quantity).to.be(expectedValueLiteral);
      });

      it('should have the property pending_quantity (base name: "pending_quantity")', function () {
        expect(instance).to.have.property('pending_quantity');
        // expect(instance.pending_quantity).to.be(expectedValueLiteral);
      });
    });
  });
});