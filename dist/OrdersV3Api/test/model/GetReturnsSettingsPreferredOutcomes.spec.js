...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetReturnsSettingsPreferredOutcomes', function () {
      beforeEach(function () {
        instance = new OrdersV3.GetReturnsSettingsPreferredOutcomes();
      });

      it('should create an instance of GetReturnsSettingsPreferredOutcomes', function () {
        expect(instance).to.be.a(OrdersV3.GetReturnsSettingsPreferredOutcomes);
      });
      ...
      it('should have the property is_archived (base name: "is_archived")', function () {
        expect(instance).to.have.property('is_archived');
        // expect(instance.is_archived).to.be(expectedValueLiteral);
      });
    });
  });
});