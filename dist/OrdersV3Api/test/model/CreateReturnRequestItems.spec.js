...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnRequestItems', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnRequestItems();
      });

      it('should create an instance of CreateReturnRequestItems', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnRequestItems);
      });
      ...
      it('should have the property preferred_outcome_id (base name: "preferred_outcome_id")', function () {
        expect(instance).to.have.property('preferred_outcome_id');
        // expect(instance.preferred_outcome_id).to.be(expectedValueLiteral);
      });

      it('should have the property reason_id (base name: "reason_id")', function () {
        expect(instance).to.have.property('reason_id');
        // expect(instance.reason_id).to.be(expectedValueLiteral);
      });
    });
  });
});