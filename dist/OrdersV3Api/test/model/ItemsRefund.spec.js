...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ItemsRefund', function () {
      beforeEach(function () {
        instance = new OrdersV3.ItemsRefund();
      });

      it('should create an instance of ItemsRefund', function () {
        expect(instance).to.be.a(OrdersV3.ItemsRefund);
      });
    });
  });
});