...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReturnFull', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReturnFull();
      });

      it('should create an instance of ReturnFull', function () {
        expect(instance).to.be.a(OrdersV3.ReturnFull);
      });
