...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('InlineResponse503', function () {
      beforeEach(function () {
        instance = new OrdersV3.InlineResponse503();
      });

      it('should create an instance of InlineResponse503', function () {
        expect(instance).to.be.a(OrdersV3.InlineResponse503);
      });
