...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('QuantityBoundItem', function () {
      beforeEach(function () {
        instance = new OrdersV3.QuantityBoundItem();
      });

      it('should create an instance of QuantityBoundItem', function () {
        expect(instance).to.be.a(OrdersV3.QuantityBoundItem);
      });
