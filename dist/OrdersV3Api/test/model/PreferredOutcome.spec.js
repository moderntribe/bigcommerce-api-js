...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PreferredOutcome', function () {
      beforeEach(function () {
        instance = new OrdersV3.PreferredOutcome();
      });

      it('should create an instance of PreferredOutcome', function () {
        expect(instance).to.be.a(OrdersV3.PreferredOutcome);
      });
