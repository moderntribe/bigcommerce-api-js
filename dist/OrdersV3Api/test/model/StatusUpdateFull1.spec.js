...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('StatusUpdateFull1', function () {
      beforeEach(function () {
        instance = new OrdersV3.StatusUpdateFull1();
      });

      it('should create an instance of StatusUpdateFull1', function () {
        expect(instance).to.be.a(OrdersV3.StatusUpdateFull1);
      });
      ...
      it('should have the property new_status (base name: "new_status")', function () {
        expect(instance).to.have.property('new_status');
        // expect(instance.new_status).to.be(expectedValueLiteral);
      });
    });
  });
});