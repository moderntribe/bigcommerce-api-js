...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundQuoteFull', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundQuoteFull();
      });

      it('should create an instance of RefundQuoteFull', function () {
        expect(instance).to.be.a(OrdersV3.RefundQuoteFull);
      });
