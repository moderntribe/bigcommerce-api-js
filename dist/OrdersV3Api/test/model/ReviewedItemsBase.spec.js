...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReviewedItemsBase', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReviewedItemsBase();
      });

      it('should create an instance of ReviewedItemsBase', function () {
        expect(instance).to.be.a(OrdersV3.ReviewedItemsBase);
      });
    });
  });
});