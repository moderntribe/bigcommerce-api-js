...
})(undefined, function (expect, OrdersV3) {
  'use strict';

  var instance;

  describe('(package)', function () {
    describe('RefundQuoteFull1', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundQuoteFull1();
      });

      it('should create an instance of RefundQuoteFull1', function () {
        expect(instance).to.be.a(OrdersV3.RefundQuoteFull1);
      });
      ...
      it('should have the property total_refund_amount (base name: "total_refund_amount")', function () {
        expect(instance).to.have.property('total_refund_amount');
        // expect(instance.total_refund_amount).to.be(expectedValueLiteral);
      });

      it('should have the property total_refund_tax_amount (base name: "total_refund_tax_amount")', function () {
        expect(instance).to.have.property('total_refund_tax_amount');
        // expect(instance.total_refund_tax_amount).to.be(expectedValueLiteral);
      });

      it('should have the property rounding (base name: "rounding")', function () {
        expect(instance).to.have.property('rounding');
        // expect(instance.rounding).to.be(expectedValueLiteral);
      });

      it('should have the property adjustment (base name: "adjustment")', function () {
        expect(instance).to.have.property('adjustment');
        // expect(instance.adjustment).to.be(expectedValueLiteral);
      });

      it('should have the property tax_inclusive (base name: "tax_inclusive")', function () {
        expect(instance).to.have.property('tax_inclusive');
        // expect(instance.tax_inclusive).to.be(expectedValueLiteral);
      });

      it('should have the property refund_methods (base name: "refund_methods")', function () {
        expect(instance).to.have.property('refund_methods');
        // expect(instance.refund_methods).to.be(expectedValueLiteral);
      });
    });
  });
});