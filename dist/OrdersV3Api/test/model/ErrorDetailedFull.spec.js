...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ErrorDetailedFull', function () {
      beforeEach(function () {
        instance = new OrdersV3.ErrorDetailedFull();
      });

      it('should create an instance of ErrorDetailedFull', function () {
        expect(instance).to.be.a(OrdersV3.ErrorDetailedFull);
      });
