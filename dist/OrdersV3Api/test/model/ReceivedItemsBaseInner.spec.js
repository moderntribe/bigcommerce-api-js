...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReceivedItemsBaseInner', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReceivedItemsBaseInner();
      });

      it('should create an instance of ReceivedItemsBaseInner', function () {
        expect(instance).to.be.a(OrdersV3.ReceivedItemsBaseInner);
      });
