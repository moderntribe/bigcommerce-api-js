...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreditCard', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreditCard();
      });

      it('should create an instance of CreditCard', function () {
        expect(instance).to.be.a(OrdersV3.CreditCard);
      });
      ...
      it('should have the property card_iin (base name: "card_iin")', function () {
        expect(instance).to.have.property('card_iin');
        // expect(instance.card_iin).to.be(expectedValueLiteral);
      });

      it('should have the property card_last4 (base name: "card_last4")', function () {
        expect(instance).to.have.property('card_last4');
        // expect(instance.card_last4).to.be(expectedValueLiteral);
      });

      it('should have the property card_expiry_month (base name: "card_expiry_month")', function () {
        expect(instance).to.have.property('card_expiry_month');
        // expect(instance.card_expiry_month).to.be(expectedValueLiteral);
      });

      it('should have the property card_expiry_year (base name: "card_expiry_year")', function () {
        expect(instance).to.have.property('card_expiry_year');
        // expect(instance.card_expiry_year).to.be(expectedValueLiteral);
      });
    });
  });
});