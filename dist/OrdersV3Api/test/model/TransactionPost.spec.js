...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('TransactionPost', function () {
      beforeEach(function () {
        instance = new OrdersV3.TransactionPost();
      });

      it('should create an instance of TransactionPost', function () {
        expect(instance).to.be.a(OrdersV3.TransactionPost);
      });
      ...
      it('should have the property gateway_transaction_id (base name: "gateway_transaction_id")', function () {
        expect(instance).to.have.property('gateway_transaction_id');
        // expect(instance.gateway_transaction_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property fraud_review (base name: "fraud_review")', function () {
        expect(instance).to.have.property('fraud_review');
        // expect(instance.fraud_review).to.be(expectedValueLiteral);
      });

      it('should have the property reference_transaction_id (base name: "reference_transaction_id")', function () {
        expect(instance).to.have.property('reference_transaction_id');
        // expect(instance.reference_transaction_id).to.be(expectedValueLiteral);
      });
