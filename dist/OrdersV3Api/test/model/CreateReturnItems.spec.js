...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnItems', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnItems();
      });

      it('should create an instance of CreateReturnItems', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnItems);
      });
      ...
      it('should have the property reference_id (base name: "reference_id")', function () {
        expect(instance).to.have.property('reference_id');
        // expect(instance.reference_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property preferred_outcome (base name: "preferred_outcome")', function () {
        expect(instance).to.have.property('preferred_outcome');
        // expect(instance.preferred_outcome).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property received_state (base name: "received_state")', function () {
        expect(instance).to.have.property('received_state');
        // expect(instance.received_state).to.be(expectedValueLiteral);
      });

      it('should have the property review_state (base name: "review_state")', function () {
        expect(instance).to.have.property('review_state');
        // expect(instance.review_state).to.be(expectedValueLiteral);
      });
    });
  });
});