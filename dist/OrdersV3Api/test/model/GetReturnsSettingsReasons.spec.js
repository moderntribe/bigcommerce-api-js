...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetReturnsSettingsReasons', function () {
      beforeEach(function () {
        instance = new OrdersV3.GetReturnsSettingsReasons();
      });

      it('should create an instance of GetReturnsSettingsReasons', function () {
        expect(instance).to.be.a(OrdersV3.GetReturnsSettingsReasons);
      });
