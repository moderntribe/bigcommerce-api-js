...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AVSResult', function () {
      beforeEach(function () {
        instance = new OrdersV3.AVSResult();
      });

      it('should create an instance of AVSResult', function () {
        expect(instance).to.be.a(OrdersV3.AVSResult);
      });
