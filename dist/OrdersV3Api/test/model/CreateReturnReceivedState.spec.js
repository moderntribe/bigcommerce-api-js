...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnReceivedState', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnReceivedState();
      });

      it('should create an instance of CreateReturnReceivedState', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnReceivedState);
      });

      it('should have the property received_quantity (base name: "received_quantity")', function () {
        expect(instance).to.have.property('received_quantity');
        // expect(instance.received_quantity).to.be(expectedValueLiteral);
      });
