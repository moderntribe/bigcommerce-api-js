...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnRequest', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnRequest();
      });

      it('should create an instance of CreateReturnRequest', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnRequest);
      });
