...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CVVResult', function () {
      beforeEach(function () {
        instance = new OrdersV3.CVVResult();
      });

      it('should create an instance of CVVResult', function () {
        expect(instance).to.be.a(OrdersV3.CVVResult);
      });
