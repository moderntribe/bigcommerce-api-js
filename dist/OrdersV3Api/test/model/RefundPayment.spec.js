...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundPayment', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundPayment();
      });

      it('should create an instance of RefundPayment', function () {
        expect(instance).to.be.a(OrdersV3.RefundPayment);
      });
      ...
      it('should have the property is_declined (base name: "is_declined")', function () {
        expect(instance).to.have.property('is_declined');
        // expect(instance.is_declined).to.be(expectedValueLiteral);
      });

      it('should have the property declined_message (base name: "declined_message")', function () {
        expect(instance).to.have.property('declined_message');
        // expect(instance.declined_message).to.be(expectedValueLiteral);
      });
    });
  });
});