...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundItem', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundItem();
      });

      it('should create an instance of RefundItem', function () {
        expect(instance).to.be.a(OrdersV3.RefundItem);
      });

      it('should have the property item_type (base name: "item_type")', function () {
        expect(instance).to.have.property('item_type');
        // expect(instance.item_type).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property requested_amount (base name: "requested_amount")', function () {
        expect(instance).to.have.property('requested_amount');
        // expect(instance.requested_amount).to.be(expectedValueLiteral);
      });
    });
  });
});