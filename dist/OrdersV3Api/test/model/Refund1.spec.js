...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('Refund1', function () {
      beforeEach(function () {
        instance = new OrdersV3.Refund1();
      });

      it('should create an instance of Refund1', function () {
        expect(instance).to.be.a(OrdersV3.Refund1);
      });
      ...
      it('should have the property user_id (base name: "user_id")', function () {
        ...
        // expect(instance.user_id).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property total_amount (base name: "total_amount")', function () {
        expect(instance).to.have.property('total_amount');
        // expect(instance.total_amount).to.be(expectedValueLiteral);
      });
