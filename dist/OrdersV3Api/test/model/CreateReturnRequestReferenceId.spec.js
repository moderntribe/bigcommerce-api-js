...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnRequestReferenceId', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnRequestReferenceId();
      });

      it('should create an instance of CreateReturnRequestReferenceId', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnRequestReferenceId);
      });
