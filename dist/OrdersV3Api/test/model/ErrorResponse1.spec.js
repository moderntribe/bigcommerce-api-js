...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ErrorResponse1', function () {
      beforeEach(function () {
        instance = new OrdersV3.ErrorResponse1();
      });

      it('should create an instance of ErrorResponse1', function () {
        expect(instance).to.be.a(OrdersV3.ErrorResponse1);
      });
