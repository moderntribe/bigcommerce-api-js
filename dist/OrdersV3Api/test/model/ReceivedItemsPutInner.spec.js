...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ReceivedItemsPutInner', function () {
      beforeEach(function () {
        instance = new OrdersV3.ReceivedItemsPutInner();
      });

      it('should create an instance of ReceivedItemsPutInner', function () {
        expect(instance).to.be.a(OrdersV3.ReceivedItemsPutInner);
      });
