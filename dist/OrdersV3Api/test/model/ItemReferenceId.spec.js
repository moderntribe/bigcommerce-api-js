...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ItemReferenceId', function () {
      beforeEach(function () {
        instance = new OrdersV3.ItemReferenceId();
      });

      it('should create an instance of ItemReferenceId', function () {
        expect(instance).to.be.a(OrdersV3.ItemReferenceId);
      });
