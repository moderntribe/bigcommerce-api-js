...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundQuotePost1', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundQuotePost1();
      });

      it('should create an instance of RefundQuotePost1', function () {
        expect(instance).to.be.a(OrdersV3.RefundQuotePost1);
      });
