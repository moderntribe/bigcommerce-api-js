...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateReturnPreferredOutcome', function () {
      beforeEach(function () {
        instance = new OrdersV3.CreateReturnPreferredOutcome();
      });

      it('should create an instance of CreateReturnPreferredOutcome', function () {
        expect(instance).to.be.a(OrdersV3.CreateReturnPreferredOutcome);
      });
