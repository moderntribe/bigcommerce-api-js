...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('UpdateReturnStatuses', function () {
      beforeEach(function () {
        instance = new OrdersV3.UpdateReturnStatuses();
      });

      it('should create an instance of UpdateReturnStatuses', function () {
        expect(instance).to.be.a(OrdersV3.UpdateReturnStatuses);
      });
    });
  });
});