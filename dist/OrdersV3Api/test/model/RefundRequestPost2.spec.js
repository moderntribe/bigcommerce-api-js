...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('RefundRequestPost2', function () {
      beforeEach(function () {
        instance = new OrdersV3.RefundRequestPost2();
      });

      it('should create an instance of RefundRequestPost2', function () {
        expect(instance).to.be.a(OrdersV3.RefundRequestPost2);
      });
