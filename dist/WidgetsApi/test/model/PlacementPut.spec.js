...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PlacementPut', function () {
      beforeEach(function () {
        instance = new Widgets.PlacementPut();
      });

      it('should create an instance of PlacementPut', function () {
        expect(instance).to.be.a(Widgets.PlacementPut);
      });
