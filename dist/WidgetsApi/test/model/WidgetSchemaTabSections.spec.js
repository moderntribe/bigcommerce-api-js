...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('WidgetSchemaTabSections', function () {
      beforeEach(function () {
        instance = new Widgets.WidgetSchemaTabSections();
      });

      it('should create an instance of WidgetSchemaTabSections', function () {
        expect(instance).to.be.a(Widgets.WidgetSchemaTabSections);
      });
