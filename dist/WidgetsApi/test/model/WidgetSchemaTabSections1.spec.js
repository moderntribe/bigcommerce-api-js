...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('WidgetSchemaTabSections1', function () {
      beforeEach(function () {
        instance = new Widgets.WidgetSchemaTabSections1();
      });

      it('should create an instance of WidgetSchemaTabSections1', function () {
        expect(instance).to.be.a(Widgets.WidgetSchemaTabSections1);
      });
