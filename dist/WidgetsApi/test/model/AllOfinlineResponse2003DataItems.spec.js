...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AllOfinlineResponse2003DataItems', function () {
      beforeEach(function () {
        instance = new Widgets.AllOfinlineResponse2003DataItems();
      });

      it('should create an instance of AllOfinlineResponse2003DataItems', function () {
        expect(instance).to.be.a(Widgets.AllOfinlineResponse2003DataItems);
      });
      ...
      it('should have the property widget (base name: "widget")', function () {
        ...
        // expect(instance.widget).to.be(expectedValueLiteral);
      });
    });
  });
});