...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('ThemeRegion1', function () {
      beforeEach(function () {
        instance = new Widgets.ThemeRegion1();
      });

      it('should create an instance of ThemeRegion1', function () {
        expect(instance).to.be.a(Widgets.ThemeRegion1);
      });
