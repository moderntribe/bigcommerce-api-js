...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('WidgetFull', function () {
      beforeEach(function () {
        instance = new Widgets.WidgetFull();
      });

      it('should create an instance of WidgetFull', function () {
        expect(instance).to.be.a(Widgets.WidgetFull);
      });
