...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('PlacementPost', function () {
      beforeEach(function () {
        instance = new Widgets.PlacementPost();
      });

      it('should create an instance of PlacementPost', function () {
        expect(instance).to.be.a(Widgets.PlacementPost);
      });
