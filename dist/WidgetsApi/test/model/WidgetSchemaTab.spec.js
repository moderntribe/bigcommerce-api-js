...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('WidgetSchemaTab', function () {
      beforeEach(function () {
        instance = Widgets.WidgetSchemaTab;
      });

      it('should create an instance of WidgetSchemaTab', function () {
        expect(instance).to.be.a('object');
      });

      it('should have the property tab', function () {
        expect(instance).to.have.property('tab');
        expect(instance.tab).to.be("tab");
      });
    });
  });
});