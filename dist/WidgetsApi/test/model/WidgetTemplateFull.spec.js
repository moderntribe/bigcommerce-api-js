...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('WidgetTemplateFull', function () {
      beforeEach(function () {
        instance = new Widgets.WidgetTemplateFull();
      });

      it('should create an instance of WidgetTemplateFull', function () {
        expect(instance).to.be.a(Widgets.WidgetTemplateFull);
      });
