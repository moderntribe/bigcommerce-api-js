...
/**
* The PlacementPost1 model module.
* @module model/PlacementPost1
* @version 3.0
*/
var PlacementPost1 = function () {
    /**
    * Constructs a new <code>PlacementPost1</code>.
    * @alias module:model/PlacementPost1
    * @class
    */

    function PlacementPost1() {
        _classCallCheck(this, PlacementPost1);
    ...
    /**
    * Constructs a <code>PlacementPost1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/PlacementPost1} obj Optional instance to populate.
    * @return {module:model/PlacementPost1} The populated <code>PlacementPost1</code> instance.
    */


    _createClass(PlacementPost1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new PlacementPost1();
        ...
        * @member {module:model/PlacementPost1.StatusEnum} status
        * @default 'inactive'
        */
    ...
    return PlacementPost1;
}();

PlacementPost1.StatusEnum = {
    /**
     * value: "inactive"
     * @const
     */
     ...
     */
    "active": "active" };
exports.default = PlacementPost1;