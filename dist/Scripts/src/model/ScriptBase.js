...
/**
* The ScriptBase model module.
* @module model/ScriptBase
* @version 3.0
*/
var ScriptBase = function () {
    /**
    * Constructs a new <code>ScriptBase</code>.
    * Script properties common to &#x60;post&#x60;, &#x60;put&#x60;, and &#x60;get&#x60; requests.
    * @alias module:model/ScriptBase
    * @class
    */

    function ScriptBase() {
        _classCallCheck(this, ScriptBase);
    ...
    /**
    * Constructs a <code>ScriptBase</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ScriptBase} obj Optional instance to populate.
    * @return {module:model/ScriptBase} The populated <code>ScriptBase</code> instance.
    */


    _createClass(ScriptBase, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ScriptBase();
        ...
        * @member {module:model/ScriptBase.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/ScriptBase.LocationEnum} location
        */
        ...
        * @member {module:model/ScriptBase.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/ScriptBase.KindEnum} kind
        */
        ...
        * @member {module:model/ScriptBase.ConsentCategoryEnum} consent_category
        */
...
ScriptBase.ConsentCategoryEnum = {
    /**
     * value: "essential"
     * @const
     */
