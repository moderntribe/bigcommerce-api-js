...
var ScriptsResponse = function () {
    ...
    */
    ...
    function ScriptsResponse() {
        _classCallCheck(this, ScriptsResponse);
    ...
    */
    ...
    _createClass(ScriptsResponse, null, [{
        ...
        value: function constructFromObject(data, obj) {
            if (data) {
                ...
                if (data.hasOwnProperty('data')) {
                    obj['data'] = _ApiClient2.default.convertToType(data['data'], [AllOfScriptsResponseDataItems]);
                }
...
exports.default = ScriptsResponse;