...
var Body = function () {
    ...
    */
    ...
    _createClass(Body, null, [{
        ...
        * @member {module:model/Body.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/Body.LocationEnum} location
        */
        ...
        * @member {module:model/Body.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/Body.ConsentCategoryEnum} consent_category
        */
