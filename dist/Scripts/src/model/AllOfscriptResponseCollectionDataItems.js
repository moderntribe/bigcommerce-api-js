...
/**
* The AllOfscriptResponseCollectionDataItems model module.
* @module model/AllOfscriptResponseCollectionDataItems
* @version 3.0
*/
var AllOfscriptResponseCollectionDataItems = function () {
    /**
    * Constructs a new <code>AllOfscriptResponseCollectionDataItems</code>.
    * @alias module:model/AllOfscriptResponseCollectionDataItems
    * @class
    */

    function AllOfscriptResponseCollectionDataItems() {
        _classCallCheck(this, AllOfscriptResponseCollectionDataItems);
    ...
    /**
    * Constructs a <code>AllOfscriptResponseCollectionDataItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfscriptResponseCollectionDataItems} obj Optional instance to populate.
    * @return {module:model/AllOfscriptResponseCollectionDataItems} The populated <code>AllOfscriptResponseCollectionDataItems</code> instance.
    */


    _createClass(AllOfscriptResponseCollectionDataItems, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfscriptResponseCollectionDataItems();
        ...
        * @member {module:model/AllOfscriptResponseCollectionDataItems.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/AllOfscriptResponseCollectionDataItems.LocationEnum} location
        */
        ...
        * @member {module:model/AllOfscriptResponseCollectionDataItems.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/AllOfscriptResponseCollectionDataItems.KindEnum} kind
        */
        ...
        * @member {module:model/AllOfscriptResponseCollectionDataItems.ConsentCategoryEnum} consent_category
        */
    ...
    return AllOfscriptResponseCollectionDataItems;
}();

AllOfscriptResponseCollectionDataItems.LoadMethodEnum = {
    /**
     * value: "default"
     * @const
     */
     ...
     */
    "defer": "defer" };
AllOfscriptResponseCollectionDataItems.LocationEnum = {
    /**
     * value: "head"
     * @const
     */
     ...
     */
    "footer": "footer" };
AllOfscriptResponseCollectionDataItems.VisibilityEnum = {
    /**
     * value: "storefront"
     * @const
     */
...
AllOfscriptResponseCollectionDataItems.KindEnum = {
    /**
     * value: "src"
     * @const
     */
...
AllOfscriptResponseCollectionDataItems.ConsentCategoryEnum = {
    /**
     * value: "essential"
     * @const
     */
     ...
     */
    "targeting": "targeting" };
exports.default = AllOfscriptResponseCollectionDataItems;