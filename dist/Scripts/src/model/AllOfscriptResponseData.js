...
/**
* The AllOfscriptResponseData model module.
* @module model/AllOfscriptResponseData
* @version 3.0
*/
var AllOfscriptResponseData = function () {
    /**
    * Constructs a new <code>AllOfscriptResponseData</code>.
    * @alias module:model/AllOfscriptResponseData
    * @class
    */

    function AllOfscriptResponseData() {
        _classCallCheck(this, AllOfscriptResponseData);
    ...
    /**
    * Constructs a <code>AllOfscriptResponseData</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AllOfscriptResponseData} obj Optional instance to populate.
    * @return {module:model/AllOfscriptResponseData} The populated <code>AllOfscriptResponseData</code> instance.
    */


    _createClass(AllOfscriptResponseData, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new AllOfscriptResponseData();
        ...
        * @member {module:model/AllOfscriptResponseData.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/AllOfscriptResponseData.LocationEnum} location
        */
        ...
        * @member {module:model/AllOfscriptResponseData.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/AllOfscriptResponseData.KindEnum} kind
        */
        ...
        * @member {module:model/AllOfscriptResponseData.ConsentCategoryEnum} consent_category
        */
...
AllOfscriptResponseData.LoadMethodEnum = {
    /**
     * value: "default"
     * @const
     */
     ...
     */
    "defer": "defer" };
AllOfscriptResponseData.LocationEnum = {
    /**
     * value: "head"
     * @const
     */
     ...
     */
    "footer": "footer" };
AllOfscriptResponseData.VisibilityEnum = {
    /**
     * value: "storefront"
     * @const
     */
...
AllOfscriptResponseData.KindEnum = {
    /**
     * value: "src"
     * @const
     */
...
AllOfscriptResponseData.ConsentCategoryEnum = {
    /**
     * value: "essential"
     * @const
     */
     ...
     */
    "targeting": "targeting" };
exports.default = AllOfscriptResponseData;