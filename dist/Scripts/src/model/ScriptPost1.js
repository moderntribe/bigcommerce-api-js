...
/**
* The ScriptPost1 model module.
* @module model/ScriptPost1
* @version 3.0
*/
var ScriptPost1 = function () {
    /**
    * Constructs a new <code>ScriptPost1</code>.
    * @alias module:model/ScriptPost1
    * @class
    */

    function ScriptPost1() {
        _classCallCheck(this, ScriptPost1);
    ...
    /**
    * Constructs a <code>ScriptPost1</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ScriptPost1} obj Optional instance to populate.
    * @return {module:model/ScriptPost1} The populated <code>ScriptPost1</code> instance.
    */


    _createClass(ScriptPost1, null, [{
        key: 'constructFromObject',
        value: function constructFromObject(data, obj) {
            if (data) {
                obj = obj || new ScriptPost1();
        ...
        * @member {module:model/ScriptPost1.LoadMethodEnum} load_method
        */

        /**
        * Where on the page to place the script. Values are `head` or `footer`.
        * @member {module:model/ScriptPost1.LocationEnum} location
        */
        ...
        * @member {module:model/ScriptPost1.VisibilityEnum} visibility
        */
        ...
        * @member {module:model/ScriptPost1.KindEnum} kind
        */
        ...
        * @member {module:model/ScriptPost1.ConsentCategoryEnum} consent_category
        */
...
ScriptPost1.ConsentCategoryEnum = {
    /**
     * value: "essential"
     * @const
     */
