...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/BulkPricingRule', 'Model/CustomField', 'Model/CustomUrlProduct', 'Model/Modifier', 'Model/Option', 'Model/ProductBase', 'Model/ProductImage', 'Model/ProductVideo', 'Model/Variant'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BulkPricingRule'), require('./CustomField'), require('./CustomUrlProduct'), require('./Modifier'), require('./Option'), require('./ProductBase'), require('./ProductImage'), require('./ProductVideo'), require('./Variant'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.Product = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.BulkPricingRule, root.BigCommerceApi.CustomField, root.BigCommerceApi.CustomUrlProduct, root.BigCommerceApi.Modifier, root.BigCommerceApi.Option, root.BigCommerceApi.ProductBase, root.BigCommerceApi.ProductImage, root.BigCommerceApi.ProductVideo, root.BigCommerceApi.Variant);
  }
}(this, function(ApiClient, BulkPricingRule, CustomField, CustomUrlProduct, Modifier, Option, ProductBase, ProductImage, ProductVideo, Variant) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('videos')) {
        obj['videos'] = ApiClient.convertToType(data['videos'], [ProductVideo]);
      }
   ...
   */
  exports.prototype['reviews_rating_sum'] = undefined;
  /**
   * The number of times the product has been rated. 
   * @member {Number} reviews_count
   */
  exports.prototype['reviews_count'] = undefined;
  /**
   * The total quantity of this product sold. 
   * @member {Number} total_sold
   */
  exports.prototype['total_sold'] = undefined;
  /**
  ...
  /**
   * @member {Array.<module:Model/ProductVideo>} videos
   */
   ...
   */
  exports.prototype['base_variant_id'] = undefined;
