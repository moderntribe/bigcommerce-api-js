...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/CollectionMeta', 'Model/Subscriber'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CollectionMeta'), require('./Subscriber'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.SubscriberCollectionResponse = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.CollectionMeta, root.BigCommerceApi.Subscriber);
  }
}(this, function(ApiClient, CollectionMeta, Subscriber) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [Subscriber]);
      }
  ...
  /**
   * @member {Array.<module:Model/Subscriber>} data
   */
