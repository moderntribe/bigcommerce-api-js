...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/VariantBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VariantBase'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.VariantProductPut = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.VariantBase);
  }
}(this, function(ApiClient, VariantBase) {
  'use strict';
  ...
  /**
   * The VariantProductPut model module.
   * @module Model/VariantProductPut
   * @version 3.0.0b
   */

  /**
   * Constructs a new <code>VariantProductPut</code>.
   * The model for a PUT to update variants on a product. 
   * @alias module:Model/VariantProductPut
   * @class
  ...
  /**
   * Constructs a <code>VariantProductPut</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/VariantProductPut} obj Optional instance to populate.
   * @return {module:Model/VariantProductPut} The populated <code>VariantProductPut</code> instance.
   */
