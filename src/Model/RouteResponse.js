...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/Meta', 'Model/Route'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Meta'), require('./Route'));
  } else {
    // Browser globals (root is window)
    if (!root.SitesRoutes) {
      root.SitesRoutes = {};
    }
    root.SitesRoutes.RouteResponse = factory(root.SitesRoutes.ApiClient, root.SitesRoutes.Meta, root.SitesRoutes.Route);
  }
}(this, function(ApiClient, Meta, Route) {
  'use strict';
