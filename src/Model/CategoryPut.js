...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BigCommerceApi.CategoryPut = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.CategoryBase, root.BigCommerceApi.CustomUrlCategory);
  }
  ...
  /**
   * The CategoryPut model module.
   * @module Model/CategoryPut
   * @version 3.0.0b
   */

  /**
   * Constructs a new <code>CategoryPut</code>.
   * The model for a PUT to update category. 
   * @alias module:Model/CategoryPut
   * @class
  ...
  /**
   * Constructs a <code>CategoryPut</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/CategoryPut} obj Optional instance to populate.
   * @return {module:Model/CategoryPut} The populated <code>CategoryPut</code> instance.
   */
