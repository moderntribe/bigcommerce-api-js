...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BigCommerceApi.ConfigurableFieldPost = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.ConfigurableFieldBase);
  }
  ...
  /**
   * The ConfigurableFieldPost model module.
   * @module Model/ConfigurableFieldPost
   * @version 3.0.0b
   */

  /**
   * Constructs a new <code>ConfigurableFieldPost</code>.
   * The model for a POST to create a configurable field on a product. 
   * @alias module:Model/ConfigurableFieldPost
   * @class
  ...
  /**
   * Constructs a <code>ConfigurableFieldPost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/ConfigurableFieldPost} obj Optional instance to populate.
   * @return {module:Model/ConfigurableFieldPost} The populated <code>ConfigurableFieldPost</code> instance.
   */
