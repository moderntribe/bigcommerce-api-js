...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/BulkPricingRulePost', 'Model/CustomFieldPost', 'Model/CustomUrlProduct', 'Model/ProductBase', 'Model/VariantProductPost'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BulkPricingRulePost'), require('./CustomFieldPost'), require('./CustomUrlProduct'), require('./ProductBase'), require('./VariantProductPost'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.ProductPost = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.BulkPricingRulePost, root.BigCommerceApi.CustomFieldPost, root.BigCommerceApi.CustomUrlProduct, root.BigCommerceApi.ProductBase, root.BigCommerceApi.VariantProductPost);
  }
}(this, function(ApiClient, BulkPricingRulePost, CustomFieldPost, CustomUrlProduct, ProductBase, VariantProductPost) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('custom_fields')) {
        obj['custom_fields'] = ApiClient.convertToType(data['custom_fields'], [CustomFieldPost]);
      }
      if (data.hasOwnProperty('bulk_pricing_rules')) {
        obj['bulk_pricing_rules'] = ApiClient.convertToType(data['bulk_pricing_rules'], [BulkPricingRulePost]);
      }
      if (data.hasOwnProperty('variants')) {
        obj['variants'] = ApiClient.convertToType(data['variants'], [VariantProductPost]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:Model/CustomFieldPost>} custom_fields
   */
  exports.prototype['custom_fields'] = undefined;
  /**
   * @member {Array.<module:Model/BulkPricingRulePost>} bulk_pricing_rules
   */
  exports.prototype['bulk_pricing_rules'] = undefined;
  /**
   * @member {Array.<module:Model/VariantProductPost>} variants
   */
