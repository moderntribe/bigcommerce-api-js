...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/Adjuster', 'Model/ComplexRuleBase', 'Model/ComplexRuleCondition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Adjuster'), require('./ComplexRuleBase'), require('./ComplexRuleCondition'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.ComplexRule = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.Adjuster, root.BigCommerceApi.ComplexRuleBase, root.BigCommerceApi.ComplexRuleCondition);
  }
}(this, function(ApiClient, Adjuster, ComplexRuleBase, ComplexRuleCondition) {
  'use strict';
