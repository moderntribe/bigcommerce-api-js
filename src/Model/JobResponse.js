...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/Job', 'Model/Meta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Job'), require('./Meta'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.JobResponse = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.Job, root.BigCommerceApi.Meta);
  }
}(this, function(ApiClient, Job, Meta) {
  'use strict';
