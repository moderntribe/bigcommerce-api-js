...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/Meta', 'Model/Theme'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Meta'), require('./Theme'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.ThemeResponse = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.Meta, root.BigCommerceApi.Theme);
  }
}(this, function(ApiClient, Meta, Theme) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = Theme.constructFromObject(data['data']);
      }
  ...
  /**
   * @member {module:Model/Theme} data
   */
