...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BigCommerceApi.CategoryPost = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.CategoryBase, root.BigCommerceApi.CustomUrlCategory);
  }
  ...
  /**
   * The CategoryPost model module.
   * @module Model/CategoryPost
   * @version 3.0.0b
   */

  /**
   * Constructs a new <code>CategoryPost</code>.
   * The model for a POST to create category. 
   * @alias module:Model/CategoryPost
   * @class
  ...
  /**
   * Constructs a <code>CategoryPost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/CategoryPost} obj Optional instance to populate.
   * @return {module:Model/CategoryPost} The populated <code>CategoryPost</code> instance.
   */
