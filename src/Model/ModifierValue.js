...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BigCommerceApi.ModifierValue = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.ModifierValueBase, root.BigCommerceApi.ModifierValueBaseAdjusters);
  }
  ...
  /**
   * The ModifierValue model module.
   * @module Model/ModifierValue
   * @version 3.0.0b
   */

  /**
   * Constructs a new <code>ModifierValue</code>.
   * @alias module:Model/ModifierValue
   * @class
  ...
  /**
   * Constructs a <code>ModifierValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/ModifierValue} obj Optional instance to populate.
   * @return {module:Model/ModifierValue} The populated <code>ModifierValue</code> instance.
   */
