...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Model/OptionValueProductPost', 'Model/VariantBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OptionValueProductPost'), require('./VariantBase'));
  } else {
    // Browser globals (root is window)
    if (!root.BigCommerceApi) {
      root.BigCommerceApi = {};
    }
    root.BigCommerceApi.VariantProductPost = factory(root.BigCommerceApi.ApiClient, root.BigCommerceApi.OptionValueProductPost, root.BigCommerceApi.VariantBase);
  }
}(this, function(ApiClient, OptionValueProductPost, VariantBase) {
  'use strict';
  ...
  /**
   * The VariantProductPost model module.
   * @module Model/VariantProductPost
   * @version 3.0.0b
   */

  /**
   * Constructs a new <code>VariantProductPost</code>.
   * The model for a POST to create variants on a product. 
   * @alias module:Model/VariantProductPost
   * @class
  ...
  /**
   * Constructs a <code>VariantProductPost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Model/VariantProductPost} obj Optional instance to populate.
   * @return {module:Model/VariantProductPost} The populated <code>VariantProductPost</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('option_values')) {
        obj['option_values'] = ApiClient.convertToType(data['option_values'], [OptionValueProductPost]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:Model/OptionValueProductPost>} option_values
   */
